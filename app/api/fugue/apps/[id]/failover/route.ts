...
import { failoverFugueApp } from "@/lib/fugue/api";
import {
  jsonError,
  readErrorMessage,
  readErrorStatus,
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const result = await failoverFugueApp(workspaceState.workspace.adminKeySecret, appId, {
      targetRuntimeId: readOptionalString(body, "targetRuntimeId"),
    });
