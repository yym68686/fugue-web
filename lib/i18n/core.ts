...
const zhCNMorlanePatchMessages = {
  ...
  "Add a directory or file mount to keep it across redeploys, restarts, runtime moves, and failover.": "添加目录或文件挂载，让它在重新部署、重启、运行时迁移和故障转移后继续保留。",
  "Add a workspace admin key for another environment, or copy a stored secret.": "为其他环境添加工作区管理密钥，或复制存储的密钥。",
  "Add admin key": "添加管理员密钥",
  "Add credits before you raise the saved cap. Fugue deducts credits from active resources, and stored images count toward disk usage.": "提高已保存上限前请先充值余额。Fugue 会从活动资源中扣除余额，已保存镜像也会计入磁盘用量。",
  "Add directory": "添加目录",
  "Add file": "添加文件",
  "Adjust from 0 to {max} GiB in {step} GiB steps.": "从 0 到 {max} GiB 调整，步进为 {step} GiB。",
  "Adjust from 0 to {max} cpu in {step} cpu steps.": "从 0 到 {max} CPU 调整，步进为 {step} CPU。",
  ...
  "Allow DNS": "允许 DNS",
  "Allow edge": "允许 Edge",
  "Another project already uses “{name}”. Project names must be unique within the workspace.": "另一个项目已使用“{name}”。项目名称在工作区内必须唯一。",
  "App service": "应用服务",
  "Apply table": "应用路由表",
  "Balance, metering, and capacity": "余额、计量和容量",
  "Billing and capacity details": "计费与容量详情",
  "Bind one repository for this project. Fugue reads the repository workflow image outputs and maps them to app services automatically.": "为此项目绑定一个仓库。Fugue 会读取仓库工作流输出的镜像，并自动映射到应用服务。",
  "Bind project": "绑定项目",
  "Binding…": "正在绑定…",
  "Bootstrap a workspace before enrolling servers into Fugue.": "先初始化工作区，再将服务器接入 Fugue。",
  "Bootstrap the workspace to create the first node key.": "初始化工作区以创建第一个节点密钥。",
  "Bottleneck": "瓶颈",
  "Branch, app name, build strategy, and optional source paths": "分支、应用名称、构建策略和可选源路径",
  "Clear filters": "清除筛选",
  ...
  "Create a CNAME record for {hostname} pointing to {target}. Fugue will verify it automatically once DNS resolves.": "为 {hostname} 创建指向 {target} 的 CNAME 记录。DNS 解析后，Fugue 会自动验证。",
  "Create a CNAME record pointing to {target}. Fugue will verify it automatically once DNS resolves.": "创建指向 {target} 的 CNAME 记录。DNS 解析后，Fugue 会自动验证。",
  "Create a node key, run the join command on your VPS, or wait for another workspace to share a server with you.": "创建节点密钥，在 VPS 上运行加入命令，或等待其他工作区向你共享服务器。",
  "Create scoped API keys and node enrollment keys from one access surface.": "在同一个访问界面创建限定范围的 API 密钥和节点接入密钥。",
  "Create the first project, import a service, and Fugue will attach route controls when the first app record is ready.": "创建第一个项目并导入服务；首个应用记录就绪后，Fugue 会挂接路由控制。",
  ...
  "Current primary: {primaryRuntimeLabel}. Choose a destination and Fugue will prepare the new primary before switching over.": "当前主实例：{primaryRuntimeLabel}。选择目标后，Fugue 会先准备新的主实例再切换。",
  "Current primary: {primaryRuntimeLabel}. Destination: {activeTransferTargetLabel}. Fugue promotes the new primary automatically once it is ready.": "当前主实例：{primaryRuntimeLabel}。目标：{activeTransferTargetLabel}。准备就绪后，Fugue 会自动提升新的主实例。",
  "DNS": "DNS",
  "Database protection restored. New standby runtime: {target}.": "数据库保护已恢复。新的备用运行时：{target}。",
  ...
  "Delete server": "删除服务器",
  "Delete server records here after the underlying VPS is permanently gone.": "在底层VPS 永久消失后，在此处删除服务器记录。",
  "Delete this server record after the VPS is permanently retired. Fugue will block deletion while workloads or active operations still reference it.": "在VPS 永久停用后删除此服务器记录。当工作负载或活动操作仍然引用它时，Fugue将阻止删除。",
  "Delete {name}?": "删除 {name}？",
  "Deleted {name}, but refresh failed: {message}": "已删除 {name}，但刷新失败：{message}",
  "Deleted {name}.": "已删除{name}。",
  "Deleting the project queues deletion for every service that still belongs to it, then removes the project shell.": "删除项目会先把仍属于它的每个服务加入删除队列，然后移除项目外壳。",
  "Deleting...": "正在删除…",
  "Desired {state}": "期望状态 {state}",
  "Detected image services for {projectName}": "检测到 {projectName} 的镜像服务",
  "Digest": "摘要",
  "Directories keep whole trees. Files mount one exact path.": "目录保存整棵树。文件挂载一个精确路径。",
  ...
  "Endpoint": "端点",
  "Enter a monthly price greater than 0, or mark the server free.": "输入大于 0 的月价格，或将服务器标记为免费。",
  "Enter a non-negative memory value with up to two decimals.": "输入最多两位小数的非负内存值。",
  ...
  "Failover already moved the primary to {primaryRuntimeLabel}. No standby runtime is protecting this database now. Choose a new standby to restore protection.": "故障转移已将主实例迁移到 {primaryRuntimeLabel}。当前没有备用运行时保护此数据库。请选择新的备用运行时恢复保护。",
  "Failover already moved this app to {primaryRuntimeLabel}. No standby runtime is protecting it now. Choose a new standby to restore protection.": "故障转移已将此应用迁移到 {primaryRuntimeLabel}。当前没有备用运行时保护它。请选择新的备用运行时恢复保护。",
  "Failover disable is queued. {primaryRuntimeLabel} keeps serving writes while Fugue removes the standby.{suffix}": "已排队禁用故障转移。Fugue 移除备用实例期间，{primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Failover enable is queued. Fugue will prepare {pendingTargetLabel} as the standby while {primaryRuntimeLabel} keeps serving writes.{suffix}": "已排队启用故障转移。Fugue 会将 {pendingTargetLabel} 准备为备用实例，同时 {primaryRuntimeLabel} 继续处理写入。{suffix}",
  "Fetching billing": "正在获取账单",
  "Freshness": "数据时效",
  "Fugue can still deploy it as a repository import.": "Fugue 仍可按仓库导入来部署它。",
  "Fugue could not load the access key snapshot right now.": "Fugue 当前无法加载访问密钥快照。",
  "Fugue could not open the workspace session. Try again.": "Fugue 无法打开工作区会话。请重试。",
  "Fugue is moving the standby to {pendingTargetLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}": "Fugue 正在将备用实例迁移到 {pendingTargetLabel}。变更期间 {primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Fugue is provisioning {pendingTargetLabel} as the standby. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}": "Fugue 正在将 {pendingTargetLabel} 配置为备用实例。变更期间 {primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Fugue is removing the standby from {configuredStandbyLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}": "Fugue 正在从 {configuredStandbyLabel} 移除备用实例。变更期间 {primaryRuntimeLabel} 会继续处理写入。{suffix}",
  ...
  "Import a GitHub repository, local folder, or Docker image to create the first app.": "导入 GitHub 仓库、本地文件夹或 Docker 镜像来创建第一个应用。",
  ...
  "Inspect all cluster apps, tenants, routing state, rebuild controls, and deletes.": "检查所有集群应用、租户、路由状态、重建控制和删除操作。",
  "Inspect control-plane state, runtime pressure, workloads, and enrollment.": "检查控制平面状态、运行时压力、工作负载和注册。",
  "Internal registry inventory is not configured for this workspace yet.": "尚未为此工作区配置内部注册表清单。",
  "Issue a platform-scoped join key": "签发平台范围的加入密钥",
  "Issue platform key": "签发平台密钥",
  "Issuing key…": "正在颁发密钥…",
  "Join command copied.": "加入命令已复制。",
  "Keep prepaid balance, managed capacity, and retained image storage aligned for this workspace.": "保持此工作区的预付余额、托管容量和保留镜像存储一致。",
  "Keep server": "保留服务器",
  "Keep this database on its current primary runtime, choose a standby runtime for failover, or actively move the primary now.": "让此数据库继续运行在当前主运行时上，选择用于故障转移的备用运行时，或现在主动迁移主实例。",
  "Key label": "密钥标签",
  "Kind": "类型",
  "Last contact": "最近联系",
  "Last contact {time}": "最近联系 {time}",
  "Last deployed {time}": "上次部署 {time}",
  "Leave blank to let Fugue generate the node key label.": "留空则由 Fugue 生成节点密钥标签。",
  "Legacy": "旧版",
  "Load trace": "加载追踪",
  ...
  "Local uploads": "本地上传",
  "Manage account state and quota context from the admin surface.": "从管理界面管理账号状态和配额上下文。",
  "Monitor attached runtime servers, capacity, heartbeat, and offline records.": "监控连接的运行时服务器、容量、心跳和离线记录。",
  "Most image data for this version is still shared with other saved images.": "此版本的大多数镜像数据仍与其他保存的镜像共享。",
  "Most image data in this history is still shared with other saved images.": "此历史记录中的大多数镜像数据仍与其他保存的镜像共享。",
  "Mount path": "挂载路径",
  ...
  "No live servers are reporting right now. Offline servers that still belong to this workspace are listed below.": "当前没有在线服务器上报。仍属于此工作区的离线服务器列在下方。",
  ...
  "No workloads are attached to this offline server.": "没有工作负载附加到此离线服务器。",
  "No workspace keys yet": "尚无工作区密钥",
  "Node keys enroll servers into the Fugue runtime plane.": "节点密钥将服务器注册到Fugue运行时平面。",
  "Not live": "未上线",
  "Observability": "可观测性",
  ...
  "Only the current managed image is stored right now.": "当前只存储了正在使用的托管镜像。",
  "Open commit": "打开提交",
  "Operate cluster apps without leaving the admin surface.": "无需离开管理界面即可运行集群应用。",
  "Partial Fugue data": "Fugue 数据部分可用",
  "Partial admin data": "部分管理员数据",
  "Partial server data": "部分服务器数据",
  "Password details": "密码详情",
  "Paste a GitHub repository link and choose GitHub authorization or a token for private access.": "粘贴GitHub 仓库链接，然后选择GitHub授权或私有访问令牌。",
  "Path": "路径",
  "Path must stay inside persistent storage. Switch to Live filesystem to work outside it.": "路径必须保留在持久化存储内。如需处理外部路径，请切换到在线文件系统。",
  "Path prefix": "路径前缀",
  "Pending": "待处理",
  "Pending standby unavailable": "备用实例不可用",
  "Platform node join": "平台节点加入",
  "Platform node key issued.": "平台节点密钥已签发。",
  "Point Fugue at a published Docker image. Fugue mirrors it into the internal registry before rollout.": "将 Fugue 指向已发布的 Docker 镜像。发布前，Fugue 会把它同步到内部镜像仓库。",
  "Primary placement stays as-is until a later maintenance window, rebuild, node drain, or explicit rebalance.": "主实例部署位置会保持不变，直到后续维护窗口、重建、节点排空或显式重新均衡。",
  "Project deletion started.": "项目删除已开始。",
  "Project deletion started. Remaining services are being removed.": "项目删除已开始。剩余服务正在删除。",
  ...
  "Projects collect services, routes, runtime placement, environment, and deployment controls.": "项目用于组织服务、路由、运行时位置、环境变量和部署控制。",
  "Protection missing": "缺少保护",
  "Protection restored. New standby runtime: {target}.": "保护已恢复。新的备用运行时：{target}。",
  "Public access": "公共访问",
  "Public image refs are mirrored into Fugue before rollout": "公开镜像引用会在发布前同步到 Fugue",
  "Public or private with GitHub authorization or a stored token": "公开仓库，或通过 GitHub 授权 / 已保存 Token 访问的私有仓库",
  "Raw": "原始",
  "Rebuild queued from default branch.": "从默认分支排队重建。",
  "Rebuild queued from {branch}.": "从{branch}排队重建。",
  "Redeploy a known-good version, or delete stale images you no longer need.": "重新部署已知良好的版本，或删除不再需要的陈旧镜像。",
  "Refresh": "刷新",
  "Refresh now": "立即刷新",
  "Remove mount": "移除挂载",
  "Remove {name}": "移除 {name}",
  "Remove {name} from the server inventory only if this VPS is permanently gone. Fugue will refuse the delete if apps, services, or active operations still depend on it.": "只有在此 VPS 永久下线时，才从服务器清单中移除 {name}。如果仍有应用、服务或活动操作依赖它，Fugue 会拒绝删除。",
  "Repository-backed services auto sync; image-backed services can repull the saved image ref": "仓库服务会自动同步；镜像服务可重新拉取已保存的镜像引用",
  "Resource usage": "资源使用量",
  "Restore protection": "恢复保护",
  "Retention pending": "保留待处理",
  "Retention {value}": "保留期 {value}",
  "Review node capacity, status, and workload pressure.": "查看节点容量、状态和工作负载压力。",
  "Review the current managed image and older saved versions for {appName}. Image storage is tracked separately from live service disk usage here, and stale versions can be redeployed or removed.": "查看 {appName} 的当前托管镜像和较早保存版本。这里的镜像存储会与在线服务磁盘用量分开统计，旧版本可重新部署或移除。",
  ...
  "Route table JSON must include domains and entrypoints arrays.": "路由表 JSON 必须包含 domains 和 entrypoints 数组。",
  "Route table must be a JSON object.": "路由表必须是JSON对象。",
  "Route updated. The new address is live immediately, and the old address has been released.": "路由已更新。新地址立即生效，旧地址已释放。",
  ...
  "Sign-in was verified, but Fugue could not open your workspace session. Try again in a minute.": "登录已验证，但Fugue无法打开您的工作区会话。请稍后重试。",
  "Sign-in was verified, but the browser session handoff expired before the cookie was written. Start again.": "登录已验证，但浏览器会话切换在写入Cookie之前已过期。请重新开始。",
  "Sources": "来源",
  "Stable redirect / returnTo": "稳定重定向 / returnTo",
  "Standby update is queued. Fugue will move failover to {pendingTargetLabel} while {primaryRuntimeLabel} keeps serving writes.{suffix}": "备用实例更新已排队。Fugue 会把故障转移目标迁移到 {pendingTargetLabel}，同时 {primaryRuntimeLabel} 继续处理写入。{suffix}",
  ...
  "That email link is invalid or expired. Request a fresh one.": "该邮箱链接无效或已过期。请重新请求。",
  "The database stays on its primary runtime. The standby runtime only takes over if the primary disappears. After a failover, choose a new standby to restore protection.": "数据库停留在其主运行时。备用运行时仅在主运行时消失时接管。故障转移后，选择一个新的备用以恢复保护。",
  "The image version that currently represents this app.": "当前表示此应用的镜像版本。",
  "This flow creates a platform-node key, not a tenant runtime key. The joined VPS stays platform-owned and can be promoted or constrained later.": "此流程创建平台节点密钥，而不是租户运行时密钥。加入的VPS仍然是平台所有的，可以在以后进行推广或限制。",
  "This hostname is already in use.": "此主机名已被使用。",
  "This hostname is already serving this app.": "此主机名已经为此应用提供服务。",
  "This hostname is attached, but setup hit a snag. Fugue will keep retrying in the background.": "已附加此主机名，但安装遇到了问题。Fugue将继续在后台重试。",
  "This hostname is attached. Fugue is finishing setup now.": "已附加此主机名。Fugue现在正在完成设置。",
  "This hostname is invalid.": "此主机名无效。",
  "This platform hostname is reserved. Platform admins can attach the root domain directly, but regular workspaces cannot claim it.": "此平台主机名已保留。平台管理员可以直接附加根域，但常规工作区无法声明。",
  ...
  "This server is offline and no longer reporting heartbeats.": "此服务器处于离线状态，不再报告心跳。",
  ...
  "Unable to load GitHub image update settings right now.": "目前无法加载GitHub镜像更新设置。",
  "Unable to load saved images right now. Try refreshing this panel.": "目前无法加载保存的镜像。请尝试刷新此面板。",
  "Update repository": "更新仓库",
  "Updates": "更新",
  "Uploaded": "上传成功",
  "Use / for the root route, or /api for a path route.": "根路由使用 /，路径路由可使用 /api。",
  ...
  "Used only when Fugue needs to create the file for the first time. Existing file contents stay in place on later deploys.": "仅在Fugue需要首次创建文件时使用。现有文件内容在稍后部署时保持不变。",
  "User directory": "用户目录",
  "Variables": "变量",
  "Wait for project deletion to finish before renaming it.": "在重命名项目之前，等待项目删除完成。",
  "What happens next": "接下来会发生什么",
  "When you issue a key, Fugue returns a one-time join command here so the next VPS can attach as a platform node immediately.": "当您发出密钥时，Fugue在此处返回一次性加入命令，以便下一个VPS可以立即作为平台节点连接。",
  "Work": "工作",
  "Workspace API keys control Fugue API access and automation scopes.": "工作区 API 密钥用于控制 Fugue API 访问和自动化权限范围。",
  "Workspace missing": "缺少工作区",
  "Keep secrets out of deploy links.": "不要在部署链接中包含密钥。",
  "Image storage": "镜像存储",
  "Live service runtime only": "仅在线服务运行时",
  "No environment variables will be applied on the first deploy.": "首次部署不会应用任何环境变量。",
  "No environment variables will be set on the first deploy.": "首次部署不会设置任何环境变量。",
  ...
  "projects": "项目",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically.": "Fugue 准备 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically. {transferPreparationNote}": "Fugue 准备 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。{transferPreparationNote}",
  "{email} will lose admin access and stay in the workspace as a regular user.": "{email} 将失去管理员访问权限，并以普通用户身份留在工作区。",
  "{label} copied.": "{label} 已复制。",
  "{name} and its {count} services will be queued for deletion from this workspace. {preview}": "{name} 及其 {count} 个服务将加入队列，并从此工作区删除。{preview}",
  "{name} is no longer reporting heartbeats.": "{name} 不再上报心跳。",
  "{provider} sign-in could not be completed. Check the callback URL and provider credentials, then try again.": "{provider}登录无法完成。请检查回调URL和提供商凭据，然后重试。",
  "{provider} sign-in details": "{provider} 登录详情",
  "{provider} sign-in was cancelled before authorization finished.": "{provider}登录在授权完成前被取消。",
  "{title} will be removed from {appName}'s saved image history.": "{title} 将从 {appName} 的已保存镜像历史中移除。",
...
const zhTWMorlanePatchMessages = {
  ...
  "Abort the in-flight build and force delete this service.": "中止飛行中組建並強制刪除此服務。",
  "Abort the in-flight deploy and force delete this service.": "中止飛行中部署並強制刪除此服務。",
  "Aborting…": "正在放棄",
  "Access key snapshot unavailable": "存取金鑰快照無法使用",
  "Account": "我的帳號",
  "Active": "作用中",
  "Add a directory or file mount to keep it across redeploys, restarts, runtime moves, and failover.": "新增目錄或檔案掛載，將其保留在重新部署、重新啟動、執行階段移動和容錯移轉之間。",
  "Add a workspace admin key for another environment, or copy a stored secret.": "新增其他環境的工作區系統管理金鑰，或複製儲存的機密。",
  "Add admin key": "添加管理员金鑰",
  "Add credits before you raise the saved cap. Fugue deducts credits from active resources, and stored images count toward disk usage.": "提高已儲存上限前请先充值餘額。Fugue 会从活动資源中扣除餘額，已儲存映像也会计入磁盘用量。",
  "Add directory": "新增目錄…",
  "Add file": "添加檔案",
  "Adjust from 0 to {max} GiB in {step} GiB steps.": "从 0 到 {max} GiB 调整，步进为 {step} GiB。",
  "Adjust from 0 to {max} cpu in {step} cpu steps.": "从 0 到 {max} CPU 调整，步进为 {step} CPU。",
  ...
  "Allow DNS": "允許DNS",
  "Allow edge": "允許邊緣",
  "Another project already uses “{name}”. Project names must be unique within the workspace.": "另一個專案已使用「{name}」。專案名稱在工作區中必須是唯一的。",
  ...
  "Bind one repository for this project. Fugue reads the repository workflow image outputs and maps them to app services automatically.": "为此專案绑定一个儲存庫。Fugue 会读取儲存庫工作流输出的映像，并自动映射到應用服務。",
  "Bind project": "綁定專案",
  "Binding…": "正在绑定…",
  "Bootstrap a workspace before enrolling servers into Fugue.": "先初始化工作區，再将伺服器接入 Fugue。",
  "Bootstrap the workspace to create the first node key.": "初始化工作區以建立第一个節點金鑰。",
  "Bottleneck": "瓶颈",
  "Branch, app name, build strategy, and optional source paths": "分支、應用程式名稱、構建策略和可選的來源路徑",
  "Build": "構造",
  "Build aborted. Force delete queued.": "組建已中止。強制刪除已排入佇列。",
  "Build is still running. Switch to Build to follow progress.": "生成仍在運行。切換至「建立」以追蹤進度。",
  "Cancel rollout & delete": "取消發布並刪除",
  "Cancel the in-flight transfer and force delete this service.": "取消機上轉機並強制刪除此服務。",
  ...
  "Deploy onto this machine. It also contributes to the internal cluster.": "部署到這台機器。它也會為內部叢集提供容量。",
  "Cancel the queued rollout and force delete this service.": "取消佇列發布並強制刪除此服務。",
  "Cancel transfer & delete": "取消轉移並刪除",
  "Choose Google or a verified email link. Password can be added later from the profile page.": "選擇Google或已驗證的電子郵件連結。稍後可以從個人資料頁面新增密碼。",
  "Clear": "清除",
  "Clear filters": "清除篩選器",
  "Clear history": "清除歷程",
  "Clear raw": "清空原始内容",
  ...
  "Create a CNAME record for {hostname} pointing to {target}. Fugue will verify it automatically once DNS resolves.": "為指向{target}的{hostname}建立CNAME記錄。解析DNS後，Fugue會自動驗證。",
  "Create a CNAME record pointing to {target}. Fugue will verify it automatically once DNS resolves.": "建立指向{target}的CNAME 记录。一旦DNS 解析，Fugue将自动验证它。",
  "Create a node key, run the join command on your VPS, or wait for another workspace to share a server with you.": "建立節點金鑰，在VPS上运行加入命令，或等待另一个工作區与您共享伺服器。",
  "Create scoped API keys and node enrollment keys from one access surface.": "在同一个存取界面建立限定範圍的 API 金鑰和節點接入金鑰。",
  "Create the first project, import a service, and Fugue will attach route controls when the first app record is ready.": "建立第一个專案，导入服務，当第一个應用记录準備就绪时，Fugue将附加路由控件。",
  ...
  "Current primary: {primaryRuntimeLabel}. Choose a destination and Fugue will prepare the new primary before switching over.": "目前主實例：{primaryRuntimeLabel}。選擇目标后，Fugue 会先準備新的主實例再切换。",
  "Current primary: {primaryRuntimeLabel}. Destination: {activeTransferTargetLabel}. Fugue promotes the new primary automatically once it is ready.": "目前主實例：{primaryRuntimeLabel}。目标：{activeTransferTargetLabel}。準備就绪后，Fugue 会自动提升新的主實例。",
  "Current release": "目前版本",
  "DNS": "DNS",
  "Database protection restored. New standby runtime: {target}.": "資料库保護已恢复。新的備用執行環境： {target}。",
  ...
  "Delete server": "刪除伺服器",
  "Delete server records here after the underlying VPS is permanently gone.": "在底层VPS 永久消失后，在此处刪除伺服器记录。",
  "Delete this server record after the VPS is permanently retired. Fugue will block deletion while workloads or active operations still reference it.": "在VPS 永久停用后刪除此伺服器记录。当工作负载或活动操作仍然引用它时，Fugue将阻止刪除。",
  "Delete {name}?": "刪除{name} ？",
  "Deleted {name}, but refresh failed: {message}": "已刪除{name} ，但重新整理失败： {message}",
  "Deleted {name}.": "已刪除{name}。",
  "Deleting the project queues deletion for every service that still belongs to it, then removes the project shell.": "刪除仍然属于它的每个服務的專案佇列刪除，然后刪除專案shell。",
  "Deleting...": "正在刪除…",
  "Desired {state}": "期望狀態 {state}",
  "Detected image services for {projectName}": "检测到{projectName}的映像服務",
  "Digest": "摘要",
  "Directories keep whole trees. Files mount one exact path.": "目錄儲存整棵树。檔案挂载一个精确路径。",
  ...
  "Enabled": "已启用",
  "Endpoint": "端点",
  "Enter a monthly price greater than 0, or mark the server free.": "输入大于0的月租价格，或将伺服器标记为免费。",
  "Enter a non-negative memory value with up to two decimals.": "输入最多两位小数的非负内存值。",
  ...
  "Entrypoint": "入口点",
  "Environment edit modes": "环境编辑模式",
  "Failover already moved the primary to {primaryRuntimeLabel}. No standby runtime is protecting this database now. Choose a new standby to restore protection.": "故障转移已将主實例遷移到 {primaryRuntimeLabel}。目前没有備用執行環境保護此資料库。请選擇新的備用執行環境恢复保護。",
  "Failover already moved this app to {primaryRuntimeLabel}. No standby runtime is protecting it now. Choose a new standby to restore protection.": "故障转移已将此應用遷移到 {primaryRuntimeLabel}。目前没有備用執行環境保護它。请選擇新的備用執行環境恢复保護。",
  "Failover disable is queued. {primaryRuntimeLabel} keeps serving writes while Fugue removes the standby.{suffix}": "已排隊禁用故障转移。Fugue 移除備用实例期间，{primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Failover enable is queued. Fugue will prepare {pendingTargetLabel} as the standby while {primaryRuntimeLabel} keeps serving writes.{suffix}": "已排隊启用故障转移。Fugue 会将 {pendingTargetLabel} 準備为備用实例，同时 {primaryRuntimeLabel} 继续处理寫入。{suffix}",
  "Fetching billing": "正在获取账单",
  "Finish DNS setup and Fugue will verify this hostname automatically.": "完成 DNS 配置后，Fugue 会自动验证此主機名。",
  "Force delete is already queued.": "强制刪除已在佇列中。",
  "Force delete service?": "强制刪除服務？",
  "Force delete this pending service.": "强制刪除这个待处理服務。",
  "Freshness": "資料时效",
  "Fugue can still deploy it as a repository import.": "Fugue仍然可以将其部署为儲存庫导入。",
  "Fugue could not load the access key snapshot right now.": "Fugue目前无法載入存取金鑰快照。",
  "Fugue could not open the workspace session. Try again.": "Fugue无法打开工作區会话。请重试。",
  "Fugue is moving the standby to {pendingTargetLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}": "Fugue 正在将備用实例遷移到 {pendingTargetLabel}。变更期间 {primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Fugue is provisioning {pendingTargetLabel} as the standby. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}": "Fugue 正在将 {pendingTargetLabel} 配置为備用实例。变更期间 {primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Fugue is removing the standby from {configuredStandbyLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}": "Fugue 正在从 {configuredStandbyLabel} 移除備用实例。变更期间 {primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  ...
  "Give the project a name, then point Fugue at the first GitHub repository, local folder, or Docker image.": "先为專案命名，然后将 Fugue 指向第一个 GitHub 儲存庫、本地檔案夹或 Docker 映像。",
  "Google": "Google",
  "Google route": "Google 路径",
  "Historical image queued for deploy.": "歷史映像已排隊部署。",
  "Historical image selected for deploy.": "已選擇歷史映像进行部署。",
  "Historical versions appear here after the app has been imported or redeployed through Fugue.": "應用通过 Fugue 导入或重新部署后，歷史版本会显示在这里。",
  "Host": "主機",
  "Image ref": "映像引用",
  "Image updates": "映像更新",
  "Import / {projectName}": "导入/{projectName}",
  "Import a GitHub repository, local folder, or Docker image to create the first app.": "导入GitHub 儲存庫、本地檔案夹或Docker 映像以建立第一个應用。",
  "Import is already running.": "导入已在进行中。",
  "Import is still running. Switch to Build to follow progress.": "导入仍在进行中。切换到“构建”查看进度。",
  ...
  "Initial contents": "初始内容",
  "Inspect all cluster apps, tenants, routing state, rebuild controls, and deletes.": "檢查所有叢集應用、租户、路由狀態、重建控件和刪除。",
  "Inspect control-plane state, runtime pressure, workloads, and enrollment.": "檢查控制平面狀態、執行環境压力、工作负载和註冊。",
  "Internal cluster": "內部叢集",
  "Internal registry inventory is not configured for this workspace yet.": "尚未为此工作區配置內部註冊表清单。",
  "Invalid": "無效",
  ...
  "Just now": "刚刚",
  "Keep prepaid balance, managed capacity, and retained image storage aligned for this workspace.": "保持此工作區的预付餘額、托管容量和保留映像儲存一致。",
  "Keep server": "保留伺服器",
  "Keep this database on its current primary runtime, choose a standby runtime for failover, or actively move the primary now.": "将此資料库保留在其目前主執行環境上，選擇用于故障转移的備用執行環境，或立即主动移动主執行環境。",
  "Key label": "金鑰标签",
  "Kind": "類型",
  "Last contact": "最近联系",
  "Last contact {time}": "最近联系 {time}",
  "Last deployed {time}": "上次部署{time}",
  "Leave blank to let Fugue generate the node key label.": "留空让Fugue生成節點金鑰标签。",
  "Legacy": "旧版",
  "Live": "線上",
  "Load trace": "載入追踪",
  ...
  "Local files are selected after sign-in, not before the auth redirect.": "本地檔案需要在登入后選擇，而不是在认证跳转之前。",
  "Local upload": "本地上传",
  "Local uploads": "本地上传",
  "Log views": "日志视图",
  "Magic link / 15 min": "魔法連結 / 15 分钟",
  "Manage account state and quota context from the admin surface.": "从管理界面管理帳號狀態和配额上下文。",
  "Monitor attached runtime servers, capacity, heartbeat, and offline records.": "监控连接的執行環境伺服器、容量、心跳和離線记录。",
  "Most image data for this version is still shared with other saved images.": "此版本的大多数映像資料仍与其他儲存的映像共享。",
  "Most image data in this history is still shared with other saved images.": "此歷史记录中的大多数映像資料仍与其他儲存的映像共享。",
  "Mount path": "挂载路径",
  "Mount {count}": "挂载 {count}",
  "New project": "新專案",
  "Next": "下一步",
  ...
  "No live servers are reporting right now. Offline servers that still belong to this workspace are listed below.": "目前没有線上伺服器上报。仍属于此工作區的離線伺服器列在下方。",
  ...
  "No workloads": "无工作负载",
  "No workloads are assigned.": "未分配工作负载。",
  "No workloads are attached to this offline server.": "没有工作负载附加到此離線伺服器。",
  "No workspace keys yet": "尚无工作區金鑰",
  "Node keys enroll servers into the Fugue runtime plane.": "節點金鑰将伺服器註冊到Fugue執行環境平面。",
  "Not live": "未上線",
  "Observability": "可观测性",
  ...
  "Open commit": "打开提交",
  "Opening the console with a first-party session.": "正在用第一方会话打开控制台。",
  "Operate cluster apps without leaving the admin surface.": "无需离开管理界面即可运行叢集應用。",
  "Partial Fugue data": "Fugue 資料部分可用",
  "Partial admin data": "部分管理员資料",
  "Partial server data": "部分伺服器資料",
  "Password details": "密码詳情",
  "Paste KEY=value lines directly from a .env file. Quoted values, blank lines, comments, and export prefixes are supported.": "可直接从 .env 檔案粘贴 KEY=value 行。支持带引号的值、空行、注释和 export 前缀。",
  "Paste a GitHub repository link and choose GitHub authorization or a token for private access.": "粘贴GitHub 儲存庫連結，然后選擇GitHub授权或私有存取令牌。",
  "Path": "路径",
  "Path must stay inside persistent storage. Switch to Live filesystem to work outside it.": "路径必须位于永久儲存内。切换到Live檔案系统以在其外部工作。",
  "Path prefix": "路径前缀",
  "Pending": "待处理",
  "Pending first import": "等待首次导入",
  ...
  "Point Fugue at a published Docker image. Fugue mirrors it into the internal registry before rollout.": "将Fugue指向已發布的Docker 映像。在發布之前，Fugue将其映像到內部註冊表中。",
  "Primary database": "主資料库",
  "Primary placement stays as-is until a later maintenance window, rebuild, node drain, or explicit rebalance.": "主實例部署位置会保持不变，直到后续维护窗口、重建、節點排空或明確重新均衡。",
  "Privacy-focused browsers sometimes need one extra first-party handoff before the destination session is available.": "以隐私为重点的浏览器有时需要额外一次第一方切换，目标会话才可用。",
  "Project deletion started.": "專案刪除已开始。",
  "Project deletion started. Remaining services are being removed.": "專案刪除已开始。剩余服務正在刪除。",
  ...
  "Projects collect services, routes, runtime placement, environment, and deployment controls.": "專案用于组织服務、路由、執行環境位置、环境變數和部署控制。",
  "Protection missing": "缺少保護",
  "Protection restored. New standby runtime: {target}.": "保護已恢复。新的備用執行環境： {target}。",
  "Public access": "公開存取",
  "Public image refs are mirrored into Fugue before rollout": "公开映像引用会在發布前同步到 Fugue",
  "Public or private with GitHub authorization or a stored token": "公开儲存庫，或通过 GitHub 授权 / 已儲存 Token 存取的私有儲存庫",
  "Queued rollout canceled. Force delete queued.": "已取消排隊中的發布，强制刪除已加入佇列。",
  ...
  "Reconnecting to live logs…": "正在重新连接实时日志…",
  "Redeploy a known-good version, or delete stale images you no longer need.": "重新部署已知良好的版本，或刪除不再需要的陈旧映像。",
  ...
  "Remove mount": "移除挂载",
  "Remove {name}": "移除{name}",
  "Remove {name} from the server inventory only if this VPS is permanently gone. Fugue will refuse the delete if apps, services, or active operations still depend on it.": "仅当此VPS 永久消失时，才从伺服器清单中刪除{name}。如果應用、服務或活动操作仍然依赖于它，则Fugue将拒绝刪除。",
  "Repository-backed services auto sync; image-backed services can repull the saved image ref": "儲存庫服務会自动同步；映像服務可重新拉取已儲存的映像引用",
  "Request canceled.": "请求已取消。",
  "Request failed.": "请求失败。",
  ...
  "Return route": "返回路径",
  "Review image": "檢查映像",
  "Review node capacity, status, and workload pressure.": "查看節點容量、狀態和工作负载压力。",
  "Review the current managed image and older saved versions for {appName}. Image storage is tracked separately from live service disk usage here, and stale versions can be redeployed or removed.": "查看{appName}的目前托管映像和较旧的已儲存版本。映像儲存在此处与線上服務磁盘使用情况分开跟踪，并且可以重新部署或刪除过时的版本。",
  ...
  "Sign-in was verified, but Fugue could not open your workspace session. Try again in a minute.": "登入已验证，但Fugue无法打开您的工作區会话。请稍后重试。",
  "Sign-in was verified, but the browser session handoff expired before the cookie was written. Start again.": "登入已验证，但浏览器会话切换在寫入Cookie之前已过期。请重新开始。",
  "Sources": "来源",
  "Stable redirect / returnTo": "稳定重定向 / returnTo",
  "Standby update is queued. Fugue will move failover to {pendingTargetLabel} while {primaryRuntimeLabel} keeps serving writes.{suffix}": "備用更新已排隊。Fugue将故障转移到{pendingTargetLabel} ，而{primaryRuntimeLabel}继续服務寫入。{suffix}",
  "Start queued at 1 replica.": "已加入啟動佇列，副本数为 1。",
  "Start shared. Move cleanly.": "先使用共享环境，再平稳遷移。",
  "Start this paused app at 1 replica without rebuilding the image.": "在不重建映像的情况下，以 1 个副本啟動这个已暂停應用。",
  "Starting…": "正在啟動…",
  "Starts after first deploy": "首次部署后开始",
  "Starts after first deploy.": "首次部署后开始。",
  ...
  "TTFB": "TTFB",
  "Template deploy": "模板部署",
  "That email link is invalid or expired. Request a fresh one.": "该電子郵件連結無效或已过期。请重新请求。",
  "The database stays on its primary runtime. The standby runtime only takes over if the primary disappears. After a failover, choose a new standby to restore protection.": "資料库停留在其主執行環境。備用執行環境仅在主執行環境消失时接管。故障转移后，選擇一个新的備用以恢复保護。",
  "The image version that currently represents this app.": "目前表示此應用的映像版本。",
  "This account has been deleted and can no longer sign in.": "此帳號已被刪除，无法再登入。",
  "This account is blocked. Contact an administrator.": "此帳號已被封禁。请联系管理员。",
  "This app is paused. Start it to reopen runtime logs without rebuilding, or use Redeploy for a fresh build.": "该應用已暂停。啟動它即可在不重建的情况下重新打开執行環境日志，或使用“重新部署”进行一次全新构建。",
  "This flow creates a platform-node key, not a tenant runtime key. The joined VPS stays platform-owned and can be promoted or constrained later.": "此流程建立平台節點金鑰，而不是租户執行環境金鑰。加入的VPS仍然是平台所有的，可以在以后进行推广或限制。",
  "This hostname is already in use.": "此主機名已被使用。",
  "This hostname is already serving this app.": "此主機名已经为此應用提供服務。",
  "This hostname is attached, but setup hit a snag. Fugue will keep retrying in the background.": "已附加此主機名，但安装遇到了问题。Fugue将继续在后台重试。",
  "This hostname is attached. Fugue is finishing setup now.": "已附加此主機名。Fugue现在正在完成設定。",
  "This hostname is invalid.": "此主機名無效。",
  "This platform hostname is reserved. Platform admins can attach the root domain directly, but regular workspaces cannot claim it.": "此平台主機名已保留。平台管理员可以直接附加根域，但常规工作區无法声明。",
  "This repository does not expose template metadata in": "此儲存庫不公开模板元資料",
  "This rollout has not reached a live runtime yet. Switch to Build to follow progress.": "本次發布尚未进入線上執行環境。切换到“构建”查看进度。",
  "This route is already current.": "此路由已处于目前狀態。",
  "This route is already in use.": "此路由已被使用。",
  "This route is invalid.": "此路由無效",
  "This server is offline and no longer reporting heartbeats.": "此伺服器处于離線狀態，不再报告心跳。",
  "This server is offline. {details}": "此伺服器处于離線狀態。{details}",
  "This sign-in handoff is missing or expired. Start again from the sign-in page.": "此登入切换缺失或已过期。请从登入页重新开始。",
  "Time": "时间",
  ...
  "Unable to load GitHub image update settings right now.": "目前无法載入GitHub映像更新設定。",
  "Unable to load saved images right now. Try refreshing this panel.": "目前无法載入儲存的映像。请尝试重新整理此面板。",
  "Unknown": "未知",
  "Unknown owner": "未知归属者",
  "Unverified": "未验证",
  ...
  "Updates": "更新",
  "Uploaded": "上传成功",
  "Use / for the root route, or /api for a path route.": "根路由使用/，路径路由使用/api。",
  ...
  "Used only when Fugue needs to create the file for the first time. Existing file contents stay in place on later deploys.": "仅在Fugue需要首次建立檔案时使用。现有檔案内容在稍后部署时保持不变。",
  "User directory": "用户目錄",
  "Users": "用户",
  "Users unavailable": "用户暂不可用",
  "Variables": "變數",
  "Verified": "已验证",
  "Wait for project deletion to finish before renaming it.": "在重命名專案之前，等待專案刪除完成。",
  "Waiting for first start": "等待首次啟動",
  "Waiting for import": "等待导入",
  "We are converting the provider callback into a first-party session before opening the destination route.": "我们正在把提供方回调转换成第一方会话，然后再打开目标路由。",
  "What happens next": "接下来会发生什么",
  "When you issue a key, Fugue returns a one-time join command here so the next VPS can attach as a platform node immediately.": "当您发出金鑰时，Fugue在此处返回一次性加入命令，以便下一个VPS可以立即作为平台節點连接。",
  "Work": "工作",
  "Workspace API keys control Fugue API access and automation scopes.": "工作區 API 金鑰用于控制 Fugue API 存取和自动化權限範圍。",
  "Workspace missing": "缺少工作區",
  "Keep secrets out of deploy links.": "不要在部署連結中包含機密。",
  "Image storage": "映像儲存",
  "Live service runtime only": "僅限線上服務執行階段",
  "No environment variables will be applied on the first deploy.": "首次部署不會套用任何環境變數。",
  "No environment variables will be set on the first deploy.": "首次部署不會設定任何環境變數。",
  ...
  "projects": "專案",
  "you@company.com": "you@company.com",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically.": "Fugue 準備 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically. {transferPreparationNote}": "Fugue 準備 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。{transferPreparationNote}",
  "{email} will lose admin access and stay in the workspace as a regular user.": "{email}将失去管理员存取權限，并作为普通用户留在工作區中。",
  "{label} copied.": "{label}已複製。",
  "{name} and its {count} services will be queued for deletion from this workspace. {preview}": "{name}及其{count}服務将排隊等待从此工作區中刪除。{preview}",
  "{name} is no longer reporting heartbeats.": "{name}不再报告心跳。",
  "{provider} sign-in could not be completed. Check the callback URL and provider credentials, then try again.": "{provider}登入无法完成。请檢查回调URL和提供商凭据，然后重试。",
  "{provider} sign-in details": "{provider}登入詳情",
  "{provider} sign-in was cancelled before authorization finished.": "{provider}登入在授权完成前被取消。",
  "{title} will be removed from {appName}'s saved image history.": "{title}将从{appName}儲存的映像歷史记录中刪除。",
  "{value} {unit}": "{value} {unit}",
} satisfies MessageCatalog;
