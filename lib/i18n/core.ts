...
const zhCNMorlanePatchMessages = {
  ...
  "Add directories or files that must stay attached after deploys and restarts.": "添加部署和重启后仍需保留的目录或文件。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents are only used the first time Fugue creates that file.": "添加重新部署、重启和运行时迁移后仍需保留的目录或文件。文件内容只会在 Fugue 首次创建该文件时使用。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents only apply when Fugue creates the file for the first time.": "添加重新部署、重启和运行时迁移后仍需保留的目录或文件。文件内容只在 Fugue 首次创建该文件时生效。",
  "After submission, Fugue creates the app and starts the import operation immediately.": "提交后，Fugue 会创建应用并立即启动导入操作。",
  "App name, startup command, and optional build overrides.": "应用名称、启动命令和可选构建覆盖项。",
  "Auto detect keeps compose and fugue manifest imports intact.": "自动检测会保留 compose 和 fugue manifest 的完整导入。",
  "Auto detect works for most repositories.": "自动检测适用于大多数仓库。",
  "Auto-generate on deploy": "部署时自动生成",
  "Background workers run without a managed route, Kubernetes Service, or readiness port.": "后台工作进程不创建托管路由、Kubernetes Service 或就绪端口。",
  "Background workers skip the managed route, Kubernetes Service, and readiness port.": "后台工作进程会跳过托管路由、Kubernetes Service 和就绪端口。",
  "Clear filters": "清除筛选",
  ...
  "Choose where the mirrored image should land for the first rollout.": "选择镜像首轮发布要落到哪里。",
  "Choose where the upload should land. Only add manual build settings when the upload is meant to deploy as a single app instead of a full manifest or compose topology.": "选择上传内容要落到哪里。只有当上传内容要作为单应用部署，而不是完整 manifest 或 compose 拓扑时，才添加手动构建设置。",
  "Choose whether Fugue should expose this app publicly, keep it cluster-internal, or run it as a background worker.": "选择 Fugue 是公开暴露此应用、保持集群内部访问，还是作为后台工作进程运行。",
  "Current": "当前",
  ...
  "Drag a local folder, .zip, .tgz, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Fugue packages file uploads on the server, then imports the detected topology when present.": "拖入本地文件夹、.zip、.tgz、docker-compose.yml、fugue.yaml、Dockerfile 或多个源码文件。Fugue 会在服务端打包上传文件，并在检测到拓扑时执行完整导入。",
  "Drag a local folder, a .zip or .tgz archive, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Folder drop works when the browser exposes directory entries.": "拖入本地文件夹、.zip 或 .tgz 归档、docker-compose.yml、fugue.yaml、Dockerfile 或多个源码文件。浏览器暴露目录条目时可以直接拖入文件夹。",
  "Enter the value that should exist before the first deploy.": "输入首次部署前应存在的值。",
  "Enter value": "输入值",
  "Folder / ZIP / compose": "文件夹 / ZIP / Compose",
  "Folder drag": "文件夹拖放",
  "Fugue creates the project if needed, packages the selected files, and then sends you back to the console.": "Fugue 会按需创建项目，打包所选文件，然后带你返回控制台。",
  "Fugue will import this archive directly. GitHub download ZIP files work as-is, without repackaging them in the browser.": "Fugue 会直接导入此归档。GitHub 下载的 ZIP 文件可原样使用，无需在浏览器中重新打包。",
  "Fugue will package these files on the server, then import them through the same upload route used by local deploys.": "Fugue 会在服务端打包这些文件，然后通过本地部署使用的同一上传路径导入。",
  "Fugue mirrors the published image into the internal registry, creates the app, and queues the first rollout onto the selected runtime.": "Fugue 会把已发布镜像同步到内部镜像仓库，创建应用，并将首轮发布加入所选运行时队列。",
  "GitHub download ready": "GitHub 下载可用",
  "Image deploy network mode": "镜像部署网络模式",
  "Includes {items}.": "包含 {items}。",
  "Internal services get a cluster-only Service and readiness checks, without a public route.": "内部服务会获得仅集群内可访问的 Service 和就绪检查，不会创建公开路由。",
  "Internal services keep a cluster-only Service and readiness checks, but Fugue does not publish a public route for them.": "内部服务会保留仅集群内可访问的 Service 和就绪检查，Fugue 不会为它们发布公开路由。",
  ...
  "Leave blank to auto-generate this value when the deploy is queued.": "留空则在部署入队时自动生成此值。",
  "Leave blank to create an empty file.": "留空则创建空文件。",
  "Leave blank to reuse the image name.": "留空则复用镜像名称。",
  "Leave blank to reuse the repository name.": "留空则复用仓库名称。",
  "Leave blank to reuse the uploaded folder or primary service name.": "留空则复用上传文件夹或主服务名称。",
  "Leave blank to use the default.": "留空则使用默认值。",
  "Leave blank to use the default value.": "留空则使用默认值。",
  "Manual build overrides are active. Clear build strategy and path overrides if you want Fugue to import every service from fugue.yaml or docker-compose.": "手动构建覆盖项已启用。如果希望 Fugue 从 fugue.yaml 或 docker-compose 导入所有服务，请清空构建策略和路径覆盖项。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while this deploy preserves a whole topology. Switch back to a single-app deploy to reuse them.": "手动持久化存储挂载会保留在此草稿中，但当前部署保留完整拓扑时 Fugue 会跳过它们。切回单应用部署即可复用。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while the upload imports a whole topology. Switch back to a single-app upload to reuse them.": "手动持久化存储挂载会保留在此草稿中，但上传内容导入完整拓扑时 Fugue 会跳过它们。切回单应用上传即可复用。",
  "Manifest import": "Manifest 导入",
  "Multi-service ready": "多服务就绪",
  "Name {name}": "名称 {name}",
  "New project name": "新项目名称",
  "Override the default entrypoint only when this upload should start with a custom shell command.": "仅当此上传内容需要使用自定义 shell 命令启动时，才覆盖默认入口。",
  "Override the image default entrypoint only when this service needs a different launch command.": "仅当此服务需要不同启动命令时，才覆盖镜像默认入口。",
  "Primary service: {service}.": "主服务：{service}。",
  "Project inventory is unavailable right now. You can still deploy into a new project.": "项目清单当前不可用。你仍可部署到一个新项目。",
  "Public image references work best for one-click deploy links because this flow does not collect registry credentials.": "一键部署链接最适合使用公开镜像引用，因为此流程不会收集镜像仓库凭据。",
  "Public services get a managed route and readiness checks.": "公开服务会获得托管路由和就绪检查。",
  "Public services get a managed route. Internal services stay cluster-only. Background workers skip route and readiness setup.": "公开服务会获得托管路由。内部服务仅限集群内访问。后台工作进程会跳过路由和就绪设置。",
  "Queue deployment": "排队部署",
  "Queue image deploy": "排队镜像部署",
  "Queueing image deploy…": "正在排队镜像部署…",
  "Queuing deploy": "正在排队部署",
  "Repository build": "仓库构建",
  "Required when the Dockerfile is outside the uploaded root.": "Dockerfile 位于上传根目录外时必填。",
  "Reuse an existing project or create a new one for this deploy.": "复用现有项目，或为此次部署创建新项目。",
  "Runs as `sh -lc <command>`. Leave blank to use the image default entrypoint.": "以 `sh -lc <command>` 运行。留空则使用镜像默认入口。",
  "Service {service}. Leave blank to create an empty file on first deploy.": "服务 {service}。留空则在首次部署时创建空文件。",
  ...
  "TGZ archive": "TGZ 归档",
  "The browser keeps files local until you submit the deploy.": "提交部署前，浏览器会将文件保留在本地。",
  "This project will be created before the deploy is queued.": "此项目会在部署入队前创建。",
  "Upload and deploy": "上传并部署",
  "Upload ready": "上传已就绪",
  "Upload deploy network mode": "上传部署网络模式",
  "Uploading deploy": "正在上传部署",
  "Use a pullable public image reference such as ghcr.io/example/api:1.2.3.": "使用可拉取的公开镜像引用，例如 ghcr.io/example/api:1.2.3。",
  "Use when the app lives below the repo root.": "应用位于仓库根目录下级路径时使用。",
  "Use when the app lives below the uploaded root.": "应用位于上传根目录下级路径时使用。",
  "Whole-topology import is ready. Leave build strategy on Auto detect and keep manual path overrides blank to import every service from fugue.yaml or docker-compose.": "完整拓扑导入已就绪。保持构建策略为自动检测，并留空手动路径覆盖项，即可从 fugue.yaml 或 docker-compose 导入所有服务。",
  "Whole-topology imports keep per-service networking from fugue.yaml or docker-compose, so manual network mode is unavailable here.": "完整拓扑导入会保留 fugue.yaml 或 docker-compose 中的逐服务网络设置，因此这里不可手动设置网络模式。",
  "Whole-topology uploads keep per-service networking from fugue.yaml or docker-compose.yml, so manual network mode is only available for single-app uploads.": "完整拓扑上传会保留 fugue.yaml 或 docker-compose.yml 中的逐服务网络设置，因此手动网络模式只适用于单应用上传。",
  "ZIP archive": "ZIP 归档",
  ...
  "{count} warning found in {path}. Review before deploying.": "在 {path} 中发现 {count} 条警告。部署前请检查。",
  "{count} warnings found in {path}. Review before deploying.": "在 {path} 中发现 {count} 条警告。部署前请检查。",
...
const zhTWMorlanePatchMessages = {
  ...
  "Add directories or files that must stay attached after deploys and restarts.": "新增部署和重新啟動後仍需保留的目錄或檔案。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents are only used the first time Fugue creates that file.": "新增重新部署、重新啟動和執行階段遷移後仍需保留的目錄或檔案。檔案內容只會在 Fugue 第一次建立該檔案時使用。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents only apply when Fugue creates the file for the first time.": "新增重新部署、重新啟動和執行階段遷移後仍需保留的目錄或檔案。檔案內容只會在 Fugue 第一次建立該檔案時生效。",
  "After submission, Fugue creates the app and starts the import operation immediately.": "提交後，Fugue 會建立應用並立即啟動匯入操作。",
  "App name, startup command, and optional build overrides.": "應用名稱、啟動命令和可選建置覆寫項。",
  "Auto detect keeps compose and fugue manifest imports intact.": "自動偵測會保留 compose 和 fugue manifest 的完整匯入。",
  "Auto detect works for most repositories.": "自動偵測適用於大多數儲存庫。",
  "Auto-generate on deploy": "部署時自動產生",
  "Background workers run without a managed route, Kubernetes Service, or readiness port.": "背景工作者不會建立受管路由、Kubernetes Service 或就緒連接埠。",
  "Background workers skip the managed route, Kubernetes Service, and readiness port.": "背景工作者會略過受管路由、Kubernetes Service 和就緒連接埠。",
  "Build": "構造",
  ...
  "Choose where the mirrored image should land for the first rollout.": "選擇鏡像首次發布要落到哪裡。",
  "Choose where the upload should land. Only add manual build settings when the upload is meant to deploy as a single app instead of a full manifest or compose topology.": "選擇上傳內容要落到哪裡。只有當上傳內容要作為單一應用部署，而不是完整 manifest 或 compose 拓撲時，才新增手動建置設定。",
  "Choose whether Fugue should expose this app publicly, keep it cluster-internal, or run it as a background worker.": "選擇 Fugue 是公開此應用、保持叢集內部存取，還是作為背景工作者執行。",
  ...
  "Drag a local folder, .zip, .tgz, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Fugue packages file uploads on the server, then imports the detected topology when present.": "拖入本機資料夾、.zip、.tgz、docker-compose.yml、fugue.yaml、Dockerfile 或多個原始碼檔案。Fugue 會在伺服器端打包上傳檔案，並在偵測到拓撲時執行完整匯入。",
  "Drag a local folder, a .zip or .tgz archive, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Folder drop works when the browser exposes directory entries.": "拖入本機資料夾、.zip 或 .tgz 封存檔、docker-compose.yml、fugue.yaml、Dockerfile 或多個原始碼檔案。瀏覽器暴露目錄項目時可以直接拖入資料夾。",
  "Enter the value that should exist before the first deploy.": "輸入首次部署前應存在的值。",
  "Enter value": "輸入值",
  "Folder / ZIP / compose": "資料夾 / ZIP / Compose",
  "Folder drag": "資料夾拖放",
  "Fugue creates the project if needed, packages the selected files, and then sends you back to the console.": "Fugue 會視需要建立專案，打包所選檔案，然後帶你回到控制台。",
  "Fugue will import this archive directly. GitHub download ZIP files work as-is, without repackaging them in the browser.": "Fugue 會直接匯入此封存檔。GitHub 下載的 ZIP 檔可原樣使用，無需在瀏覽器中重新打包。",
  "Fugue will package these files on the server, then import them through the same upload route used by local deploys.": "Fugue 會在伺服器端打包這些檔案，然後透過本機部署使用的同一上傳路徑匯入。",
  "Fugue mirrors the published image into the internal registry, creates the app, and queues the first rollout onto the selected runtime.": "Fugue 會將已發布映像同步到內部映像倉庫，建立應用，並將首次發布排入所選執行環境。",
  "GitHub download ready": "GitHub 下載可用",
  "Image deploy network mode": "映像部署網路模式",
  "Includes {items}.": "包含 {items}。",
  "Internal services get a cluster-only Service and readiness checks, without a public route.": "內部服務會取得僅限叢集內存取的 Service 和就緒檢查，不會建立公開路由。",
  "Internal services keep a cluster-only Service and readiness checks, but Fugue does not publish a public route for them.": "內部服務會保留僅限叢集內存取的 Service 和就緒檢查，Fugue 不會為它們發布公開路由。",
  ...
  "Leave blank to auto-generate this value when the deploy is queued.": "留空則在部署排入佇列時自動產生此值。",
  "Leave blank to create an empty file.": "留空則建立空檔案。",
  "Leave blank to reuse the image name.": "留空則重用映像名稱。",
  "Leave blank to reuse the repository name.": "留空則重用儲存庫名稱。",
  "Leave blank to reuse the uploaded folder or primary service name.": "留空則重用上傳資料夾或主服務名稱。",
  "Leave blank to use the default.": "留空則使用預設值。",
  "Leave blank to use the default value.": "留空則使用預設值。",
  "Manual build overrides are active. Clear build strategy and path overrides if you want Fugue to import every service from fugue.yaml or docker-compose.": "手動建置覆寫項已啟用。如果希望 Fugue 從 fugue.yaml 或 docker-compose 匯入所有服務，請清空建置策略和路徑覆寫項。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while this deploy preserves a whole topology. Switch back to a single-app deploy to reuse them.": "手動持久化儲存掛載會保留在此草稿中，但目前部署保留完整拓撲時 Fugue 會略過它們。切回單一應用部署即可重用。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while the upload imports a whole topology. Switch back to a single-app upload to reuse them.": "手動持久化儲存掛載會保留在此草稿中，但上傳內容匯入完整拓撲時 Fugue 會略過它們。切回單一應用上傳即可重用。",
  "Manifest import": "Manifest 匯入",
  "Multi-service ready": "多服務就緒",
  "Name {name}": "名稱 {name}",
  "New project name": "新專案名稱",
  "Override the default entrypoint only when this upload should start with a custom shell command.": "僅當此上傳內容需要以自訂 shell 命令啟動時，才覆寫預設入口。",
  "Override the image default entrypoint only when this service needs a different launch command.": "僅當此服務需要不同啟動命令時，才覆寫映像預設入口。",
  "Primary service: {service}.": "主服務：{service}。",
  "Project inventory is unavailable right now. You can still deploy into a new project.": "專案清單目前無法使用。你仍可部署到新專案。",
  "Public image references work best for one-click deploy links because this flow does not collect registry credentials.": "一鍵部署連結最適合使用公開映像引用，因為此流程不會收集映像倉庫憑證。",
  "Public services get a managed route and readiness checks.": "公開服務會取得受管路由和就緒檢查。",
  "Public services get a managed route. Internal services stay cluster-only. Background workers skip route and readiness setup.": "公開服務會取得受管路由。內部服務僅限叢集內存取。背景工作者會略過路由和就緒設定。",
  "Queue deployment": "排隊部署",
  "Queue image deploy": "排隊映像部署",
  "Queueing image deploy…": "正在排隊映像部署…",
  "Queuing deploy": "正在排隊部署",
  "Repository build": "儲存庫建置",
  "Required when the Dockerfile is outside the uploaded root.": "Dockerfile 位於上傳根目錄外時必填。",
  "Reuse an existing project or create a new one for this deploy.": "重用現有專案，或為此次部署建立新專案。",
  "Runs as `sh -lc <command>`. Leave blank to use the image default entrypoint.": "以 `sh -lc <command>` 執行。留空則使用映像預設入口。",
  "Service {service}. Leave blank to create an empty file on first deploy.": "服務 {service}。留空則在首次部署時建立空檔案。",
  ...
  "TGZ archive": "TGZ 封存檔",
  "The browser keeps files local until you submit the deploy.": "提交部署前，瀏覽器會將檔案保留在本機。",
  "This project will be created before the deploy is queued.": "此專案會在部署排入佇列前建立。",
  "Upload and deploy": "上傳並部署",
  "Upload ready": "上傳已就緒",
  "Upload deploy network mode": "上傳部署網路模式",
  "Uploading deploy": "正在上傳部署",
  "Use a pullable public image reference such as ghcr.io/example/api:1.2.3.": "使用可拉取的公開映像引用，例如 ghcr.io/example/api:1.2.3。",
  "Use when the app lives below the repo root.": "應用位於儲存庫根目錄下層路徑時使用。",
  "Use when the app lives below the uploaded root.": "應用位於上傳根目錄下層路徑時使用。",
  "Whole-topology import is ready. Leave build strategy on Auto detect and keep manual path overrides blank to import every service from fugue.yaml or docker-compose.": "完整拓撲匯入已就緒。保持建置策略為自動偵測，並留空手動路徑覆寫項，即可從 fugue.yaml 或 docker-compose 匯入所有服務。",
  "Whole-topology imports keep per-service networking from fugue.yaml or docker-compose, so manual network mode is unavailable here.": "完整拓撲匯入會保留 fugue.yaml 或 docker-compose 中的逐服務網路設定，因此這裡無法手動設定網路模式。",
  "Whole-topology uploads keep per-service networking from fugue.yaml or docker-compose.yml, so manual network mode is only available for single-app uploads.": "完整拓撲上傳會保留 fugue.yaml 或 docker-compose.yml 中的逐服務網路設定，因此手動網路模式只適用於單一應用上傳。",
  "ZIP archive": "ZIP 封存檔",
  "ZIP or TGZ": "ZIP 或 TGZ",
  "archive": "封存檔",
  ...
  "{count} warning found in {path}. Review before deploying.": "在 {path} 中發現 {count} 條警告。部署前請檢查。",
  "{count} warnings found in {path}. Review before deploying.": "在 {path} 中發現 {count} 條警告。部署前請檢查。",
