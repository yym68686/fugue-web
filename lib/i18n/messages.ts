...
export const zhCN = {
  ...
  Projects: "项目",
  "Object storage": "对象存储",
  "Private buckets for your projects. Data survives application releases.": "项目专属的私有存储，数据独立于应用发布保留。",
  "Bucket name": "存储名称",
  "Create private bucket": "创建私有存储",
  "Storage is optional. Access is disabled until you issue an application credential.": "按需开启。签发应用凭证后，应用才能访问存储。",
  "No object storage enabled yet.": "尚未开启对象存储。",
  "Not measured": "尚未测量",
  "Measure usage to see stored bytes.": "测量用量后显示实际储存容量。",
  "Measure usage": "测量用量",
  "Disable access": "关闭访问",
  "Storage budget": "存储预算",
  "Not set": "未设置",
  ...
  "Each credential grants access to this bucket only. Binding writes S3 environment variables to the selected app.": "每份凭证仅能访问当前存储。绑定后会把 S3 连接信息写入所选应用的环境变量。",
  "Select application": "选择应用",
  "Credential name": "凭证名称",
  "Read only": "只读",
  "Read and write": "读写",
  "Bind to application": "绑定到应用",
  "Revoke": "撤销",
  "No credentials issued.": "尚未签发凭证。",
  "Storage updated.": "存储已更新。",
  "Revoke all bucket credentials? Objects will be retained.": "撤销此存储的全部凭证？已存对象会保留。",
  "Revoke this credential? The application will lose bucket access.": "撤销此凭证？对应应用将失去存储访问权限。",
  Billing: "账单",
  "Access keys": "访问密钥",
  Servers: "服务器",
  Users: "用户",
  ...
  Kubelet: "Kubelet",
  OS: "操作系统",
  "Services on this node ({count})": "该节点上的服务（{count}）",
  "No services scheduled here.": "该节点上暂无服务。",
  Workload: "工作负载",
  Tenant: "租户",
  Pods: "Pod",
  "Service · {type}": "服务 · {type}",
  Service: "服务",
  "All services": "全部服务",
  ...
  "Total services": "服务总数",
  "Across the platform": "平台全部服务",
  "of {total} services": "共 {total} 项服务",
  "Need attention": "需要关注",
  "Everything looks good": "运行状态良好",
  "Active workspaces": "活跃工作空间",
  "Search services": "搜索服务",
  "Clear search": "清除搜索",
  "Filter services": "筛选服务",
  "Filter by status": "按状态筛选",
  "Filter by owner": "按用户筛选",
  "Filter by node": "按节点筛选",
  "Filter by tech stack": "按技术栈筛选",
  "All statuses": "所有状态",
