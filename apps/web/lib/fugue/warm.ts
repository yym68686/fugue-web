...
async function warmFugueApi() {
  ...
  const warmPaths = [
    ...
    "/v1/apps?include_resource_usage=false&include_live_status=false&limit=1",
...
async function warmCriticalRouteModules() {
  await Promise.allSettled([
    ...
    import("@/app/app/api-keys/page"),
    import("@/app/app/billing/page"),
    import("@/app/app/cluster/page"),
    import("@/app/app/cluster-nodes/page"),
    import("@/app/app/users/page"),
    import("@/app/new/repository/page"),
    import("@/app/api/auth/session/route"),
    import("@/app/api/fugue/console/gallery/route"),
    import("@/app/api/fugue/console/projects/route"),
    import("@/app/api/fugue/console/projects/[id]/route"),
    import("@/app/api/fugue/console/pages/api-keys/route"),
    import("@/app/api/fugue/console/pages/billing/route"),
    import("@/app/api/fugue/console/pages/cluster-nodes/route"),
    import("@/app/api/fugue/console/pages/settings/profile/route"),
...
async function warmCriticalSnapshots() {
  await Promise.allSettled([getAdminClusterPageData()]);
}

async function warmServerRuntimeInternal() {
  await warmCriticalRouteModules();

  await Promise.allSettled([warmFugueApiConnection(), warmCriticalSnapshots()]);
}
