...
export function getDocumentLocaleAttributes(
  locale: Locale,
  localePreference: LocalePreference,
) {
  return {
    "data-locale": locale,
    "data-locale-preference": localePreference,
...
const enMessages = {
  ...
  "{count} active version": "{count} active version",
  "{count} active versions": "{count} active versions",
  "{count} old version": "{count} old version",
  "{count} old versions": "{count} old versions",
  "{amount} schedulable": "{amount} schedulable",
  "{signals} signal": "{signals} signal",
  "{signals} signals": "{signals} signals",
  "Waiting for complete node health telemetry.":
    "Waiting for complete node health telemetry.",
  "{label} / {usage} / {total} / {request}": "{label} / {usage} / {total} / {request}",
  "{label} / {usage} / {total} / {request} / {free}":
    "{label} / {usage} / {total} / {request} / {free}",
  "{label} requested {percent} ({usage})": "{label} requested {percent} ({usage})",
...
const zhCNMessages = {
  ...
  "{count} active version": "{count} 个当前版本",
  "{count} active versions": "{count} 个当前版本",
  "{count} project": "{count} 个项目",
  "{count} projects": "{count} 个项目",
  "{count} old version": "{count} 个历史版本",
  "{count} old versions": "{count} 个历史版本",
  ...
  "Abort the in-flight build and force delete this service.":
    "中止当前构建并强制删除此服务。",
  "Abort the in-flight deploy and force delete this service.":
    "中止当前部署并强制删除此服务。",
  ...
  "Cancel the in-flight transfer and force delete this service.":
    "取消当前迁移并强制删除此服务。",
  "Cancel the queued rollout and force delete this service.":
    "取消排队中的发布并强制删除此服务。",
  ...
  "Email route": "邮箱路径",
  "Email verified. You can continue to the console.":
    "邮箱已验证。你可以继续前往控制台。",
  Enabled: "已启用",
  ...
  "Authorize GitHub or paste a token first.": "请先授权 GitHub，或粘贴 Token。",
  ...
  "Last event: {name}": "最近事件：{name}",
  "Installation #{id}": "安装 #{id}",
  "Checked {value}": "已检查 {value}",
  Installed: "已安装",
  Missing: "未安装",
  ...
  "Track project lifecycle, workload placement, and resource usage from the live Fugue workspace.":
    "从实时 Fugue 工作区跟踪项目生命周期、工作负载位置和资源使用情况。",
  "Public route": "公开路由",
  Queued: "已排队",
  "Queued rollout canceled. Force delete queued.":
    "已取消排队中的发布，强制删除已加入队列。",
  ...
  "Internal cluster can now deploy to this server.": "内部集群现在可以部署到此服务器。",
  ...
  "Managed centrally as shared system capacity.": "作为共享系统容量由平台集中管理。",
  ...
  "Skip pricing and let anyone deploy here at no cost.":
    "跳过定价，让任何人都能免费部署到这里。",
  System: "系统",
  "System access · internal cluster can deploy here": "系统访问 · 内部集群可部署到这里",
  ...
  "This server is now public to every workspace.": "此服务器现已对所有工作区公开。",
  ...
  Visibility: "可见性",
  "Waiting for complete node health telemetry.": "等待完整节点健康遥测。",
  ...
  "Identity, reachability, and placement facts.": "节点标识、可达性与放置信息。",
  Large: "大型",
  "Live policy": "实时策略",
...
const zhTWMessages = {
  ...
  "{count} active version": "{count} 個目前版本",
  "{count} active versions": "{count} 個目前版本",
  "{count} old version": "{count} 個歷史版本",
  "{count} old versions": "{count} 個歷史版本",
  ...
  Projects: "專案",
  "Track project lifecycle, workload placement, and resource usage from the live Fugue workspace.":
    "從即時 Fugue 工作區追蹤專案生命週期、工作負載位置和資源使用情況。",
  Queued: "已排隊",
  Redeploy: "重新部署",
...
const zhCNExtraMessages = {
  ...
  "Cluster join command copied with {label}.": "已使用 {label} 复制集群加入命令。",
  ...
  "Create app metadata and desired specs.": "创建应用元数据和期望规格。",
  "Create node key": "创建节点密钥",
  "Create node keys and enroll external runtimes.": "创建节点密钥并注册外部运行时。",
  "Create one, then copy a join command.": "先创建一个，再复制加入命令。",
  "Create or edit runtime records.": "创建或编辑运行时记录。",
  "Create projects inside the current tenant.": "在当前租户内创建项目。",
  "Create the first node key when you are ready.": "准备好后再创建第一个节点密钥。",
  ...
  "Delete apps without broad write access.": "在不授予广泛写权限的情况下删除应用。",
  ...
  "Reserve VPS targets exclusively for projects.": "将 VPS 目标保留为项目专用。",
  ...
  "Keep at least one permission enabled.": "请至少保留一个已启用权限。",
  ...
  "Mint additional tenant access keys.": "生成额外的租户访问密钥。",
  ...
  "No permissions are currently available from the workspace key.":
    "当前工作区密钥没有可用权限。",
  "Node key": "节点密钥",
  "Node key created and secret copied.": "节点密钥已创建，并已复制密钥。",
  ...
  "Node key revoked and removed from the list.": "节点密钥已吊销并已从列表中移除。",
  "Node keys": "节点密钥",
  ...
  "Preview based on unsaved capacity changes.": "基于未保存的容量变更预估。",
  Prefix: "前缀",
  "Primary VPS key…": "主 VPS 密钥…",
  "Refresh keys": "刷新密钥",
  "Ready to cover the saved managed envelope.": "可用于覆盖已保存的托管额度。",
  Rename: "重命名",
  ...
  Restore: "恢复",
  "Restore the workspace to continue.": "请先恢复工作区再继续。",
  "Restoring…": "正在恢复…",
  Revoked: "已吊销",
  Revoke: "吊销",
  "Revoke key": "吊销密钥",
  ...
  "Secret copied.": "密钥已复制。",
  "Secret hidden": "密钥已隐藏",
  "Secret is ready, but clipboard access failed.": "密钥已生成，但剪贴板访问失败。",
  ...
  "The current secret stops working immediately and the new secret will be copied.":
    "当前密钥会立即失效，并复制新的密钥。",
  "This revokes the secret in Fugue immediately.": "这会立即在 Fugue 中吊销该密钥。",
  "Trigger failover onto a secondary runtime.": "触发切换到备用运行时的故障转移。",
  "Whole USD only · {min} to {max}": "仅支持整数美元 · {min} 到 {max}",
  ...
  "Service name and optional startup command.": "服务名称和可选启动命令。",
  ...
  "Static site": "静态站点",
  "This build strategy is reused for later syncs.": "后续同步会复用这个构建策略。",
  "This source is already linked or cannot be changed here.":
    "此来源已经关联，或不能在这里更改。",
  ...
  "Use https://github.com/owner/repo.": "使用 https://github.com/owner/repo。",
  ...
  "Start from a repository, image, or uploaded bundle.": "从仓库、镜像或上传包开始。",
  ...
  "Unable to load the current custom domain right now.": "当前无法加载现有自定义域名。",
  Unavailable: "不可用",
  ...
  "Automatic failover already points to {target}.": "自动故障切换已经指向 {target}。",
  ...
  "Database failover already points to {target}.": "数据库故障切换已经指向 {target}。",
  ...
  "Hostname looks good. Save to attach it.": "主机名看起来可用。保存后即可挂接。",
  ...
  "Mirrored image limit is already {count}.": "镜像保留上限已经是 {count}。",
  ...
  "Persistent storage already matches the current release.":
    "持久化存储已与当前发布保持一致。",
  "Persistent storage cleared. Deploy queued.": "持久化存储已清空，部署已加入队列。",
  "Persistent storage is already cleared.": "持久化存储已经处于清空状态。",
  "Persistent storage is not configured yet.": "持久化存储尚未配置。",
  "Persistent storage refreshed.": "持久化存储已刷新。",
  "Persistent storage saved. Deploy queued.": "持久化存储已保存，部署已加入队列。",
  ...
  "Repository token updated. Rebuild queued.": "仓库 Token 已更新，重建已加入队列。",
  Resume: "恢复",
  "Resume first.": "请先恢复。",
  ...
  Subdomain: "子域名",
  Taken: "已被占用",
  "This app does not expose an internal HTTP service.": "此应用未暴露内部 HTTP 服务。",
  "This database cannot be configured from the console yet.":
    "这个数据库暂时还不能在控制台中配置。",
  "This database cannot be transferred from the console yet.":
    "这个数据库暂时还不能在控制台中迁移。",
  "This database is not attached to an application.": "这个数据库尚未挂接到应用。",
  ...
  "Move immediately once the destination is chosen.": "选定目标位置后立即迁移。",
  "Unable to check availability right now.": "当前无法检查可用性。",
  "Unable to check hostname availability right now.": "当前无法检查主机名可用性。",
  ...
  "Unable to load this folder. Try refreshing the current scope.":
    "无法加载此文件夹。请尝试刷新当前范围。",
  Unassigned: "未分配",
  "Unassigned groups cannot be renamed yet.": "尚未分组的项目当前还不能重命名。",
  ...
  "Wait for the current release to finish before browsing files.":
    "请等待当前发布完成后再浏览文件。",
  "Wait for the current release to finish.": "请等待当前发布完成。",
  ...
  "{hostname} is already attached to {appName}.": "{hostname} 已挂接到 {appName}。",
  ...
  "{hostname} is already serving {appName}.": "{hostname} 已在为 {appName} 提供服务。",
  "{hostname} is attached to {appName}, but setup still needs attention.":
    "{hostname} 已挂接到 {appName}，但设置仍需处理。",
  "{hostname} is attached to {appName}.": "{hostname} 已挂接到 {appName}。",
  ...
  "{path} will be removed from {appName}.": "{path} 将从 {appName} 中移除。",
  ...
  "Billing top-up status response was malformed.": "计费充值状态响应格式不正确。",
  ...
  "GitHub could not be linked right now. Try again.": "当前无法关联 GitHub。请重试。",
  ...
  "No services are attached to this project yet.": "这个项目还没有挂接任何服务。",
  ...
  "Packaging uploaded files for the first build.": "正在为第一次构建打包上传文件。",
  ...
  "Payment completed. Billing balance refreshed.": "支付已完成，计费余额已刷新。",
  "Payment failed.": "支付失败。",
  ...
  State: "状态",
  "Streaming response body is unavailable.": "流式响应正文不可用。",
  Stopped: "已停止",
  ...
  "Unable to load this project right now.": "当前无法加载这个项目。",
  "Update password": "更新密码",
  "Updated {time}": "更新于 {time}",
  "Waiting for complete node health telemetry.": "正在等待完整节点健康遥测。",
  "{amount} / hour": "{amount} / 小时",
  "{amount} / hour at the current live rate.": "按当前实时费率计算为 {amount} / 小时。",
  ...
  "Google could not be linked right now. Try again.": "当前无法关联 Google，请重试。",
  ...
  Linked: "已关联",
  "Live {streamLabel} output for {name}.": "{name} 的实时 {streamLabel} 输出。",
  "Local source": "本地源码",
  Location: "位置",
  Logs: "日志",
  ...
  "Managed envelope set to {envelope}.": "托管容量包已设为 {envelope}。",
  "Managed envelope was raised automatically.": "托管容量包已自动提升。",
  "Maximum managed resources for this workspace.": "此工作区可使用的最大托管资源。",
  ...
  Paused: "已暂停",
  "Platform admin adjusted the prepaid balance": "平台管理员调整了预付余额",
  Profile: "个人资料",
  "Project 1": "项目 1",
  ...
  "Registration still uses an email verification link.": "注册仍通过邮箱验证链接完成。",
  Release: "版本",
  Remove: "移除",
  "Remove password": "移除密码",
  "Remove password sign-in?": "移除密码登录？",
  Removing: "移除中",
  "Repeat the password once to confirm it.": "再次输入密码以确认。",
  "Request failed with status {status}.": "请求失败，状态码 {status}。",
  "Required before the password can be changed.": "修改密码前必须提供。",
  "Reserve the project and the first service slot.": "预留项目和首个服务槽位。",
  ...
  "Return to the create flow and retry the import": "返回创建流程并重试导入",
  Running: "运行中",
  ...
  "Unable to open the {streamLabel} stream.": "无法打开 {streamLabel} 流。",
  Undo: "撤销",
  ...
  "{message} Showing the latest received output.": "{message} 当前显示最近收到的输出。",
  "{method} sign-in disconnected.": "{method} 登录方式已解除关联。",
  "{name} discard variable": "舍弃变量 {name}",
  "{name} is currently {phase}. {description}": "{name} 当前为 {phase}。{description}",
  "{name} key": "{name} 键",
  ...
  "{email} will gain workspace admin access.": "{email} 将获得工作区管理员权限。",
  "{amount} schedulable": "{amount} 可调度",
  "{label} / {usage} / {total}": "{label} / {usage} / {total}",
  "{label} / {usage} / {total} / {request}": "{label} / {usage} / {total} / {request}",
  "{label} / {usage} / {total} / {request} / {free}":
    "{label} / {usage} / {total} / {request} / {free}",
  "{label} requested {percent} ({usage})": "{label} 已预留 {percent}（{usage}）",
  ...
  "{updated} updated / {available} available": "{updated} 已更新 / {available} 可用",
  "{value} / month": "{value} / 月",
  "{value}/mo": "{value}/月",
  ...
  "Services / CPU / Memory / Disk / Images": "服务 / CPU / 内存 / 磁盘 / 镜像",
  "Set balance": "设置余额",
  ...
  "User deleted.": "用户已删除。",
  "User email": "用户邮箱",
  "User promoted to admin and restored.": "用户已提升为管理员并恢复访问。",
  ...
  "The Unassigned bucket is managed by Fugue.": "未分配分组由 Fugue 管理。",
...
const zhTWExtraMessages = {
  ...
  "Identity, reachability, and placement facts.": "節點識別、可達性與放置資訊。",
  Large: "大型",
  "Live policy": "即時策略",
  "Live node labels still differ from the saved policy. Reapply the policy to reconcile again.":
  ...
  "Reserve VPS targets exclusively for projects.": "將 VPS 目標保留為專案專用。",
  "Reconcile needed": "需要 reconcile",
  "Runtime inventory is unavailable. Existing default settings stay unchanged.":
  ...
  "Cluster join command copied with {label}.": "已使用 {label} 複製叢集加入命令。",
  "Cluster join command is ready, but clipboard access failed.":
    "叢集加入命令已產生，但剪貼簿存取失敗。",
  Copy: "複製",
  "Copy secret": "複製密鑰",
  ...
  "Create app metadata and desired specs.": "建立應用中繼資料與目標規格。",
  "Create node key": "建立節點金鑰",
  "Create node keys and enroll external runtimes.": "建立節點金鑰並註冊外部執行環境。",
  "Create one, then copy a join command.": "先建立一個，再複製加入命令。",
  "Create or edit runtime records.": "建立或編輯執行環境記錄。",
  "Create projects inside the current tenant.": "在目前租戶內建立專案。",
  "Create the first node key when you are ready.": "準備好後再建立第一個節點金鑰。",
  ...
  "Delete apps without broad write access.": "在不授予廣泛寫入權限的情況下刪除應用。",
  "Read data workspace metadata, versions, manifests, and download plans.":
  ...
  "Keep at least one permission enabled.": "請至少保留一個已啟用的權限。",
  ...
  "Mint additional tenant access keys.": "產生額外的租戶存取金鑰。",
  ...
  "No permissions are currently available from the workspace key.":
    "目前工作區金鑰沒有可用權限。",
  "Node key": "節點金鑰",
  "Node key created and secret copied.": "節點金鑰已建立，並已複製密鑰。",
  ...
  "Node key revoked and removed from the list.": "節點金鑰已吊銷並已從清單中移除。",
  "Node keys": "節點金鑰",
  ...
  "Preview based on unsaved capacity changes.": "根據尚未儲存的容量變更預估。",
  Prefix: "前綴",
  "Primary VPS key…": "主 VPS 金鑰…",
  "Refresh keys": "重新整理金鑰",
  "Ready to cover the saved managed envelope.": "可用於覆蓋已儲存的託管額度。",
  Rename: "重新命名",
  ...
  Restore: "恢復",
  "Restore the workspace to continue.": "請先恢復工作區再繼續。",
  "Restoring…": "恢復中…",
  Revoked: "已吊銷",
  Revoke: "吊銷",
  "Revoke key": "吊銷金鑰",
  ...
  "Secret copied.": "密鑰已複製。",
  "Secret hidden": "密鑰已隱藏",
  "Secret is ready, but clipboard access failed.": "密鑰已產生，但剪貼簿存取失敗。",
  "Showing stored metadata while live key sync is unavailable.":
  ...
  "The current secret stops working immediately and the new secret will be copied.":
    "目前密鑰會立即失效，並複製新的密鑰。",
  "This revokes the secret in Fugue immediately.": "這會立即在 Fugue 中吊銷該密鑰。",
  "Trigger failover onto a secondary runtime.": "觸發切換到備援執行環境的故障轉移。",
  "Whole USD only · {min} to {max}": "僅支援整數美元 · {min} 到 {max}",
  "Update the display name used in this workspace. The key ID, secret, prefix, and attached VPS stay the same.":
  ...
  "Authorize GitHub or paste a token first.": "請先授權 GitHub，或貼上 Token。",
  "Authorize GitHub in the browser, or paste a token below.":
  ...
  "Service name and optional startup command.": "服務名稱與可選的啟動命令。",
  ...
  "Static site": "靜態網站",
  "This build strategy is reused for later syncs.": "後續同步會重用這個建置策略。",
  "This source is already linked or cannot be changed here.":
    "此來源已經連結，或不能在這裡變更。",
  ...
  "Use the password saved from the profile page.": "使用你在個人資料頁儲存的密碼。",
  "Use the same account email shown in Profile.":
  ...
  "Unable to load the current custom domain right now.": "目前無法載入現有自訂網域。",
  Unavailable: "不可用",
  "Use a public image reference to unlock the deploy form after sign-in.":
    "使用公開映像引用，即可在登入後解鎖部署表單。",
  "Verify the public route, then continue to sign in.": "先確認公開路由，再繼續登入。",
  ...
  "Automatic failover already points to {target}.": "自動故障切換已經指向 {target}。",
  ...
  "Database failover already points to {target}.": "資料庫故障切換已經指向 {target}。",
  ...
  "Hostname looks good. Save to attach it.": "主機名稱看起來可用。儲存後即可掛接。",
  "Hostname looks good. Save to replace the current domain.":
  ...
  "Mirrored image limit is already {count}.": "映像保留上限已經是 {count}。",
  ...
  "Persistent storage already matches the current release.":
    "持久化儲存已與目前發佈一致。",
  "Persistent storage cleared. Deploy queued.": "持久化儲存已清空，部署已加入佇列。",
  "Persistent storage is already cleared.": "持久化儲存已經處於清空狀態。",
  "Persistent storage is not configured yet.": "持久化儲存尚未設定。",
  "Persistent storage refreshed.": "持久化儲存已重新整理。",
  "Persistent storage saved. Deploy queued.": "持久化儲存已儲存，部署已加入佇列。",
  "Persistent storage sync runs before the move completes.":
    "在遷移完成前會先同步持久化儲存。",
  "Persistent storage sync runs before the move completes. Database stays where it is.":
  ...
  "Repository token updated. Rebuild queued.": "儲存庫 Token 已更新，重建已加入佇列。",
  Resume: "恢復",
  "Resume first.": "請先恢復。",
  ...
  Subdomain: "子網域",
  Taken: "已被占用",
  "This app does not expose an internal HTTP service.": "此應用未暴露內部 HTTP 服務。",
  "This database cannot be configured from the console yet.":
    "這個資料庫暫時還不能在控制台中設定。",
  "This database cannot be transferred from the console yet.":
    "這個資料庫暫時還不能在控制台中遷移。",
  "This database is not attached to an application.": "這個資料庫尚未掛接到應用。",
  "This file is shown as base64 because it is not valid utf-8 text.":
  ...
  "Fugue prepares the destination before cutover.":
    "Fugue 會先準備目的地，再執行切換。",
  "Move immediately once the destination is chosen.": "選定目的地後立即遷移。",
  "Unable to check availability right now.": "目前無法檢查可用性。",
  "Unable to check hostname availability right now.": "目前無法檢查主機名稱可用性。",
  ...
  Unassigned: "未分配",
  "Unassigned groups cannot be renamed yet.": "尚未分組的專案目前還不能重新命名。",
  ...
  "Use lowercase letters, numbers, and hyphens.": "請使用小寫字母、數字與連字號。",
  ...
  "{hostname} is already attached to {appName}.": "{hostname} 已掛接到 {appName}。",
  "{hostname} is already attached to {appName}. Fugue is finishing setup now.":
    "{hostname} 已掛接到 {appName}。Fugue 正在完成設定。",
  "{hostname} is already attached to {appName}. {guidance}":
    "{hostname} 已掛接到 {appName}。{guidance}",
  "{hostname} is already serving {appName}.": "{hostname} 已在為 {appName} 提供服務。",
  "{hostname} is attached to {appName}, but setup still needs attention.":
    "{hostname} 已掛接到 {appName}，但設定仍需處理。",
  "{hostname} is attached to {appName}.": "{hostname} 已掛接到 {appName}。",
  "{hostname} is attached to {appName}. Fugue is finishing setup now.":
    "{hostname} 已掛接到 {appName}。Fugue 正在完成設定。",
  "{hostname} is attached to {appName}. {guidance}":
    "{hostname} 已掛接到 {appName}。{guidance}",
  ...
  "{path} will be removed from {appName}.": "{path} 將從 {appName} 中移除。",
  ...
  "Billing top-up status response was malformed.": "帳務儲值狀態回應格式不正確。",
  ...
  "No services are attached to this project yet.": "這個專案尚未掛接任何服務。",
  ...
  "Packaging uploaded files for the first build.": "正在為第一次建置封裝上傳檔案。",
  ...
  "Payment completed. Billing balance refreshed.": "付款已完成，帳務餘額已刷新。",
  "Payment failed.": "付款失敗。",
  ...
  State: "狀態",
  "Streaming response body is unavailable.": "串流回應本文不可用。",
  Stopped: "已停止",
  ...
  "Unable to load this project right now.": "目前無法載入這個專案。",
  "Update password": "更新密碼",
  "Updated {time}": "更新於 {time}",
  "{amount} / hour": "{amount} / 小時",
  "{amount} / hour at the current live rate.": "依目前即時費率為 {amount} / 小時。",
  ...
  "Line {line}: {message}": "第 {line} 行：{message}",
  Linked: "已連結",
  "Live {streamLabel} output for {name}.": "{name} 的即時 {streamLabel} 輸出。",
  "Local source": "本機原始碼",
  Location: "位置",
  Logs: "日誌",
  "Manage how this account gets back into Fugue. Email stays the recovery anchor while GitHub and Google remain optional return paths.":
  ...
  "Managed envelope set to {envelope}.": "託管容量包已設為 {envelope}。",
  "Managed envelope was raised automatically.": "託管容量包已自動提高。",
  "Maximum managed resources for this workspace.": "此工作區可使用的最大託管資源。",
  "Mirror the published image internally and stage the first rollout.":
  ...
  Paused: "已暫停",
  "Platform admin adjusted the prepaid balance": "平台管理員調整了預付餘額",
  Profile: "個人資料",
  "Project 1": "專案 1",
  ...
  Removing: "移除中",
  "Repeat the password once to confirm it.": "再次輸入密碼以確認。",
  "Request failed with status {status}.": "請求失敗，狀態碼 {status}。",
  "Required before the password can be changed.": "變更密碼前必須提供。",
  "Reserve the project and the first service slot.": "預留專案與第一個服務槽位。",
  ...
  "Return to the create flow and retry the import": "返回建立流程並重試匯入",
  Running: "執行中",
  "Runway updates after the latest live billing sync.":
    "續航估算會在最新即時帳務同步後更新。",
  "Save the maximum managed CPU, memory, and disk for this workspace. Fugue charges against the larger of your saved cap and any resources already committed.":
  ...
  "Unable to open the {streamLabel} stream.": "無法開啟 {streamLabel} 串流。",
  Undo: "還原",
  "Update or remove the stored password. Email link stays the recovery anchor for this account.":
  ...
  "{message} Showing the latest received output.": "{message} 目前顯示最近收到的輸出。",
  "{method} sign-in disconnected.": "{method} 登入方式已解除連結。",
  "{name} discard variable": "捨棄變數 {name}",
  "{name} is currently {phase}. {description}": "{name} 目前為 {phase}。{description}",
  "{name} key": "{name} 鍵",
  ...
  "{email} will gain workspace admin access.": "{email} 將取得工作區管理員權限。",
  "{amount} schedulable": "{amount} 可排程",
  "{label} / {usage} / {total}": "{label} / {usage} / {total}",
  "{label} / {usage} / {total} / {request}": "{label} / {usage} / {total} / {request}",
  "{label} / {usage} / {total} / {request} / {free}":
    "{label} / {usage} / {total} / {request} / {free}",
  "{label} requested {percent} ({usage})": "{label} 已預留 {percent}（{usage}）",
  "{label} usage {percent} ({usage})": "{label} 使用量 {percent}（{usage}）",
  "{limit} limit. Billed as {billed} until live storage shrinks.":
  ...
  "Services / CPU / Memory / Disk / Images": "服務 / CPU / 記憶體 / 磁碟 / 映像",
  "Set balance": "設定餘額",
  "Set CPU or memory to 0 to pause managed billing.":
  ...
  "User deleted.": "使用者已刪除。",
  "User email": "使用者電子郵件",
  "User promoted to admin and restored.": "使用者已提升為管理員並恢復存取。",
  ...
  "Internal cluster can now deploy to this server.": "內部叢集現在可以部署到此伺服器。",
  ...
  "Managed centrally as shared system capacity.": "作為共享系統容量由平台集中管理。",
  ...
  "The Unassigned bucket is managed by Fugue.": "未分配分組由 Fugue 管理。",
  "This project is already empty. Deleting it only removes the shell from the workspace.":
...
const zhCNMorlanePatchMessages = {
  " +{count} more": "另有 {count} 项",
  "{label} / {primary}": "{label} / {primary}",
  "{label} / {primary} / {secondary}": "{label} / {primary} / {secondary}",
  "API keys": "API 密钥",
  "Account / Preferences": "账号 / 偏好",
  "Access key snapshot unavailable": "访问密钥快照不可用",
  "Admins / Quotas / Access": "管理员 / 配额 / 访问",
  "Admins, quotas, and access": "管理员、配额和访问控制",
  "Add a directory or file mount to keep it across redeploys, restarts, runtime moves, and failover.":
    "添加目录或文件挂载，让它在重新部署、重启、运行时迁移和故障转移后继续保留。",
  "Add a workspace admin key for another environment, or copy a stored secret.":
    "为其他环境添加工作区管理密钥，或复制存储的密钥。",
  "Add admin key": "添加管理员密钥",
  "Add credits before you raise the saved cap. Fugue deducts credits from active resources, and stored images count toward disk usage.":
    "提高已保存上限前请先充值余额。Fugue 会从活动资源中扣除余额，已保存镜像也会计入磁盘用量。",
  "Add directory": "添加目录",
  "Add file": "添加文件",
  "Adjust from 0 to {max} GiB in {step} GiB steps.":
    "从 0 到 {max} GiB 调整，步进为 {step} GiB。",
  "Adjust from 0 to {max} cpu in {step} cpu steps.":
    "从 0 到 {max} CPU 调整，步进为 {step} CPU。",
  "Admin key added and secret copied.": "管理员密钥已添加，并已复制新密钥。",
  "Admin key added. Copy the new secret now.": "管理员密钥已添加。请立即复制新密钥。",
  "Admin keys": "管理员密钥",
  "All projects": "所有项目",
  "Allow DNS": "允许 DNS",
  "Allow edge": "允许 Edge",
  "Another project already uses “{name}”. Project names must be unique within the workspace.":
    "另一个项目已使用“{name}”。项目名称在工作区内必须唯一。",
  "App service": "应用服务",
  "Apply table": "应用路由表",
  "Balance, metering, and capacity": "余额、计量和容量",
  "Billing and capacity details": "计费与容量详情",
  "Bind one repository for this project. Fugue reads the repository workflow image outputs and maps them to app services automatically.":
    "为此项目绑定一个仓库。Fugue 会读取仓库工作流输出的镜像，并自动映射到应用服务。",
  "Bind project": "绑定项目",
  "Binding…": "正在绑定…",
  "Bootstrap a workspace before enrolling servers into Fugue.":
    "先初始化工作区，再将服务器接入 Fugue。",
  "Bootstrap the workspace to create the first node key.":
    "初始化工作区以创建第一个节点密钥。",
  Bottleneck: "瓶颈",
  ...
  "Add directories or files that must stay attached after deploys and restarts.":
    "添加部署和重启后仍需保留的目录或文件。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents are only used the first time Fugue creates that file.":
    "添加重新部署、重启和运行时迁移后仍需保留的目录或文件。文件内容只会在 Fugue 首次创建该文件时使用。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents only apply when Fugue creates the file for the first time.":
    "添加重新部署、重启和运行时迁移后仍需保留的目录或文件。文件内容只在 Fugue 首次创建该文件时生效。",
  "After submission, Fugue creates the app and starts the import operation immediately.":
    "提交后，Fugue 会创建应用并立即启动导入操作。",
  "App name, startup command, and optional build overrides.":
    "应用名称、启动命令和可选构建覆盖项。",
  "Auto detect keeps compose and fugue manifest imports intact.":
    "自动检测会保留 compose 和 fugue manifest 的完整导入。",
  "Auto detect works for most repositories.": "自动检测适用于大多数仓库。",
  "Auto-generate on deploy": "部署时自动生成",
  "Background workers run without a managed route, Kubernetes Service, or readiness port.":
    "后台工作进程不创建托管路由、Kubernetes Service 或就绪端口。",
  "Background workers skip the managed route, Kubernetes Service, and readiness port.":
    "后台工作进程会跳过托管路由、Kubernetes Service 和就绪端口。",
  "Clear filters": "清除筛选",
  "Clear history": "清除历史记录",
  "Clear raw": "清空原始内容",
  "Clearing…": "正在清除…",
  "Cluster / Rebuild / Delete": "集群 / 重建 / 删除",
  "Cluster apps, rebuilds, and deletes": "集群应用、重建和删除",
  "Cluster apps": "集群应用",
  Commercial: "商业",
  "Commit {hash}": "提交{hash}",
  Confidence: "置信度",
  "Console / first run": "控制台 / 首次运行",
  "Control-plane nodes, pressure, and workloads": "控制平面节点、压力和工作负载",
  "Copy join command": "复制加入命令",
  "Copy ref": "复制引用",
  "Copy the join command manually.": "请手动复制加入命令。",
  "Create new project": "创建新项目",
  "Create new project · {name}": "创建新项目 · {name}",
  "Create project failed.": "创建项目失败。",
  "Create / Rebuild / Scopes": "创建 / 重建 / 权限范围",
  "Create, rebuild, and scope API keys": "创建、重建和限定 API 密钥权限",
  "Current project total": "当前项目总计",
  "Create a CNAME record for {hostname} pointing to {target}. Fugue will verify it automatically once DNS resolves.":
    "为 {hostname} 创建指向 {target} 的 CNAME 记录。DNS 解析后，Fugue 会自动验证。",
  "Create a CNAME record pointing to {target}. Fugue will verify it automatically once DNS resolves.":
    "创建指向 {target} 的 CNAME 记录。DNS 解析后，Fugue 会自动验证。",
  "Create a node key, run the join command on your VPS, or wait for another workspace to share a server with you.":
    "创建节点密钥，在 VPS 上运行加入命令，或等待其他工作区向你共享服务器。",
  "Create scoped API keys and node enrollment keys from one access surface.":
    "在同一个访问界面创建限定范围的 API 密钥和节点接入密钥。",
  "Create the first project, import a service, and Fugue will attach route controls when the first app record is ready.":
    "创建第一个项目并导入服务；首个应用记录就绪后，Fugue 会挂接路由控制。",
  ...
  "Choose where the mirrored image should land for the first rollout.":
    "选择镜像首轮发布要落到哪里。",
  "Choose where the upload should land. Only add manual build settings when the upload is meant to deploy as a single app instead of a full manifest or compose topology.":
    "选择上传内容要落到哪里。只有当上传内容要作为单应用部署，而不是完整 manifest 或 compose 拓扑时，才添加手动构建设置。",
  "Choose whether Fugue should expose this app publicly, keep it cluster-internal, or run it as a background worker.":
    "选择 Fugue 是公开暴露此应用、保持集群内部访问，还是作为后台工作进程运行。",
  Current: "当前",
  "Current managed image": "当前托管镜像",
  "Current managed usage is {usage}.": "当前托管使用量为{usage}。",
  Resource: "资源",
  "Current primary: {primaryRuntimeLabel}. Choose a destination and Fugue will prepare the new primary before switching over.":
    "当前主实例：{primaryRuntimeLabel}。选择目标后，Fugue 会先准备新的主实例再切换。",
  "Current primary: {primaryRuntimeLabel}. Destination: {activeTransferTargetLabel}. Fugue promotes the new primary automatically once it is ready.":
    "当前主实例：{primaryRuntimeLabel}。目标：{activeTransferTargetLabel}。准备就绪后，Fugue 会自动提升新的主实例。",
  DNS: "DNS",
  "Database protection restored. New standby runtime: {target}.":
    "数据库保护已恢复。新的备用运行时：{target}。",
  "Delete all saved images?": "删除所有保存的镜像？",
  "Delete image": "删除镜像",
  "Delete project and services?": "删除项目和服务？",
  "Delete project?": "删除项目",
  "Delete request was not accepted.": "删除请求未被接受。",
  "Delete saved image?": "删除已保存镜像？",
  Deploy: "部署",
  "Deploy from a Docker image.": "从 Docker 镜像部署。",
  "Deploy from a local source.": "从本地源码部署。",
  ...
  "Choose files": "选择文件",
  "Choose folder": "选择文件夹",
  "Compose detected": "已检测到 Compose",
  "Direct import": "直接导入",
  "Dockerfile detected": "已检测到 Dockerfile",
  "Drop a folder, archive, or source files": "拖入文件夹、归档或源码文件",
  "Defaults to the repository root when omitted.": "留空则默认使用仓库根目录。",
  "Defaults to the uploaded root when omitted.": "留空则默认使用上传根目录。",
  "Drag a local folder, .zip, .tgz, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Fugue packages file uploads on the server, then imports the detected topology when present.":
    "拖入本地文件夹、.zip、.tgz、docker-compose.yml、fugue.yaml、Dockerfile 或多个源码文件。Fugue 会在服务端打包上传文件，并在检测到拓扑时执行完整导入。",
  "Drag a local folder, a .zip or .tgz archive, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Folder drop works when the browser exposes directory entries.":
    "拖入本地文件夹、.zip 或 .tgz 归档、docker-compose.yml、fugue.yaml、Dockerfile 或多个源码文件。浏览器暴露目录条目时可以直接拖入文件夹。",
  "Enter the value that should exist before the first deploy.":
    "输入首次部署前应存在的值。",
  "Enter value": "输入值",
  "Folder / ZIP / compose": "文件夹 / ZIP / Compose",
  "Folder drag": "文件夹拖放",
  "Fugue creates the project if needed, packages the selected files, and then sends you back to the console.":
    "Fugue 会按需创建项目，打包所选文件，然后带你返回控制台。",
  "Fugue will import this archive directly. GitHub download ZIP files work as-is, without repackaging them in the browser.":
    "Fugue 会直接导入此归档。GitHub 下载的 ZIP 文件可原样使用，无需在浏览器中重新打包。",
  "Fugue will package these files on the server, then import them through the same upload route used by local deploys.":
    "Fugue 会在服务端打包这些文件，然后通过本地部署使用的同一上传路径导入。",
  "Fugue mirrors the published image into the internal registry, creates the app, and queues the first rollout onto the selected runtime.":
    "Fugue 会把已发布镜像同步到内部镜像仓库，创建应用，并将首轮发布加入所选运行时队列。",
  "GitHub download ready": "GitHub 下载可用",
  "Image deploy network mode": "镜像部署网络模式",
  "Includes {items}.": "包含 {items}。",
  "Internal services get a cluster-only Service and readiness checks, without a public route.":
    "内部服务会获得仅集群内可访问的 Service 和就绪检查，不会创建公开路由。",
  "Internal services keep a cluster-only Service and readiness checks, but Fugue does not publish a public route for them.":
    "内部服务会保留仅集群内可访问的 Service 和就绪检查，Fugue 不会为它们发布公开路由。",
  "Imports {count} service from {path}": "从 {path} 导入 {count} 个服务",
  "Imports {count} service from {path}.": "从 {path} 导入 {count} 个服务。",
  "Imports {count} services from {path}": "从 {path} 导入 {count} 个服务",
  "Imports {count} services from {path}.": "从 {path} 导入 {count} 个服务。",
  "Leave blank to auto-generate it.": "留空则自动生成。",
  "Leave blank to auto-generate this value when the deploy is queued.":
    "留空则在部署入队时自动生成此值。",
  "Leave blank to create an empty file.": "留空则创建空文件。",
  "Leave blank to reuse the image name.": "留空则复用镜像名称。",
  "Leave blank to reuse the repository name.": "留空则复用仓库名称。",
  "Leave blank to reuse the uploaded folder or primary service name.":
    "留空则复用上传文件夹或主服务名称。",
  "Leave blank to use the default.": "留空则使用默认值。",
  "Leave blank to use the default value.": "留空则使用默认值。",
  "Manual build overrides are active. Clear build strategy and path overrides if you want Fugue to import every service from fugue.yaml or docker-compose.":
    "手动构建覆盖项已启用。如果希望 Fugue 从 fugue.yaml 或 docker-compose 导入所有服务，请清空构建策略和路径覆盖项。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while this deploy preserves a whole topology. Switch back to a single-app deploy to reuse them.":
    "手动持久化存储挂载会保留在此草稿中，但当前部署保留完整拓扑时 Fugue 会跳过它们。切回单应用部署即可复用。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while the upload imports a whole topology. Switch back to a single-app upload to reuse them.":
    "手动持久化存储挂载会保留在此草稿中，但上传内容导入完整拓扑时 Fugue 会跳过它们。切回单应用上传即可复用。",
  "Manifest import": "Manifest 导入",
  "Multi-service ready": "多服务就绪",
  "Name {name}": "名称 {name}",
  "New project name": "新项目名称",
  "Override the default entrypoint only when this upload should start with a custom shell command.":
    "仅当此上传内容需要使用自定义 shell 命令启动时，才覆盖默认入口。",
  "Override the image default entrypoint only when this service needs a different launch command.":
    "仅当此服务需要不同启动命令时，才覆盖镜像默认入口。",
  "Primary service: {service}.": "主服务：{service}。",
  "Project inventory is unavailable right now. You can still deploy into a new project.":
    "项目清单当前不可用。你仍可部署到一个新项目。",
  "Public image references work best for one-click deploy links because this flow does not collect registry credentials.":
    "一键部署链接最适合使用公开镜像引用，因为此流程不会收集镜像仓库凭据。",
  "Public services get a managed route and readiness checks.":
    "公开服务会获得托管路由和就绪检查。",
  "Public services get a managed route. Internal services stay cluster-only. Background workers skip route and readiness setup.":
    "公开服务会获得托管路由。内部服务仅限集群内访问。后台工作进程会跳过路由和就绪设置。",
  "Queue deployment": "排队部署",
  "Queue image deploy": "排队镜像部署",
  "Queueing image deploy…": "正在排队镜像部署…",
  "Queuing deploy": "正在排队部署",
  "Repository build": "仓库构建",
  "Required when the Dockerfile is outside the uploaded root.":
    "Dockerfile 位于上传根目录外时必填。",
  "Reuse an existing project or create a new one for this deploy.":
    "复用现有项目，或为此次部署创建新项目。",
  "Runs as `sh -lc <command>`. Leave blank to use the image default entrypoint.":
    "以 `sh -lc <command>` 运行。留空则使用镜像默认入口。",
  "Service {service}. Leave blank to create an empty file on first deploy.":
    "服务 {service}。留空则在首次部署时创建空文件。",
  "Set this when the container listens on a known port.": "容器监听固定端口时填写。",
  "Single file import": "单文件导入",
  Target: "目标",
  "Target and build": "目标与构建",
  "Template deploy network mode": "模板部署网络模式",
  "Template variables": "模板变量",
  "TGZ archive": "TGZ 归档",
  "The browser keeps files local until you submit the deploy.":
    "提交部署前，浏览器会将文件保留在本地。",
  "This project will be created before the deploy is queued.":
    "此项目会在部署入队前创建。",
  "Upload and deploy": "上传并部署",
  "Upload ready": "上传已就绪",
  "Upload deploy network mode": "上传部署网络模式",
  "Uploading deploy": "正在上传部署",
  "Use a pullable public image reference such as ghcr.io/example/api:1.2.3.":
    "使用可拉取的公开镜像引用，例如 ghcr.io/example/api:1.2.3。",
  "Use when the app lives below the repo root.": "应用位于仓库根目录下级路径时使用。",
  "Use when the app lives below the uploaded root.":
    "应用位于上传根目录下级路径时使用。",
  "Whole-topology import is ready. Leave build strategy on Auto detect and keep manual path overrides blank to import every service from fugue.yaml or docker-compose.":
    "完整拓扑导入已就绪。保持构建策略为自动检测，并留空手动路径覆盖项，即可从 fugue.yaml 或 docker-compose 导入所有服务。",
  "Whole-topology imports keep per-service networking from fugue.yaml or docker-compose, so manual network mode is unavailable here.":
    "完整拓扑导入会保留 fugue.yaml 或 docker-compose 中的逐服务网络设置，因此这里不可手动设置网络模式。",
  "Whole-topology uploads keep per-service networking from fugue.yaml or docker-compose.yml, so manual network mode is only available for single-app uploads.":
    "完整拓扑上传会保留 fugue.yaml 或 docker-compose.yml 中的逐服务网络设置，因此手动网络模式只适用于单应用上传。",
  "ZIP archive": "ZIP 归档",
  "ZIP or TGZ": "ZIP 或 TGZ",
  archive: "归档",
  "{count} domain": "{count} 个域名",
  "{count} domains": "{count} 个域名",
  "{count} entrypoint": "{count} 个入口",
  "{count} entrypoints": "{count} 个入口",
  "{count} file": "{count} 个文件",
  "{count} files": "{count} 个文件",
  "{count} missing file before first deploy": "首次部署前有 {count} 个缺失文件",
  "{count} missing files before first deploy": "首次部署前有 {count} 个缺失文件",
  "{count} path route": "{count} 条路径路由",
  "{count} path routes": "{count} 条路径路由",
  "{count} variable before first deploy": "首次部署前有 {count} 个变量",
  "{count} variables before first deploy": "首次部署前有 {count} 个变量",
  "{count} warning found in {path}. Review before deploying.":
    "在 {path} 中发现 {count} 条警告。部署前请检查。",
  "{count} warnings found in {path}. Review before deploying.":
    "在 {path} 中发现 {count} 条警告。部署前请检查。",
  "{label} is required.": "必须填写 {label}。",
  "{name} · Default project": "{name} · 默认项目",
  "+{count} more file": "另有 {count} 个文件",
  "+{count} more files": "另有 {count} 个文件",
  "fugue.yaml detected": "已检测到 fugue.yaml",
  "not declared": "未声明",
  "Delete server": "删除服务器",
  "Delete server records here after the underlying VPS is permanently gone.":
    "在底层VPS 永久消失后，在此处删除服务器记录。",
  "Delete this server record after the VPS is permanently retired. Fugue will block deletion while workloads or active operations still reference it.":
    "在VPS 永久停用后删除此服务器记录。当工作负载或活动操作仍然引用它时，Fugue将阻止删除。",
  "Delete {name}?": "删除 {name}？",
  "Deleted {name}, but refresh failed: {message}":
    "已删除 {name}，但刷新失败：{message}",
  "Deleted {name}.": "已删除{name}。",
  "Deleting the project queues deletion for every service that still belongs to it, then removes the project shell.":
    "删除项目会先把仍属于它的每个服务加入删除队列，然后移除项目外壳。",
  "Deleting...": "正在删除…",
  "Desired {state}": "期望状态 {state}",
  "Detected image services for {projectName}": "检测到 {projectName} 的镜像服务",
  Digest: "摘要",
  ...
  Duration: "持续时间",
  Edge: "边缘",
  "Email link details": "邮箱链接详情",
  "Email sign-in details": "邮箱登录详细信息",
  Endpoint: "端点",
  "Enter a monthly price greater than 0, or mark the server free.":
    "输入大于 0 的月价格，或将服务器标记为免费。",
  "Enter a non-negative memory value with up to two decimals.":
    "输入最多两位小数的非负内存值。",
  "Enter the project name exactly as shown.": "如图所示准确输入项目名称。",
  "Enter {name} exactly to delete this server.": "准确输入 {name} 以删除此服务器。",
  Entrypoint: "入口点",
  "Environment edit modes": "环境编辑模式",
  "Failover already moved the primary to {primaryRuntimeLabel}. No standby runtime is protecting this database now. Choose a new standby to restore protection.":
    "故障转移已将主实例迁移到 {primaryRuntimeLabel}。当前没有备用运行时保护此数据库。请选择新的备用运行时恢复保护。",
  "Failover already moved this app to {primaryRuntimeLabel}. No standby runtime is protecting it now. Choose a new standby to restore protection.":
    "故障转移已将此应用迁移到 {primaryRuntimeLabel}。当前没有备用运行时保护它。请选择新的备用运行时恢复保护。",
  "Failover disable is queued. {primaryRuntimeLabel} keeps serving writes while Fugue removes the standby.{suffix}":
    "已排队禁用故障转移。Fugue 移除备用实例期间，{primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Failover enable is queued. Fugue will prepare {pendingTargetLabel} as the standby while {primaryRuntimeLabel} keeps serving writes.{suffix}":
    "已排队启用故障转移。Fugue 会将 {pendingTargetLabel} 准备为备用实例，同时 {primaryRuntimeLabel} 继续处理写入。{suffix}",
  "Fetching billing": "正在获取账单",
  Freshness: "数据时效",
  "Fugue can still deploy it as a repository import.": "Fugue 仍可按仓库导入来部署它。",
  "Fugue could not load the access key snapshot right now.":
    "Fugue 当前无法加载访问密钥快照。",
  ...
  "Fugue is moving the standby to {pendingTargetLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}":
    "Fugue 正在将备用实例迁移到 {pendingTargetLabel}。变更期间 {primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Fugue is provisioning {pendingTargetLabel} as the standby. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}":
    "Fugue 正在将 {pendingTargetLabel} 配置为备用实例。变更期间 {primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Fugue is removing the standby from {configuredStandbyLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}":
    "Fugue 正在从 {configuredStandbyLabel} 移除备用实例。变更期间 {primaryRuntimeLabel} 会继续处理写入。{suffix}",
  "Fugue is waiting for DNS to resolve for this hostname.":
    "Fugue 正在等待此主机名完成 DNS 解析。",
  "Fugue keeps {primaryRuntimeLabel} serving writes while it prepares {selectedTransferTargetLabel}, then promotes the new primary and keeps {primaryRuntimeLabel} as the standby.":
    "Fugue 会让 {primaryRuntimeLabel} 继续处理写入，同时准备 {selectedTransferTargetLabel}，随后提升新的主实例，并将 {primaryRuntimeLabel} 保留为备用实例。",
  ...
  "GitHub repositories, local uploads, or Docker images":
    "GitHub 仓库、本地上传或 Docker 镜像",
  "GitHub repository linked to {count} services.":
    "GitHub 仓库已关联到 {count} 个服务。",
  ...
  "These services keep their existing service-level tracking.":
    "这些服务会保留现有的服务单独跟踪。",
  "This service does not update images automatically.": "此服务不会自动更新镜像。",
  "This service keeps its own image tracking.": "此服务保留自己的镜像跟踪。",
  "This service keeps its own registry polling.": "此服务保留自己的镜像轮询。",
  "This service keeps its own webhook tracking.": "此服务保留自己的 Webhook 跟踪。",
  ...
  "Historical versions appear here after the app has been imported or redeployed through Fugue.":
    "应用通过 Fugue 导入或重新部署后，历史版本会显示在这里。",
  Host: "主机",
  "Image ref": "镜像引用",
  "Image updates": "镜像更新",
  "Import / {projectName}": "导入 / {projectName}",
  "Import a GitHub repository, local folder, or Docker image to create the first app.":
    "导入 GitHub 仓库、本地文件夹或 Docker 镜像来创建第一个应用。",
  "Import one service": "导入一个服务",
  "Import rules": "导入规则",
  "Import service": "导入服务",
  "Import the first service.": "导入第一个服务。",
  "Importing service…": "正在导入服务…",
  "Included resources: {preview}.": "附带资源： {preview}。",
  "Initial contents": "初始内容",
  "Inspect all cluster apps, tenants, routing state, rebuild controls, and deletes.":
    "检查所有集群应用、租户、路由状态、重建控制和删除操作。",
  "Inspect control-plane state, runtime pressure, workloads, and enrollment.":
    "检查控制平面状态、运行时压力、工作负载和注册。",
  "Internal registry inventory is not configured for this workspace yet.":
    "尚未为此工作区配置内部注册表清单。",
  "Issue a platform-scoped join key": "签发平台范围的加入密钥",
  "Issue platform key": "签发平台密钥",
  "Issuing key…": "正在颁发密钥…",
  "Join command copied.": "加入命令已复制。",
  "Keep prepaid balance, managed capacity, and retained image storage aligned for this workspace.":
    "保持此工作区的预付余额、托管容量和保留镜像存储一致。",
  "Keep server": "保留服务器",
  "Keep this database on its current primary runtime, choose a standby runtime for failover, or actively move the primary now.":
    "让此数据库继续运行在当前主运行时上，选择用于故障转移的备用运行时，或现在主动迁移主实例。",
  "Key label": "密钥标签",
  Kind: "类型",
  "Last contact": "最近联系",
  "Last contact {time}": "最近联系 {time}",
  "Last deployed {time}": "上次部署 {time}",
  "Leave blank to let Fugue generate the node key label.":
    "留空则由 Fugue 生成节点密钥标签。",
  Legacy: "旧版",
  "Load trace": "加载追踪",
  "Loading billing": "正在加载账单",
  "Loading image update settings…": "正在加载镜像更新设置……",
  "Loading project": "正在载入项目",
  "Loading route table…": "正在加载路由表…",
  "Loading workspace inventory.": "正在加载工作区清单。",
  "Local uploads": "本地上传",
  "Manage account state and quota context from the admin surface.":
    "从管理界面管理账号状态和配额上下文。",
  "Monitor attached runtime servers, capacity, heartbeat, and offline records.":
    "监控连接的运行时服务器、容量、心跳和离线记录。",
  "Most image data for this version is still shared with other saved images.":
    "此版本的大多数镜像数据仍与其他保存的镜像共享。",
  "Most image data in this history is still shared with other saved images.":
    "此历史记录中的大多数镜像数据仍与其他保存的镜像共享。",
  "Mount path": "挂载路径",
  "Mount {count}": "挂载 {count}",
  "New project": "新项目",
  Next: "下一步",
  "No alert feed exposed.": "未提供告警流。",
  "No contact recorded": "没有联系记录",
  "No data in this window.": "此窗口中没有数据。",
  "No live servers are reporting right now. Offline servers that still belong to this workspace are listed below.":
    "当前没有在线服务器上报。仍属于此工作区的离线服务器列在下方。",
  "No live servers right now": "当前没有在线服务器",
  "No logs": "无日志",
  "No managed image history yet.": "尚无托管镜像历史。",
  "No metric samples": "没有指标样本",
  "No platform key issued yet": "尚未颁发平台密钥",
  "No project routes.": "没有项目路由。",
  "No projects match the current filters.": "没有与当前筛选器匹配的项目。",
  "No projects yet": "还没有项目",
  "No requests in this window.": "此窗口中没有请求。",
  "No runtime changes.": "没有运行时更改。",
  "No stale images to clean up.": "没有陈旧的镜像需要清理。",
  "No trace selected": "未选择追踪",
  "No variables yet.": "尚无变量。",
  "No workloads": "无工作负载",
  "No workloads are assigned.": "未分配工作负载。",
  "No workloads are attached to this offline server.":
    "没有工作负载附加到此离线服务器。",
  "No workspace keys yet": "尚无工作区密钥",
  "Node keys enroll servers into the Fugue runtime plane.":
    "节点密钥将服务器注册到Fugue运行时平面。",
  "Not live": "未上线",
  Observability: "可观测性",
  "Observability data is unavailable.": "可观测性数据不可用。",
  "Observability source is not available.": "可观测性来源不可用。",
  "Observability views": "可观测性视图",
  "Observability window": "可观测性窗口",
  "Offline server": "离线服务器",
  "Offline servers": "离线服务器",
  "Only the current managed image is stored right now.":
    "当前只存储了正在使用的托管镜像。",
  "Open commit": "打开提交",
  "Operate cluster apps without leaving the admin surface.":
    "无需离开管理界面即可运行集群应用。",
  "Partial Fugue data": "Fugue 数据部分可用",
  "Partial admin data": "部分管理员数据",
  "Partial server data": "部分服务器数据",
  "Password details": "密码详情",
  "Paste a GitHub repository link and choose GitHub authorization or a token for private access.":
    "粘贴GitHub 仓库链接，然后选择GitHub授权或私有访问令牌。",
  Path: "路径",
  "Path must stay inside persistent storage. Switch to Live filesystem to work outside it.":
    "路径必须保留在持久化存储内。如需处理外部路径，请切换到在线文件系统。",
  "Path prefix": "路径前缀",
  Pending: "待处理",
  "Pending standby unavailable": "备用实例不可用",
  "Platform node join": "平台节点加入",
  "Platform node key issued.": "平台节点密钥已签发。",
  "Point Fugue at a published Docker image. Fugue mirrors it into the internal registry before rollout.":
    "将 Fugue 指向已发布的 Docker 镜像。发布前，Fugue 会把它同步到内部镜像仓库。",
  "Primary placement stays as-is until a later maintenance window, rebuild, node drain, or explicit rebalance.":
    "主实例部署位置会保持不变，直到后续维护窗口、重建、节点排空或显式重新均衡。",
  "Project deletion started.": "项目删除已开始。",
  "Project deletion started. Remaining services are being removed.":
    "项目删除已开始。剩余服务正在删除。",
  "Project filters": "项目筛选器",
  "Project name is required.": "必须填写项目名称。",
  "Project name updated.": "项目名称已更新。",
  "Project route table": "项目路由表",
  "Project route table updated.": "项目路由表已更新。",
  "Project state": "项目状态",
  "Project workbench": "项目工作台",
  "Projects collect services, routes, runtime placement, environment, and deployment controls.":
    "项目用于组织服务、路由、运行时位置、环境变量和部署控制。",
  "Protection missing": "缺少保护",
  "Protection restored. New standby runtime: {target}.":
    "保护已恢复。新的备用运行时：{target}。",
  "Public access": "公共访问",
  "Public image refs are mirrored into Fugue before rollout":
    "公开镜像引用会在发布前同步到 Fugue",
  "Public or private with GitHub authorization or a stored token":
    "公开仓库，或通过 GitHub 授权 / 已保存 Token 访问的私有仓库",
  Raw: "原始",
  "Rebuild queued from default branch.": "从默认分支排队重建。",
  "Rebuild queued from {branch}.": "从{branch}排队重建。",
  "Redeploy a known-good version, or delete stale images you no longer need.":
    "重新部署已知良好的版本，或删除不再需要的陈旧镜像。",
  Refresh: "刷新",
  "Refresh now": "立即刷新",
  "Remove mount": "移除挂载",
  "Remove {name}": "移除 {name}",
  "Remove {name} from the server inventory only if this VPS is permanently gone. Fugue will refuse the delete if apps, services, or active operations still depend on it.":
    "只有在此 VPS 永久下线时，才从服务器清单中移除 {name}。如果仍有应用、服务或活动操作依赖它，Fugue 会拒绝删除。",
  "Repository-backed services auto sync; image-backed services can repull the saved image ref":
    "仓库服务会自动同步；镜像服务可重新拉取已保存的镜像引用",
  "Resource usage": "资源使用量",
  "Restore protection": "恢复保护",
  "Retention pending": "保留待处理",
  "Retention {value}": "保留期 {value}",
  "Review node capacity, status, and workload pressure.":
    "查看节点容量、状态和工作负载压力。",
  "Review the current managed image and older saved versions for {appName}. Image storage is tracked separately from live service disk usage here, and stale versions can be redeployed or removed.":
    "查看 {appName} 的当前托管镜像和较早保存版本。这里的镜像存储会与在线服务磁盘用量分开统计，旧版本可重新部署或移除。",
  "Review users, admin status, quotas, service usage, and account state.":
    "查看用户、管理员状态、配额、服务使用情况和账号状态。",
  "Review workspace balance, usage envelope, storage, and capacity controls.":
    "查看工作区平衡、使用范围、存储和容量控制。",
  "Route availability response was malformed.": "路由可用性响应格式不正确。",
  "Route summary": "路由摘要",
  "Route table": "路由表",
  "Route table JSON is invalid.": "路由表JSON无效。",
  "Route table JSON must include domains and entrypoints arrays.":
    "路由表 JSON 必须包含 domains 和 entrypoints 数组。",
  "Route table must be a JSON object.": "路由表必须是JSON对象。",
  "Route updated. The new address is live immediately, and the old address has been released.":
    "路由已更新。新地址立即生效，旧地址已释放。",
  "Run authoritative DNS service on this machine.": "在此计算机上运行权威DNS服务。",
  "Run the public edge proxy on this machine.": "在此计算机上运行公共边缘代理。",
  "Run this on the target VPS": "在目标 VPS 上运行此命令",
  "Runtime nodes": "运行时节点",
  "Runtime ref": "运行时引用",
  "Save to switch the live route.": "保存后切换在线路由。",
  Saved: "已保存",
  "Saved history": "已保存历史记录",
  "Saved image deleted.": "已保存镜像已删除。",
  "Saved image history updated.": "已保存镜像历史已更新。",
  "Saved image was already missing.": "已保存镜像已不存在。",
  "Saved managed image": "已保存托管镜像",
  Schedulable: "可调度",
  "Search projects": "搜索项目",
  "Search projects...": "搜索项目…",
  "Select a request trace or enter a trace id.": "选择请求跟踪或输入跟踪ID。",
  "Send sign-in link": "发送登录链接",
  "Server name": "服务器名称",
  "Set up the workspace and prepare {projectName}.": "设置工作区并准备{projectName}。",
  "Setting up": "正在设置",
  "Sign in to continue with this image.": "登录以继续使用此镜像。",
  "Sign in to continue with this repository.": "登录以继续使用此仓库。",
  "Sign-in was verified, but Fugue could not open your workspace session. Try again in a minute.":
    "登录已验证，但Fugue无法打开您的工作区会话。请稍后重试。",
  "Sign-in was verified, but the browser session handoff expired before the cookie was written. Start again.":
    "登录已验证，但浏览器会话切换在写入Cookie之前已过期。请重新开始。",
  Sources: "来源",
  "Stable redirect / returnTo": "稳定重定向 / returnTo",
  "Standby update is queued. Fugue will move failover to {pendingTargetLabel} while {primaryRuntimeLabel} keeps serving writes.{suffix}":
    "备用实例更新已排队。Fugue 会把故障转移目标迁移到 {pendingTargetLabel}，同时 {primaryRuntimeLabel} 继续处理写入。{suffix}",
  "Start shared. Move cleanly.": "先使用共享环境，再平稳迁移。",
  "Starts after first deploy": "首次部署后开始",
  "Starts after first deploy.": "首次部署后开始。",
  "Startup command already matches the current release.": "启动命令已匹配当前版本。",
  "Startup command already uses the image default.": "启动命令已使用镜像默认值。",
  "Startup command cleared. Deploy queued.": "启动命令已清除。部署已排入队列。",
  "Startup command saved. Deploy queued.": "启动命令已保存。部署已排入队列。",
  "Stored for this workspace": "为此工作区存储",
  "Stored size": "存储大小",
  TTFB: "TTFB",
  "Template deploy": "模板部署",
  "That email link is invalid or expired. Request a fresh one.":
    "该邮箱链接无效或已过期。请重新请求。",
  "The database stays on its primary runtime. The standby runtime only takes over if the primary disappears. After a failover, choose a new standby to restore protection.":
    "数据库停留在其主运行时。备用运行时仅在主运行时消失时接管。故障转移后，选择一个新的备用以恢复保护。",
  "The image version that currently represents this app.": "当前表示此应用的镜像版本。",
  "This flow creates a platform-node key, not a tenant runtime key. The joined VPS stays platform-owned and can be promoted or constrained later.":
    "此流程创建平台节点密钥，而不是租户运行时密钥。加入的VPS仍然是平台所有的，可以在以后进行推广或限制。",
  "This hostname is already in use.": "此主机名已被使用。",
  "This hostname is already serving this app.": "此主机名已经为此应用提供服务。",
  "This hostname is attached, but setup hit a snag. Fugue will keep retrying in the background.":
    "已附加此主机名，但安装遇到了问题。Fugue将继续在后台重试。",
  "This hostname is attached. Fugue is finishing setup now.":
    "已附加此主机名。Fugue现在正在完成设置。",
  "This hostname is invalid.": "此主机名无效。",
  "This platform hostname is reserved. Platform admins can attach the root domain directly, but regular workspaces cannot claim it.":
    "此平台主机名已保留。平台管理员可以直接附加根域，但常规工作区无法声明。",
  "This repository does not expose template metadata in": "此仓库未暴露模板元数据",
  "This route is already current.": "此路由已处于当前状态。",
  "This route is already in use.": "此路由已被使用。",
  "This route is invalid.": "此路由无效",
  "This server is offline and no longer reporting heartbeats.":
    "此服务器处于离线状态，不再报告心跳。",
  "This server is offline. {details}": "此服务器处于离线状态。{details}",
  Time: "时间",
  "Total image storage": "总镜像存储",
  Trace: "追踪",
  "Trace data is unavailable.": "跟踪数据不可用。",
  "Trace id": "追踪 ID",
  "Type {name} exactly to enable deletion.": "准确输入 {name} 以启用删除。",
  "Unable to copy {label}.": "无法复制{label}。",
  "Unable to load GitHub image update settings right now.":
    "目前无法加载GitHub镜像更新设置。",
  "Unable to load saved images right now. Try refreshing this panel.":
    "目前无法加载保存的镜像。请尝试刷新此面板。",
  "Update repository": "更新仓库",
  Updates: "更新",
  Uploaded: "上传成功",
  "Use / for the root route, or /api for a path route.":
    "根路由使用 /，路径路由可使用 /api。",
  "Use 1 or more.": "请输入 1 或更大值。",
  "Use the directory path inside the service.": "使用服务内的目录路径。",
  "Use the exact file path inside the service.": "使用服务内的确切文件路径。",
  "Used only when Fugue needs to create the file for the first time. Existing file contents stay in place on later deploys.":
    "仅在Fugue需要首次创建文件时使用。现有文件内容在稍后部署时保持不变。",
  "User directory": "用户目录",
  Variables: "变量",
  "Wait for project deletion to finish before renaming it.":
    "在重命名项目之前，等待项目删除完成。",
  ...
  "When you issue a key, Fugue returns a one-time join command here so the next VPS can attach as a platform node immediately.":
    "当您发出密钥时，Fugue在此处返回一次性加入命令，以便下一个VPS可以立即作为平台节点连接。",
  Work: "工作",
  "Workspace API keys control Fugue API access and automation scopes.":
    "工作区 API 密钥用于控制 Fugue API 访问和自动化权限范围。",
  "Workspace missing": "缺少工作区",
  "Keep secrets out of deploy links.": "不要在部署链接中包含密钥。",
  "Image storage": "镜像存储",
  "Live service runtime only": "仅在线服务运行时",
  "No environment variables will be applied on the first deploy.":
    "首次部署不会应用任何环境变量。",
  "No environment variables will be set on the first deploy.":
    "首次部署不会设置任何环境变量。",
  "Profile, account, and workspace preferences": "个人资料、账号和工作区偏好",
  "Projects, services, routes, and deploy controls": "项目、服务、路由和部署控制",
  "Server health, heartbeat, and workloads": "服务器健康、心跳和工作负载",
  "Stored project images": "已存储项目镜像",
  "edge-singapore-01": "edge-singapore-01",
  ...
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically.":
    "Fugue 准备 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically. {transferPreparationNote}":
    "Fugue 准备 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。{transferPreparationNote}",
  "{email} will lose admin access and stay in the workspace as a regular user.":
    "{email} 将失去管理员访问权限，并以普通用户身份留在工作区。",
  "{label} copied.": "{label} 已复制。",
  "{name} and its {count} services will be queued for deletion from this workspace. {preview}":
    "{name} 及其 {count} 个服务将加入队列，并从此工作区删除。{preview}",
  "{name} is no longer reporting heartbeats.": "{name} 不再上报心跳。",
  "{provider} sign-in could not be completed. Check the callback URL and provider credentials, then try again.":
    "{provider}登录无法完成。请检查回调URL和提供商凭据，然后重试。",
  "{provider} sign-in details": "{provider} 登录详情",
  "{provider} sign-in was cancelled before authorization finished.":
    "{provider}登录在授权完成前被取消。",
  "{title} will be removed from {appName}'s saved image history.":
    "{title} 将从 {appName} 的已保存镜像历史中移除。",
  "{value} {unit}": "{value} {unit}",
} satisfies MessageCatalog;

const zhTWMorlanePatchMessages = {
  " +{count} more": "另有 {count} 项",
  "API keys": "API keys",
  "Account / Preferences": "帳號 / 偏好",
  "Admins / Quotas / Access": "管理員 / 配額 / 存取",
  "Admins, quotas, and access": "管理員、配額與存取控制",
  "Abort build & delete": "中止建立並刪除",
  "Abort deploy & delete": "中止部署和刪除",
  "Abort the in-flight build and force delete this service.":
    "中止飛行中組建並強制刪除此服務。",
  "Abort the in-flight deploy and force delete this service.":
    "中止飛行中部署並強制刪除此服務。",
  "Aborting…": "正在放棄",
  "Access key snapshot unavailable": "存取金鑰快照無法使用",
  Account: "我的帳號",
  Active: "作用中",
  "Add a directory or file mount to keep it across redeploys, restarts, runtime moves, and failover.":
    "新增目錄或檔案掛載，將其保留在重新部署、重新啟動、執行階段移動和容錯移轉之間。",
  "Add a workspace admin key for another environment, or copy a stored secret.":
    "新增其他環境的工作區系統管理金鑰，或複製儲存的機密。",
  "Add admin key": "添加管理员金鑰",
  "Add credits before you raise the saved cap. Fugue deducts credits from active resources, and stored images count toward disk usage.":
    "提高已儲存上限前请先充值餘額。Fugue 会从活动資源中扣除餘額，已儲存映像也会计入磁盘用量。",
  "Add directory": "新增目錄…",
  "Add file": "添加檔案",
  "Adjust from 0 to {max} GiB in {step} GiB steps.":
    "从 0 到 {max} GiB 调整，步进为 {step} GiB。",
  "Adjust from 0 to {max} cpu in {step} cpu steps.":
    "从 0 到 {max} CPU 调整，步进为 {step} CPU。",
  "Admin key added and secret copied.": "管理员金鑰已添加，并已複製新金鑰。",
  "Admin key added. Copy the new secret now.": "管理员金鑰已添加。请立即複製新金鑰。",
  "Admin keys": "管理员金鑰",
  "All projects": "所有專案",
  "Allow DNS": "允許DNS",
  "Allow edge": "允許邊緣",
  "Another project already uses “{name}”. Project names must be unique within the workspace.":
    "另一個專案已使用「{name}」。專案名稱在工作區中必須是唯一的。",
  "Any available region": "任意可用區域",
  "App id is required.": "必須要有 ID",
  "App service": "應用服務",
  "Apply table": "應用路由表",
  "Attached app": "附加的應用程式",
  "Awaiting runtime": "等待運行時",
  "Background worker": "後臺工作者",
  "Balance, metering, and capacity": "餘額、計量與容量",
  "Billing and capacity details": "帳務与容量詳情",
  "Bind one repository for this project. Fugue reads the repository workflow image outputs and maps them to app services automatically.":
    "为此專案绑定一个儲存庫。Fugue 会读取儲存庫工作流输出的映像，并自动映射到應用服務。",
  "Bind project": "綁定專案",
  "Binding…": "正在绑定…",
  "Bootstrap a workspace before enrolling servers into Fugue.":
    "先初始化工作區，再将伺服器接入 Fugue。",
  "Bootstrap the workspace to create the first node key.":
    "初始化工作區以建立第一个節點金鑰。",
  Bottleneck: "瓶颈",
  "Branch, app name, build strategy, and optional source paths":
    "分支、應用程式名稱、構建策略和可選的來源路徑",
  "Add directories or files that must stay attached after deploys and restarts.":
    "新增部署和重新啟動後仍需保留的目錄或檔案。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents are only used the first time Fugue creates that file.":
    "新增重新部署、重新啟動和執行階段遷移後仍需保留的目錄或檔案。檔案內容只會在 Fugue 第一次建立該檔案時使用。",
  "Add directories or files that should stay attached after redeploys, restarts, and runtime moves. File contents only apply when Fugue creates the file for the first time.":
    "新增重新部署、重新啟動和執行階段遷移後仍需保留的目錄或檔案。檔案內容只會在 Fugue 第一次建立該檔案時生效。",
  "After submission, Fugue creates the app and starts the import operation immediately.":
    "提交後，Fugue 會建立應用並立即啟動匯入操作。",
  "App name, startup command, and optional build overrides.":
    "應用名稱、啟動命令和可選建置覆寫項。",
  "Auto detect keeps compose and fugue manifest imports intact.":
    "自動偵測會保留 compose 和 fugue manifest 的完整匯入。",
  "Auto detect works for most repositories.": "自動偵測適用於大多數儲存庫。",
  "Auto-generate on deploy": "部署時自動產生",
  "Background workers run without a managed route, Kubernetes Service, or readiness port.":
    "背景工作者不會建立受管路由、Kubernetes Service 或就緒連接埠。",
  "Background workers skip the managed route, Kubernetes Service, and readiness port.":
    "背景工作者會略過受管路由、Kubernetes Service 和就緒連接埠。",
  Build: "構造",
  "Build aborted. Force delete queued.": "組建已中止。強制刪除已排入佇列。",
  "Build is still running. Switch to Build to follow progress.":
    "生成仍在運行。切換至「建立」以追蹤進度。",
  "Cancel rollout & delete": "取消發布並刪除",
  "Cancel the in-flight transfer and force delete this service.":
    "取消機上轉機並強制刪除此服務。",
  "Cluster / Rebuild / Delete": "叢集 / 重建 / 刪除",
  "Cluster apps, rebuilds, and deletes": "叢集應用、重建與刪除",
  "Control-plane nodes, pressure, and workloads": "控制平面節點、壓力與工作負載",
  "Create new project": "建立新專案",
  "Create new project · {name}": "建立新專案 · {name}",
  "Create project failed.": "建立專案失敗。",
  "Create / Rebuild / Scopes": "建立 / 重建 / 權限範圍",
  "Create, rebuild, and scope API keys": "建立、重建並限制 API 金鑰權限",
  "Choose where the mirrored image should land for the first rollout.":
    "選擇鏡像首次發布要落到哪裡。",
  "Choose where the upload should land. Only add manual build settings when the upload is meant to deploy as a single app instead of a full manifest or compose topology.":
    "選擇上傳內容要落到哪裡。只有當上傳內容要作為單一應用部署，而不是完整 manifest 或 compose 拓撲時，才新增手動建置設定。",
  "Choose whether Fugue should expose this app publicly, keep it cluster-internal, or run it as a background worker.":
    "選擇 Fugue 是公開此應用、保持叢集內部存取，還是作為背景工作者執行。",
  "Current project total": "目前專案總計",
  Deploy: "部署",
  "Deploy from a Docker image.": "從 Docker 映像部署。",
  "Deploy from a local source.": "從本機原始碼部署。",
  "Deploy request failed.": "部署請求失敗。",
  Dockerfile: "Dockerfile",
  "Archive ready": "封存檔已就緒",
  "Choose archive": "選擇封存檔",
  "Choose files": "選擇檔案",
  "Choose folder": "選擇資料夾",
  "Compose detected": "已偵測到 Compose",
  "Direct import": "直接匯入",
  "Dockerfile detected": "已偵測到 Dockerfile",
  "Drop a folder, archive, or source files": "拖入資料夾、封存檔或原始碼檔案",
  "Defaults to the repository root when omitted.": "留空則預設使用儲存庫根目錄。",
  "Defaults to the uploaded root when omitted.": "留空則預設使用上傳根目錄。",
  "Drag a local folder, .zip, .tgz, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Fugue packages file uploads on the server, then imports the detected topology when present.":
    "拖入本機資料夾、.zip、.tgz、docker-compose.yml、fugue.yaml、Dockerfile 或多個原始碼檔案。Fugue 會在伺服器端打包上傳檔案，並在偵測到拓撲時執行完整匯入。",
  "Drag a local folder, a .zip or .tgz archive, docker-compose.yml, fugue.yaml, Dockerfile, or multiple source files. Folder drop works when the browser exposes directory entries.":
    "拖入本機資料夾、.zip 或 .tgz 封存檔、docker-compose.yml、fugue.yaml、Dockerfile 或多個原始碼檔案。瀏覽器暴露目錄項目時可以直接拖入資料夾。",
  "Enter the value that should exist before the first deploy.":
    "輸入首次部署前應存在的值。",
  "Enter value": "輸入值",
  "Folder / ZIP / compose": "資料夾 / ZIP / Compose",
  "Folder drag": "資料夾拖放",
  "Fugue creates the project if needed, packages the selected files, and then sends you back to the console.":
    "Fugue 會視需要建立專案，打包所選檔案，然後帶你回到控制台。",
  "Fugue will import this archive directly. GitHub download ZIP files work as-is, without repackaging them in the browser.":
    "Fugue 會直接匯入此封存檔。GitHub 下載的 ZIP 檔可原樣使用，無需在瀏覽器中重新打包。",
  "Fugue will package these files on the server, then import them through the same upload route used by local deploys.":
    "Fugue 會在伺服器端打包這些檔案，然後透過本機部署使用的同一上傳路徑匯入。",
  "Fugue mirrors the published image into the internal registry, creates the app, and queues the first rollout onto the selected runtime.":
    "Fugue 會將已發布映像同步到內部映像倉庫，建立應用，並將首次發布排入所選執行環境。",
  "GitHub download ready": "GitHub 下載可用",
  "Image deploy network mode": "映像部署網路模式",
  "Includes {items}.": "包含 {items}。",
  "Internal services get a cluster-only Service and readiness checks, without a public route.":
    "內部服務會取得僅限叢集內存取的 Service 和就緒檢查，不會建立公開路由。",
  "Internal services keep a cluster-only Service and readiness checks, but Fugue does not publish a public route for them.":
    "內部服務會保留僅限叢集內存取的 Service 和就緒檢查，Fugue 不會為它們發布公開路由。",
  "Imports {count} service from {path}": "從 {path} 匯入 {count} 個服務",
  "Imports {count} service from {path}.": "從 {path} 匯入 {count} 個服務。",
  "Imports {count} services from {path}": "從 {path} 匯入 {count} 個服務",
  "Imports {count} services from {path}.": "從 {path} 匯入 {count} 個服務。",
  "Leave blank to auto-generate it.": "留空則自動產生。",
  "Leave blank to auto-generate this value when the deploy is queued.":
    "留空則在部署排入佇列時自動產生此值。",
  "Leave blank to create an empty file.": "留空則建立空檔案。",
  "Leave blank to reuse the image name.": "留空則重用映像名稱。",
  "Leave blank to reuse the repository name.": "留空則重用儲存庫名稱。",
  "Leave blank to reuse the uploaded folder or primary service name.":
    "留空則重用上傳資料夾或主服務名稱。",
  "Leave blank to use the default.": "留空則使用預設值。",
  "Leave blank to use the default value.": "留空則使用預設值。",
  "Manual build overrides are active. Clear build strategy and path overrides if you want Fugue to import every service from fugue.yaml or docker-compose.":
    "手動建置覆寫項已啟用。如果希望 Fugue 從 fugue.yaml 或 docker-compose 匯入所有服務，請清空建置策略和路徑覆寫項。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while this deploy preserves a whole topology. Switch back to a single-app deploy to reuse them.":
    "手動持久化儲存掛載會保留在此草稿中，但目前部署保留完整拓撲時 Fugue 會略過它們。切回單一應用部署即可重用。",
  "Manual persistent storage mounts stay in this draft, but Fugue skips them while the upload imports a whole topology. Switch back to a single-app upload to reuse them.":
    "手動持久化儲存掛載會保留在此草稿中，但上傳內容匯入完整拓撲時 Fugue 會略過它們。切回單一應用上傳即可重用。",
  "Manifest import": "Manifest 匯入",
  "Multi-service ready": "多服務就緒",
  "Name {name}": "名稱 {name}",
  "New project name": "新專案名稱",
  "Override the default entrypoint only when this upload should start with a custom shell command.":
    "僅當此上傳內容需要以自訂 shell 命令啟動時，才覆寫預設入口。",
  "Override the image default entrypoint only when this service needs a different launch command.":
    "僅當此服務需要不同啟動命令時，才覆寫映像預設入口。",
  "Primary service: {service}.": "主服務：{service}。",
  "Project inventory is unavailable right now. You can still deploy into a new project.":
    "專案清單目前無法使用。你仍可部署到新專案。",
  "Public image references work best for one-click deploy links because this flow does not collect registry credentials.":
    "一鍵部署連結最適合使用公開映像引用，因為此流程不會收集映像倉庫憑證。",
  "Public services get a managed route and readiness checks.":
    "公開服務會取得受管路由和就緒檢查。",
  "Public services get a managed route. Internal services stay cluster-only. Background workers skip route and readiness setup.":
    "公開服務會取得受管路由。內部服務僅限叢集內存取。背景工作者會略過路由和就緒設定。",
  "Queue deployment": "排隊部署",
  "Queue image deploy": "排隊映像部署",
  "Queueing image deploy…": "正在排隊映像部署…",
  "Queuing deploy": "正在排隊部署",
  "Repository build": "儲存庫建置",
  "Required when the Dockerfile is outside the uploaded root.":
    "Dockerfile 位於上傳根目錄外時必填。",
  "Reuse an existing project or create a new one for this deploy.":
    "重用現有專案，或為此次部署建立新專案。",
  "Runs as `sh -lc <command>`. Leave blank to use the image default entrypoint.":
    "以 `sh -lc <command>` 執行。留空則使用映像預設入口。",
  "Service {service}. Leave blank to create an empty file on first deploy.":
    "服務 {service}。留空則在首次部署時建立空檔案。",
  "Set this when the container listens on a known port.": "容器監聽固定連接埠時填寫。",
  "Single file import": "單檔案匯入",
  Target: "目標",
  "Target and build": "目標與建置",
  "Template deploy network mode": "模板部署網路模式",
  ...
  "This project will be created before the deploy is queued.":
    "此專案會在部署排入佇列前建立。",
  "Upload and deploy": "上傳並部署",
  "Upload ready": "上傳已就緒",
  "Upload deploy network mode": "上傳部署網路模式",
  "Uploading deploy": "正在上傳部署",
  "Use a pullable public image reference such as ghcr.io/example/api:1.2.3.":
    "使用可拉取的公開映像引用，例如 ghcr.io/example/api:1.2.3。",
  "Use when the app lives below the repo root.": "應用位於儲存庫根目錄下層路徑時使用。",
  "Use when the app lives below the uploaded root.":
    "應用位於上傳根目錄下層路徑時使用。",
  "Whole-topology import is ready. Leave build strategy on Auto detect and keep manual path overrides blank to import every service from fugue.yaml or docker-compose.":
    "完整拓撲匯入已就緒。保持建置策略為自動偵測，並留空手動路徑覆寫項，即可從 fugue.yaml 或 docker-compose 匯入所有服務。",
  "Whole-topology imports keep per-service networking from fugue.yaml or docker-compose, so manual network mode is unavailable here.":
    "完整拓撲匯入會保留 fugue.yaml 或 docker-compose 中的逐服務網路設定，因此這裡無法手動設定網路模式。",
  "Whole-topology uploads keep per-service networking from fugue.yaml or docker-compose.yml, so manual network mode is only available for single-app uploads.":
    "完整拓撲上傳會保留 fugue.yaml 或 docker-compose.yml 中的逐服務網路設定，因此手動網路模式只適用於單一應用上傳。",
  "ZIP archive": "ZIP 封存檔",
  "ZIP or TGZ": "ZIP 或 TGZ",
  archive: "封存檔",
  "{count} domain": "{count} 個網域",
  "{count} domains": "{count} 個網域",
  "{count} entrypoint": "{count} 個入口",
  "{count} entrypoints": "{count} 個入口",
  "{count} file": "{count} 個檔案",
  "{count} files": "{count} 個檔案",
  "{count} missing file before first deploy": "首次部署前有 {count} 個缺失檔案",
  "{count} missing files before first deploy": "首次部署前有 {count} 個缺失檔案",
  "{count} path route": "{count} 條路徑路由",
  "{count} path routes": "{count} 條路徑路由",
  "{count} variable before first deploy": "首次部署前有 {count} 個變數",
  "{count} variables before first deploy": "首次部署前有 {count} 個變數",
  "{count} warning found in {path}. Review before deploying.":
    "在 {path} 中發現 {count} 條警告。部署前請檢查。",
  "{count} warnings found in {path}. Review before deploying.":
    "在 {path} 中發現 {count} 條警告。部署前請檢查。",
  "{label} is required.": "必須填寫 {label}。",
  "{name} · Default project": "{name} · 預設專案",
  "+{count} more file": "另有 {count} 個檔案",
  "+{count} more files": "另有 {count} 個檔案",
  "fugue.yaml detected": "已偵測到 fugue.yaml",
  "not declared": "未宣告",
  "Deploy onto a machine shared with this workspace.": "部署到與此工作區共用的機器。",
  "Deploy onto the internal cluster.": "部署到內部叢集。",
  "Deploy onto this machine.": "部署到這台機器。",
  "Deploy onto this machine. It also contributes to the internal cluster.":
    "部署到這台機器。它也會為內部叢集提供容量。",
  "Cancel the queued rollout and force delete this service.":
    "取消佇列發布並強制刪除此服務。",
  "Cancel transfer & delete": "取消轉移並刪除",
  "Choose Google or a verified email link. Password can be added later from the profile page.":
    "選擇Google或已驗證的電子郵件連結。稍後可以從個人資料頁面新增密碼。",
  Clear: "清除",
  "Clear filters": "清除篩選器",
  "Clear history": "清除歷程",
  "Clear raw": "清空原始内容",
  ...
  Console: "主控台",
  "Console / first run": "控制台 / 首次运行",
  "Copy join command": "複製加入命令",
  "Copy ref": "複製引用",
  "Copy the join command manually.": "请手动複製加入命令。",
  "Create a CNAME record for {hostname} pointing to {target}. Fugue will verify it automatically once DNS resolves.":
    "為指向{target}的{hostname}建立CNAME記錄。解析DNS後，Fugue會自動驗證。",
  "Create a CNAME record pointing to {target}. Fugue will verify it automatically once DNS resolves.":
    "建立指向{target}的CNAME 记录。一旦DNS 解析，Fugue将自动验证它。",
  "Create a node key, run the join command on your VPS, or wait for another workspace to share a server with you.":
    "建立節點金鑰，在VPS上运行加入命令，或等待另一个工作區与您共享伺服器。",
  "Create scoped API keys and node enrollment keys from one access surface.":
    "在同一个存取界面建立限定範圍的 API 金鑰和節點接入金鑰。",
  "Create the first project, import a service, and Fugue will attach route controls when the first app record is ready.":
    "建立第一个專案，导入服務，当第一个應用记录準備就绪时，Fugue将附加路由控件。",
  "Create the first project.": "建立第一个專案。",
  "Creating workspace…": "正在建立工作區…",
  Current: "目前",
  "Current managed image": "目前托管映像",
  "Current managed usage is {usage}.": "目前托管使用量为{usage}。",
  Resource: "資源",
  "Current primary": "目前主節點",
  "Current primary: {primaryRuntimeLabel}. Choose a destination and Fugue will prepare the new primary before switching over.":
    "目前主實例：{primaryRuntimeLabel}。選擇目标后，Fugue 会先準備新的主實例再切换。",
  "Current primary: {primaryRuntimeLabel}. Destination: {activeTransferTargetLabel}. Fugue promotes the new primary automatically once it is ready.":
    "目前主實例：{primaryRuntimeLabel}。目标：{activeTransferTargetLabel}。準備就绪后，Fugue 会自动提升新的主實例。",
  "Current release": "目前版本",
  DNS: "DNS",
  "Database protection restored. New standby runtime: {target}.":
    "資料库保護已恢复。新的備用執行環境： {target}。",
  "Delete all saved images?": "刪除所有儲存的映像？",
  "Delete image": "刪除映像",
  "Delete project and services?": "刪除專案和服務？",
  "Delete project?": "刪除專案",
  "Delete request was not accepted.": "刪除请求未被接受。",
  "Delete saved image?": "刪除已儲存映像？",
  "Delete server": "刪除伺服器",
  "Delete server records here after the underlying VPS is permanently gone.":
    "在底层VPS 永久消失后，在此处刪除伺服器记录。",
  "Delete this server record after the VPS is permanently retired. Fugue will block deletion while workloads or active operations still reference it.":
    "在VPS 永久停用后刪除此伺服器记录。当工作负载或活动操作仍然引用它时，Fugue将阻止刪除。",
  "Delete {name}?": "刪除{name} ？",
  "Deleted {name}, but refresh failed: {message}":
    "已刪除{name} ，但重新整理失败： {message}",
  "Deleted {name}.": "已刪除{name}。",
  "Deleting the project queues deletion for every service that still belongs to it, then removes the project shell.":
    "刪除仍然属于它的每个服務的專案佇列刪除，然后刪除專案shell。",
  "Deleting...": "正在刪除…",
  "Desired {state}": "期望狀態 {state}",
  "Detected image services for {projectName}": "检测到{projectName}的映像服務",
  Digest: "摘要",
  "Directories keep whole trees. Files mount one exact path.":
    "目錄儲存整棵树。檔案挂载一个精确路径。",
  ...
  Duration: "持续时间",
  Edge: "边缘",
  "Email link details": "電子郵件連結詳情",
  "Email sign-in details": "電子郵件登入详细資訊",
  Enabled: "已启用",
  Endpoint: "端点",
  "Enter a monthly price greater than 0, or mark the server free.":
    "输入大于0的月租价格，或将伺服器标记为免费。",
  "Enter a non-negative memory value with up to two decimals.":
    "输入最多两位小数的非负内存值。",
  "Enter the project name exactly as shown.": "如图所示准确输入專案名称。",
  "Enter the service name exactly as shown.": "请按显示内容准确输入服務名称。",
  "Enter {name} exactly to delete this server.": "准确输入{name}以刪除此伺服器。",
  Entrypoint: "入口点",
  "Environment edit modes": "环境编辑模式",
  "Failover already moved the primary to {primaryRuntimeLabel}. No standby runtime is protecting this database now. Choose a new standby to restore protection.":
    "故障转移已将主實例遷移到 {primaryRuntimeLabel}。目前没有備用執行環境保護此資料库。请選擇新的備用執行環境恢复保護。",
  "Failover already moved this app to {primaryRuntimeLabel}. No standby runtime is protecting it now. Choose a new standby to restore protection.":
    "故障转移已将此應用遷移到 {primaryRuntimeLabel}。目前没有備用執行環境保護它。请選擇新的備用執行環境恢复保護。",
  "Failover disable is queued. {primaryRuntimeLabel} keeps serving writes while Fugue removes the standby.{suffix}":
    "已排隊禁用故障转移。Fugue 移除備用实例期间，{primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Failover enable is queued. Fugue will prepare {pendingTargetLabel} as the standby while {primaryRuntimeLabel} keeps serving writes.{suffix}":
    "已排隊启用故障转移。Fugue 会将 {pendingTargetLabel} 準備为備用实例，同时 {primaryRuntimeLabel} 继续处理寫入。{suffix}",
  "Fetching billing": "正在获取账单",
  "Finish DNS setup and Fugue will verify this hostname automatically.":
    "完成 DNS 配置后，Fugue 会自动验证此主機名。",
  "Force delete is already queued.": "强制刪除已在佇列中。",
  "Force delete service?": "强制刪除服務？",
  "Force delete this pending service.": "强制刪除这个待处理服務。",
  Freshness: "資料时效",
  "Fugue can still deploy it as a repository import.":
    "Fugue仍然可以将其部署为儲存庫导入。",
  "Fugue could not load the access key snapshot right now.":
    "Fugue目前无法載入存取金鑰快照。",
  "Fugue could not open the workspace session. Try again.":
    "Fugue无法打开工作區会话。请重试。",
  "Fugue is moving the standby to {pendingTargetLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}":
    "Fugue 正在将備用实例遷移到 {pendingTargetLabel}。变更期间 {primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Fugue is provisioning {pendingTargetLabel} as the standby. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}":
    "Fugue 正在将 {pendingTargetLabel} 配置为備用实例。变更期间 {primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Fugue is removing the standby from {configuredStandbyLabel}. {primaryRuntimeLabel} keeps serving writes throughout the change.{suffix}":
    "Fugue 正在从 {configuredStandbyLabel} 移除備用实例。变更期间 {primaryRuntimeLabel} 会继续处理寫入。{suffix}",
  "Fugue is waiting for DNS to resolve for this hostname.":
    "Fugue正在等待DNS 解析此主機名。",
  "Fugue keeps {primaryRuntimeLabel} serving writes while it prepares {selectedTransferTargetLabel}, then promotes the new primary and keeps {primaryRuntimeLabel} as the standby.":
    "Fugue 会让 {primaryRuntimeLabel} 继续处理寫入，同时準備 {selectedTransferTargetLabel}，随后提升新的主實例，并将 {primaryRuntimeLabel} 保留为備用实例。",
  ...
  "GitHub repositories, local uploads, or Docker images":
    "GitHub 儲存庫、本地上传或Docker 映像",
  "GitHub repository": "GitHub 儲存庫",
  "GitHub repository linked to {count} services.":
    "GitHub 儲存庫已关联到 {count} 个服務。",
  ...
  "These services keep their existing service-level tracking.":
    "這些服務會保留現有的服務單獨追蹤。",
  "This service does not update images automatically.": "此服務不會自動更新映像。",
  "This service keeps its own image tracking.": "此服務保留自己的映像追蹤。",
  "This service keeps its own registry polling.": "此服務保留自己的映像輪詢。",
  "This service keeps its own webhook tracking.": "此服務保留自己的 Webhook 追蹤。",
  ...
  "GitHub source saved. Redeploy when you are ready.":
    "GitHub 來源已儲存。準備好後可重新部署。",
  "Give the project a name, then point Fugue at the first GitHub repository, local folder, or Docker image.":
    "先为專案命名，然后将 Fugue 指向第一个 GitHub 儲存庫、本地檔案夹或 Docker 映像。",
  Google: "Google",
  "Google route": "Google 路径",
  "Historical image queued for deploy.": "歷史映像已排隊部署。",
  "Historical image selected for deploy.": "已選擇歷史映像进行部署。",
  "Historical versions appear here after the app has been imported or redeployed through Fugue.":
    "應用通过 Fugue 导入或重新部署后，歷史版本会显示在这里。",
  Host: "主機",
  "Image ref": "映像引用",
  "Image updates": "映像更新",
  "Import / {projectName}": "导入/{projectName}",
  "Import a GitHub repository, local folder, or Docker image to create the first app.":
    "导入GitHub 儲存庫、本地檔案夹或Docker 映像以建立第一个應用。",
  "Import is already running.": "导入已在进行中。",
  "Import is still running. Switch to Build to follow progress.":
    "导入仍在进行中。切换到“构建”查看进度。",
  "Import one service": "导入一项服務",
  "Import rules": "导入规则",
  "Import service": "导入服務",
  "Import the first service.": "导入第一个服務。",
  "Importing service…": "正在导入服務…",
  "Included resources: {preview}.": "附带資源： {preview}。",
  "Initial contents": "初始内容",
  "Inspect all cluster apps, tenants, routing state, rebuild controls, and deletes.":
    "檢查所有叢集應用、租户、路由狀態、重建控件和刪除。",
  "Inspect control-plane state, runtime pressure, workloads, and enrollment.":
    "檢查控制平面狀態、執行環境压力、工作负载和註冊。",
  "Internal cluster": "內部叢集",
  "Internal registry inventory is not configured for this workspace yet.":
    "尚未为此工作區配置內部註冊表清单。",
  Invalid: "無效",
  "Issue a platform-scoped join key": "签发平台範圍的加入金鑰",
  "Issue platform key": "签发平台金鑰",
  "Issuing key…": "正在颁发金鑰…",
  "Join command copied.": "加入命令已複製。",
  "Just now": "刚刚",
  "Keep prepaid balance, managed capacity, and retained image storage aligned for this workspace.":
    "保持此工作區的预付餘額、托管容量和保留映像儲存一致。",
  "Keep server": "保留伺服器",
  "Keep this database on its current primary runtime, choose a standby runtime for failover, or actively move the primary now.":
    "将此資料库保留在其目前主執行環境上，選擇用于故障转移的備用執行環境，或立即主动移动主執行環境。",
  "Key label": "金鑰标签",
  Kind: "類型",
  "Last contact": "最近联系",
  "Last contact {time}": "最近联系 {time}",
  ...
  Live: "線上",
  "Load trace": "載入追踪",
  "Loading billing": "正在載入账单",
  "Loading image update settings…": "正在載入映像更新設定……",
  "Loading project": "正在载入專案",
  "Loading route table…": "正在載入路由表…",
  "Loading saved images…": "正在載入已儲存映像…",
  "Loading workspace inventory.": "正在載入工作區清单。",
  "Local files are selected after sign-in, not before the auth redirect.":
    "本地檔案需要在登入后選擇，而不是在认证跳转之前。",
  "Local upload": "本地上传",
  "Local uploads": "本地上传",
  "Log views": "日志视图",
  "Magic link / 15 min": "魔法連結 / 15 分钟",
  "Manage account state and quota context from the admin surface.":
    "从管理界面管理帳號狀態和配额上下文。",
  "Monitor attached runtime servers, capacity, heartbeat, and offline records.":
    "监控连接的執行環境伺服器、容量、心跳和離線记录。",
  "Most image data for this version is still shared with other saved images.":
    "此版本的大多数映像資料仍与其他儲存的映像共享。",
  "Most image data in this history is still shared with other saved images.":
    "此歷史记录中的大多数映像資料仍与其他儲存的映像共享。",
  "Mount path": "挂载路径",
  "Mount {count}": "挂载 {count}",
  "New project": "新專案",
  Next: "下一步",
  ...
  "No alert feed exposed.": "未提供告警流。",
  "No contact recorded": "没有联系记录",
  "No data in this window.": "此窗口中没有資料。",
  "No environment changes.": "环境變數没有变化。",
  "No live servers are reporting right now. Offline servers that still belong to this workspace are listed below.":
    "目前没有線上伺服器上报。仍属于此工作區的離線伺服器列在下方。",
  "No live servers right now": "目前没有線上伺服器",
  "No log lines were received before the stream closed.": "流关闭前没有收到任何日志。",
  "No logs": "无日志",
  "No logs available.": "没有可用日志。",
  "No managed image history yet.": "尚无托管映像歷史记录。",
  "No metric samples": "没有指标样本",
  "No platform key issued yet": "尚未颁发平台金鑰",
  "No project routes.": "没有專案路由。",
  "No projects match the current filters.": "没有与目前筛选器匹配的專案。",
  "No projects yet": "还没有專案",
  "No requests in this window.": "此窗口中没有请求。",
  "No runtime changes.": "没有執行環境更改。",
  "No stale images to clean up.": "没有陈旧的映像需要清理。",
  "No trace selected": "未選擇追踪",
  "No variables yet.": "尚无變數。",
  "No workloads": "无工作负载",
  "No workloads are assigned.": "未分配工作负载。",
  "No workloads are attached to this offline server.":
    "没有工作负载附加到此離線伺服器。",
  "No workspace keys yet": "尚无工作區金鑰",
  "Node keys enroll servers into the Fugue runtime plane.":
    "節點金鑰将伺服器註冊到Fugue執行環境平面。",
  "Not live": "未上線",
  Observability: "可观测性",
  "Observability data is unavailable.": "可观测性資料不可用。",
  "Observability source is not available.": "可观测性来源不可用。",
  "Observability views": "可观测性视图",
  "Observability window": "可观测性窗口",
  Offline: "離線",
  "Offline server": "離線伺服器",
  "Offline servers": "離線伺服器",
  "Only the current managed image is stored right now.": "目前仅儲存目前托管映像。",
  "Open commit": "打开提交",
  "Opening the console with a first-party session.": "正在用第一方会话打开控制台。",
  "Operate cluster apps without leaving the admin surface.":
    "无需离开管理界面即可运行叢集應用。",
  "Partial Fugue data": "Fugue 資料部分可用",
  "Partial admin data": "部分管理员資料",
  "Partial server data": "部分伺服器資料",
  "Password details": "密码詳情",
  "Paste KEY=value lines directly from a .env file. Quoted values, blank lines, comments, and export prefixes are supported.":
    "可直接从 .env 檔案粘贴 KEY=value 行。支持带引号的值、空行、注释和 export 前缀。",
  "Paste a GitHub repository link and choose GitHub authorization or a token for private access.":
    "粘贴GitHub 儲存庫連結，然后選擇GitHub授权或私有存取令牌。",
  Path: "路径",
  "Path must stay inside persistent storage. Switch to Live filesystem to work outside it.":
    "路径必须位于永久儲存内。切换到Live檔案系统以在其外部工作。",
  "Path prefix": "路径前缀",
  Pending: "待处理",
  "Pending first import": "等待首次导入",
  "Pending standby unavailable": "備用实例不可用",
  "Pending sync": "等待同步",
  "Platform node join": "平台節點加入",
  "Platform node key issued.": "平台節點金鑰已颁发。",
  "Point Fugue at a published Docker image. Fugue mirrors it into the internal registry before rollout.":
    "将Fugue指向已發布的Docker 映像。在發布之前，Fugue将其映像到內部註冊表中。",
  "Primary database": "主資料库",
  "Primary placement stays as-is until a later maintenance window, rebuild, node drain, or explicit rebalance.":
    "主實例部署位置会保持不变，直到后续维护窗口、重建、節點排空或明確重新均衡。",
  "Privacy-focused browsers sometimes need one extra first-party handoff before the destination session is available.":
    "以隐私为重点的浏览器有时需要额外一次第一方切换，目标会话才可用。",
  "Project deletion started.": "專案刪除已开始。",
  "Project deletion started. Remaining services are being removed.":
    "專案刪除已开始。剩余服務正在刪除。",
  "Project filters": "專案筛选器",
  "Project name is required.": "專案名称是必需的。",
  "Project name updated.": "專案名称已更新。",
  "Project route table": "專案路由表",
  "Project route table updated.": "專案路由表已更新。",
  "Project state": "專案狀態",
  "Project workbench": "專案工作台",
  "Projects collect services, routes, runtime placement, environment, and deployment controls.":
    "專案用于组织服務、路由、執行環境位置、环境變數和部署控制。",
  "Protection missing": "缺少保護",
  "Protection restored. New standby runtime: {target}.":
    "保護已恢复。新的備用執行環境： {target}。",
  "Public access": "公開存取",
  "Public image refs are mirrored into Fugue before rollout":
    "公开映像引用会在發布前同步到 Fugue",
  "Public or private with GitHub authorization or a stored token":
    "公开儲存庫，或通过 GitHub 授权 / 已儲存 Token 存取的私有儲存庫",
  "Queued rollout canceled. Force delete queued.":
    "已取消排隊中的發布，强制刪除已加入佇列。",
  "Queued transfer": "遷移已排隊",
  Raw: "原始",
  "Raw environment": "原始环境變數",
  "Rebuild queued from default branch.": "从預設分支排隊重建。",
  "Rebuild queued from {branch}.": "从{branch}排隊重建。",
  "Reconnecting to live logs…": "正在重新连接实时日志…",
  "Redeploy a known-good version, or delete stale images you no longer need.":
    "重新部署已知良好的版本，或刪除不再需要的陈旧映像。",
  "Redeploy is not available for this app.": "此應用暂不支持重新部署。",
  Refresh: "重新整理",
  "Refresh now": "立即重新整理",
  "Refreshing recent logs…": "正在重新整理最近日志…",
  "Remove mount": "移除挂载",
  "Remove {name}": "移除{name}",
  "Remove {name} from the server inventory only if this VPS is permanently gone. Fugue will refuse the delete if apps, services, or active operations still depend on it.":
    "仅当此VPS 永久消失时，才从伺服器清单中刪除{name}。如果應用、服務或活动操作仍然依赖于它，则Fugue将拒绝刪除。",
  "Repository-backed services auto sync; image-backed services can repull the saved image ref":
    "儲存庫服務会自动同步；映像服務可重新拉取已儲存的映像引用",
  "Request canceled.": "请求已取消。",
  "Request failed.": "请求失败。",
  "Resource usage": "資源使用量",
  "Restore protection": "恢复保護",
  "Retention pending": "保留待处理",
  "Retention {value}": "保留期 {value}",
  "Return route": "返回路径",
  "Review image": "檢查映像",
  "Review node capacity, status, and workload pressure.":
    "查看節點容量、狀態和工作负载压力。",
  "Review the current managed image and older saved versions for {appName}. Image storage is tracked separately from live service disk usage here, and stale versions can be redeployed or removed.":
    "查看{appName}的目前托管映像和较旧的已儲存版本。映像儲存在此处与線上服務磁盘使用情况分开跟踪，并且可以重新部署或刪除过时的版本。",
  "Review users, admin status, quotas, service usage, and account state.":
    "查看用户、管理员狀態、配额、服務使用情况和帳號狀態。",
  "Review workspace balance, usage envelope, storage, and capacity controls.":
    "查看工作區平衡、使用範圍、儲存和容量控制。",
  "Route availability response was malformed.": "路由可用性响应格式不正确。",
  "Route summary": "路由摘要",
  "Route table": "路由表",
  ...
  "Route updated. The new address is live immediately, and the old address has been released.":
    "路由已更新。新地址立即生效，旧地址已释放。",
  "Run authoritative DNS service on this machine.": "在此计算机上运行权威DNS服務。",
  "Run the public edge proxy on this machine.": "在此计算机上运行公開边缘代理。",
  "Run this on the target VPS": "在目标 VPS 上运行此命令",
  "Runtime logs are not ready": "執行環境日志尚未就绪",
  "Runtime logs are unavailable": "執行環境日志不可用",
  "Runtime nodes": "執行環境節點",
  "Runtime ref": "執行環境引用",
  "Save to switch the live route.": "儲存后切换線上路由。",
  Saved: "已儲存",
  "Saved history": "已儲存歷史记录",
  "Saved image deleted.": "已儲存映像已刪除。",
  "Saved image history updated.": "已儲存映像歷史已更新。",
  "Saved image was already missing.": "已儲存映像已不存在。",
  "Saved managed image": "已儲存托管映像",
  Schedulable: "可调度",
  "Search projects": "搜索專案",
  "Search projects...": "搜索專案…",
  "Select a request trace or enter a trace id.": "選擇请求跟踪或输入跟踪ID。",
  "Send sign-in link": "发送登入連結",
  "Server name": "伺服器名称",
  Servers: "伺服器",
  "Service panels": "服務面板",
  "Session handoff": "会话切换",
  "Set up the workspace and prepare {projectName}.": "設定工作區并準備{projectName}。",
  "Setting up": "正在設定",
  "Showing refreshed log snapshots…": "正在显示重新整理后的日志快照…",
  "Sign in first to open the console.": "请先登入再打开控制台。",
  "Sign in to continue with this image.": "登入以继续使用此映像。",
  "Sign in to continue with this repository.": "登入以继续使用此儲存庫。",
  "Sign-in was verified, but Fugue could not open your workspace session. Try again in a minute.":
    "登入已验证，但Fugue无法打开您的工作區会话。请稍后重试。",
  "Sign-in was verified, but the browser session handoff expired before the cookie was written. Start again.":
    "登入已验证，但浏览器会话切换在寫入Cookie之前已过期。请重新开始。",
  Sources: "来源",
  "Stable redirect / returnTo": "稳定重定向 / returnTo",
  "Standby update is queued. Fugue will move failover to {pendingTargetLabel} while {primaryRuntimeLabel} keeps serving writes.{suffix}":
    "備用更新已排隊。Fugue将故障转移到{pendingTargetLabel} ，而{primaryRuntimeLabel}继续服務寫入。{suffix}",
  "Start queued at 1 replica.": "已加入啟動佇列，副本数为 1。",
  "Start shared. Move cleanly.": "先使用共享环境，再平稳遷移。",
  "Start this paused app at 1 replica without rebuilding the image.":
    "在不重建映像的情况下，以 1 个副本啟動这个已暂停應用。",
  "Starting…": "正在啟動…",
  "Starts after first deploy": "首次部署后开始",
  "Starts after first deploy.": "首次部署后开始。",
  "Startup command already matches the current release.": "啟動命令已匹配目前版本。",
  "Startup command already uses the image default.": "啟動命令已使用映像預設值。",
  "Startup command cleared. Deploy queued.": "啟動命令已清除。部署已排入佇列。",
  "Startup command saved. Deploy queued.": "啟動命令已儲存。部署已排入佇列。",
  Storage: "儲存",
  "Stored for this workspace": "为此工作區儲存",
  "Stored size": "儲存大小",
  TTFB: "TTFB",
  "Template deploy": "模板部署",
  "That email link is invalid or expired. Request a fresh one.":
    "该電子郵件連結無效或已过期。请重新请求。",
  "The database stays on its primary runtime. The standby runtime only takes over if the primary disappears. After a failover, choose a new standby to restore protection.":
    "資料库停留在其主執行環境。備用執行環境仅在主執行環境消失时接管。故障转移后，選擇一个新的備用以恢复保護。",
  "The image version that currently represents this app.": "目前表示此應用的映像版本。",
  "This account has been deleted and can no longer sign in.":
    "此帳號已被刪除，无法再登入。",
  "This account is blocked. Contact an administrator.":
    "此帳號已被封禁。请联系管理员。",
  "This app is paused. Start it to reopen runtime logs without rebuilding, or use Redeploy for a fresh build.":
    "该應用已暂停。啟動它即可在不重建的情况下重新打开執行環境日志，或使用“重新部署”进行一次全新构建。",
  "This flow creates a platform-node key, not a tenant runtime key. The joined VPS stays platform-owned and can be promoted or constrained later.":
    "此流程建立平台節點金鑰，而不是租户執行環境金鑰。加入的VPS仍然是平台所有的，可以在以后进行推广或限制。",
  "This hostname is already in use.": "此主機名已被使用。",
  "This hostname is already serving this app.": "此主機名已经为此應用提供服務。",
  "This hostname is attached, but setup hit a snag. Fugue will keep retrying in the background.":
    "已附加此主機名，但安装遇到了问题。Fugue将继续在后台重试。",
  "This hostname is attached. Fugue is finishing setup now.":
    "已附加此主機名。Fugue现在正在完成設定。",
  "This hostname is invalid.": "此主機名無效。",
  "This platform hostname is reserved. Platform admins can attach the root domain directly, but regular workspaces cannot claim it.":
    "此平台主機名已保留。平台管理员可以直接附加根域，但常规工作區无法声明。",
  "This repository does not expose template metadata in": "此儲存庫不公开模板元資料",
  "This rollout has not reached a live runtime yet. Switch to Build to follow progress.":
    "本次發布尚未进入線上執行環境。切换到“构建”查看进度。",
  "This route is already current.": "此路由已处于目前狀態。",
  "This route is already in use.": "此路由已被使用。",
  "This route is invalid.": "此路由無效",
  "This server is offline and no longer reporting heartbeats.":
    "此伺服器处于離線狀態，不再报告心跳。",
  "This server is offline. {details}": "此伺服器处于離線狀態。{details}",
  "This sign-in handoff is missing or expired. Start again from the sign-in page.":
    "此登入切换缺失或已过期。请从登入页重新开始。",
  Time: "时间",
  "Total image storage": "总映像儲存",
  Trace: "追踪",
  "Trace data is unavailable.": "跟踪資料不可用。",
  "Trace id": "追踪 ID",
  "Transfer in progress": "遷移进行中",
  "Type {name} exactly to enable deletion.": "准确输入 {name} 以启用刪除。",
  "Unable to copy {label}.": "无法複製{label}。",
  "Unable to load GitHub image update settings right now.":
    "目前无法載入GitHub映像更新設定。",
  "Unable to load saved images right now. Try refreshing this panel.":
    "目前无法載入儲存的映像。请尝试重新整理此面板。",
  Unknown: "未知",
  "Unknown owner": "未知归属者",
  Unverified: "未验证",
  "Update repository": "更新儲存庫",
  Updates: "更新",
  Uploaded: "上传成功",
  "Use / for the root route, or /api for a path route.":
    "根路由使用/，路径路由使用/api。",
  "Use 1 or more.": "使用1个或多个。",
  "Use the directory path inside the service.": "使用服務内的目錄路径。",
  "Use the exact file path inside the service.": "使用服務内的确切檔案路径。",
  "Used only when Fugue needs to create the file for the first time. Existing file contents stay in place on later deploys.":
    "仅在Fugue需要首次建立檔案时使用。现有檔案内容在稍后部署时保持不变。",
  "User directory": "用户目錄",
  Users: "用户",
  "Users unavailable": "用户暂不可用",
  Variables: "變數",
  ...
  "Wait for project deletion to finish before renaming it.":
    "在重命名專案之前，等待專案刪除完成。",
  "Waiting for first start": "等待首次啟動",
  "Waiting for import": "等待导入",
  "We are converting the provider callback into a first-party session before opening the destination route.":
    "我们正在把提供方回调转换成第一方会话，然后再打开目标路由。",
  "What happens next": "接下来会发生什么",
  "When you issue a key, Fugue returns a one-time join command here so the next VPS can attach as a platform node immediately.":
    "当您发出金鑰时，Fugue在此处返回一次性加入命令，以便下一个VPS可以立即作为平台節點连接。",
  Work: "工作",
  "Workspace API keys control Fugue API access and automation scopes.":
    "工作區 API 金鑰用于控制 Fugue API 存取和自动化權限範圍。",
  "Workspace missing": "缺少工作區",
  "Keep secrets out of deploy links.": "不要在部署連結中包含機密。",
  "Image storage": "映像儲存",
  "Live service runtime only": "僅限線上服務執行階段",
  "No environment variables will be applied on the first deploy.":
    "首次部署不會套用任何環境變數。",
  "No environment variables will be set on the first deploy.":
    "首次部署不會設定任何環境變數。",
  "Profile, account, and workspace preferences": "個人資料、帳號與工作區偏好",
  "Projects, services, routes, and deploy controls": "專案、服務、路由與部署控制",
  "Region unavailable": "區域不可用",
  "Server health, heartbeat, and workloads": "伺服器健康、心跳與工作負載",
  "Stored project images": "已儲存專案映像",
  "edge-singapore-01": "edge-singapore-01",
  "github_pat_...": "github_pat_...",
  loading: "正在載入",
  main: "main",
  ...
  "you@company.com": "you@company.com",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically.":
    "Fugue 準備 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。",
  "{appName} stays live on {liveRuntimeLabel} while Fugue prepares {selectedTargetLabel}, then cuts over automatically. {transferPreparationNote}":
    "Fugue 準備 {selectedTargetLabel} 时，{appName} 会继续在 {liveRuntimeLabel} 上运行，随后自动切换。{transferPreparationNote}",
  "{email} will lose admin access and stay in the workspace as a regular user.":
    "{email}将失去管理员存取權限，并作为普通用户留在工作區中。",
  "{label} copied.": "{label}已複製。",
  "{name} and its {count} services will be queued for deletion from this workspace. {preview}":
    "{name}及其{count}服務将排隊等待从此工作區中刪除。{preview}",
  "{name} is no longer reporting heartbeats.": "{name}不再报告心跳。",
  "{provider} sign-in could not be completed. Check the callback URL and provider credentials, then try again.":
    "{provider}登入无法完成。请檢查回调URL和提供商凭据，然后重试。",
  "{provider} sign-in details": "{provider}登入詳情",
  "{provider} sign-in was cancelled before authorization finished.":
    "{provider}登入在授权完成前被取消。",
  "{title} will be removed from {appName}'s saved image history.":
    "{title}将从{appName}儲存的映像歷史记录中刪除。",
  "{value} {unit}": "{value} {unit}",
} satisfies MessageCatalog;

const enPublicMessages = {
  "Deploy on managed runtime, then move to your own server":
    "Deploy on managed runtime, then move to your own server",
  "Import from GitHub, a Docker image, or a local upload, then operate routes, environment, logs, files, images, and runtime migration in one console.":
    "Import from GitHub, a Docker image, or a local upload, then operate routes, environment, logs, files, images, and runtime migration in one console.",
  "managed first / owned runtime later": "managed first / owned runtime later",
  ...
  "The product panel keeps the first workflow visible.":
    "The product panel keeps the first workflow visible.",
  Source: "Source",
  Runtime: "Runtime",
  shared: "shared",
  ...
  "Open the operational surface first.": "Open the operational surface first.",
  "The app shell, docs shell, auth panels, deploy wizard, and admin pages share the same component foundation.":
    "The app shell, docs shell, auth panels, deploy wizard, and admin pages share the same component foundation.",
  "Open console": "Open console",
  "Fugue documentation": "Fugue documentation",
  ...
  "GitHub repository, Docker image, and local upload all create the same project/service graph.":
    "GitHub repository, Docker image, and local upload all create the same project/service graph.",
  "fugue.yaml topology": "fugue.yaml topology",
  ...
  "Billing and continuity boundaries": "Billing and continuity boundaries",
  ...
  "Continuing with GitHub…": "Continuing with GitHub…",
  "Continuing with Google…": "Continuing with Google…",
  "Creating account…": "Creating account…",
  "Email link": "Email link",
  "Email link mode": "Email link mode",
  "A verification link creates or resumes the session without exposing credentials.":
    "A verification link creates or resumes the session without exposing credentials.",
  "Enter a valid email address.": "Enter a valid email address.",
  "Password must be at least 10 characters.":
    "Password must be at least 10 characters.",
  "Use an existing password for this account.":
    "Use an existing password for this account.",
  ...
  "Try again in {seconds} seconds": "Try again in {seconds} seconds",
  "Verification link sent to {email}.": "Verification link sent to {email}.",
  ...
  "Authentication request payload is too large.":
    "Authentication request payload is too large.",
  "Display name is too long.": "Display name is too long.",
...
const zhCNPublicMessages = {
  "Deploy on managed runtime, then move to your own server":
    "先部署到托管运行时，再迁移到自己的服务器",
  "Import from GitHub, a Docker image, or a local upload, then operate routes, environment, logs, files, images, and runtime migration in one console.":
    "从 GitHub、Docker 镜像或本地上传导入应用，并在一个控制台中管理路由、环境变量、日志、文件、镜像和运行时迁移。",
  "managed first / owned runtime later": "先用托管运行时 / 再迁移到自有运行时",
  "Ship on Fugue, then move the same app to your own server.":
    "先在 Fugue 上发布，再把同一个应用迁移到自己的服务器。",
  "Import from GitHub, a Docker image, or a local upload. Fugue starts it on shared managed runtime and keeps the route, env, logs, files, images, and migration surface in one console.":
    "从 GitHub、Docker 镜像或本地上传导入。Fugue 会先在共享托管运行时启动应用，并把路由、环境变量、日志、文件、镜像和迁移入口集中在一个控制台中。",
  "Get started": "开始使用",
  "Read docs": "阅读文档",
  "Deployment graph": "部署关系",
  "The product panel keeps the first workflow visible.":
    "产品面板会让首个工作流程始终清晰可见。",
  Source: "来源",
  Runtime: "运行时",
  ...
  "GitHub repository": "GitHub 仓库",
  "Connect a repository, choose a branch, authorize private access, and create the first service.":
    "连接仓库、选择分支、授权私有访问并创建第一个服务。",
  source: "源码",
  "Docker image": "Docker 镜像",
  "Point Fugue at an existing image and keep runtime, env, route, and logs in the same console.":
    "让 Fugue 使用现有镜像，并在同一个控制台中管理运行时、环境变量、路由和日志。",
  image: "镜像",
  "Local upload": "本地上传",
  "Upload a build artifact before auth and resume the pending deploy after sign-in.":
    "可以在认证前上传构建产物，并在登录后继续待处理的部署。",
  upload: "上传",
  "Project workbench": "项目工作台",
  "Routes, env, logs, files, images, observability, and settings live with the service.":
    "路由、环境变量、日志、文件、镜像、可观测性和设置都随服务集中管理。",
  "Runtime servers": "运行时服务器",
  "Add your own machines, inspect pressure, and move workloads without changing the product model.":
    "添加自己的机器、查看资源压力，并在不改变产品模型的情况下迁移工作负载。",
  "Capacity and billing": "容量与计费",
  "Prepaid balance, managed envelope, storage, and events are visible from one page.":
    "预付余额、托管容量、存储和事件可以在一个页面中查看。",
  "Console ready": "控制台已就绪",
  "Open the operational surface first.": "先打开实际操作界面。",
  "The app shell, docs shell, auth panels, deploy wizard, and admin pages share the same component foundation.":
    "应用外壳、文档外壳、认证面板、部署向导和管理页面共用同一套组件基础。",
  "Open console": "打开控制台",
  "Fugue documentation": "Fugue 文档",
  "Operate Fugue from source import through runtime inspection, migration, and diagnosis.":
    "从源码导入到运行时检查、迁移和诊断，完整操作 Fugue。",
  "Operate Fugue from source import to runtime diagnosis.":
    "从源码导入到运行时诊断，完整操作 Fugue。",
  "CLI quick start, import modes, topology rules, billing boundaries, migration, failover, inspection, and diagnosis.":
    "涵盖 CLI 快速入门、导入方式、拓扑规则、计费边界、迁移、故障转移、检查和诊断。",
  "Start deploy": "开始部署",
  "On this page": "本页内容",
  "Docs navigation": "文档目录",
  "CLI quick start": "CLI 快速入门",
  "Install Fugue, authenticate, and import a service from a repository, image, or local upload.":
    "安装 Fugue、完成认证，并从仓库、镜像或本地上传导入服务。",
  "Import modes": "导入方式",
  "GitHub repository, Docker image, and local upload all create the same project/service graph.":
    "GitHub 仓库、Docker 镜像和本地上传都会创建相同的项目与服务关系。",
  "fugue.yaml topology": "fugue.yaml 拓扑",
  "Topology files describe services, routes, backing services, runtime targets, and persistent mounts.":
    "拓扑文件描述服务、路由、后端服务、运行时目标和持久化挂载。",
  "Inspect and diagnose": "检查与诊断",
  "Use inspect and diagnose to compare configured intent against runtime state.":
    "使用 inspect 和 diagnose 对比配置意图与运行时状态。",
  "Copy command": "复制命令",
  "Copied to clipboard.": "已复制到剪贴板。",
  "Could not copy to clipboard.": "无法复制到剪贴板。",
  "Billing and continuity boundaries": "计费与连续性边界",
  "Stateless migrate moves an app service between runtime targets. Managed failover protects backing services that support primary/standby behavior. Both states are visible from the project workbench.":
    "无状态迁移会在运行时目标之间移动应用服务。托管故障转移会保护支持主备模式的后端服务。两类状态都可在项目工作台中查看。",
  "Sign in to Fugue": "登录 Fugue",
  "Provider auth, password auth, and email link auth all preserve the requested return destination.":
    "第三方认证、密码认证和邮箱链接认证都会保留请求的返回位置。",
  "Create your Fugue account": "创建 Fugue 账号",
  "Create the account first, then continue the saved project or template deployment intent.":
    "先创建账号，再继续已保存的项目或模板部署操作。",
  "Authentication failed": "认证失败",
  "Authentication method": "认证方式",
  "Authentication request failed.": "认证请求失败。",
  "Check your email to finish creating the account.": "请检查邮箱以完成账号创建。",
  "Check your email": "请检查邮箱",
  "Confirm password": "确认密码",
  "Continue with GitHub": "使用 GitHub 继续",
  "Continue with Google": "使用 Google 继续",
  "Continuing with GitHub…": "正在前往 GitHub…",
  "Continuing with Google…": "正在前往 Google…",
  "Creating account…": "正在创建账号…",
  "Email link": "邮箱链接",
  "Email link mode": "邮箱链接模式",
  "A verification link creates or resumes the session without exposing credentials.":
    "验证链接可在不暴露凭据的情况下创建或恢复会话。",
  "Enter a valid email address.": "请输入有效的邮箱地址。",
  "Password must be at least 10 characters.": "密码至少需要 10 个字符。",
  "Use an existing password for this account.": "请输入此账号的现有密码。",
  "Use at least 10 characters. Email verification is still required.":
    "请至少使用 10 个字符；仍需完成邮箱验证。",
  "Send link": "发送链接",
  "Sending link…": "正在发送链接…",
  "Signing in…": "正在登录…",
  ...
  "Passwords must stay under 256 characters.": "密码不得超过 256 个字符。",
  "This account has been deleted.": "此账号已删除。",
  "This account is blocked.": "此账号已被封禁。",
  "Use at least 10 characters.": "请至少使用 10 个字符。",
  "Verification email could not be sent. Try again.": "验证邮件发送失败，请重试。",
  "Page not found": "页面不存在",
  "The requested page does not exist or is no longer available.":
    "请求的页面不存在或已不可用。",
  "Finalize session": "完成会话",
  "Convert the OAuth or email-link handoff into a Fugue browser session.":
    "将 OAuth 或邮箱链接交接转换为 Fugue 浏览器会话。",
  "Import a repository, image, or local upload.": "导入仓库、镜像或本地上传。",
  ...
  "Fugue validates the provider handoff token, creates a first-party session, and redirects to the requested destination.":
    "Fugue 会验证提供方交接令牌、创建第一方会话，并跳转到请求的目标页面。",
  "Start a fresh sign-in flow to receive a new browser session token.":
    "请重新开始登录流程，以获取新的浏览器会话令牌。",
  "Handoff token missing": "缺少交接令牌",
  "Missing token": "缺少令牌",
  "Restart sign in": "重新登录",
  "Your session expired. Sign in again.": "会话已过期，请重新登录。",
  "Validating…": "正在验证…",
  "Display name must be 80 characters or fewer.": "显示名称不得超过 80 个字符。",
  "Choose a source archive or source file first.": "请先选择源码归档或源码文件。",
  "Variable {index} key": "第 {index} 个变量的名称",
  "Variable {index} value": "第 {index} 个变量的值",
  "Workspace API keys and node enrollment keys with scopes, one-time secrets, join commands, rotation, and revoke actions.":
    "管理工作区 API 密钥与节点接入密钥，包括权限范围、一次性密钥、接入命令、轮换和吊销操作。",
  "Prepaid balance, managed capacity envelope, image storage, price book, checkout status, and billing events.":
    "查看预付余额、托管容量上限、镜像存储、价格表、结账状态和计费事件。",
  ...
  "Control plane status, runtime nodes, platform join keys, runtime node policy, build allowance, workload placement, and reconcile state.":
    "管理控制平面状态、运行时节点、平台接入密钥、节点策略、构建权限、工作负载放置和协调状态。",
  "Admin users": "用户管理",
  "User directory, account status, admin state, providers, verification, balance, billing limit, service usage, block, unblock, and delete.":
    "管理用户目录、账号状态、管理员状态、提供方、验证、余额、计费限额、服务使用、封禁、解封和删除。",
  "Display name, account email, active session, connected providers, email links, password, and at-least-one-method protection.":
    "管理显示名称、账号邮箱、活动会话、已连接提供方、邮箱链接、密码和至少一种登录方式保护。",
  "Routes, environment, logs, files, images, observability, settings, backing services, failover, and migration in one workspace.":
    "在一个工作区中管理路由、环境变量、日志、文件、镜像、可观测性、设置、后端服务、故障转移和迁移。",
  "Hosted DNS zones, records, and delegation health": "托管 DNS 区域、记录与委派健康",
  "Zones / Records / Preflight": "区域 / 记录 / 预检",
} satisfies MessageCatalog;

const zhTWPublicMessages = {
  "Deploy on managed runtime, then move to your own server":
    "先部署到代管執行環境，再移轉到自己的伺服器",
  "Import from GitHub, a Docker image, or a local upload, then operate routes, environment, logs, files, images, and runtime migration in one console.":
    "從 GitHub、Docker 映像或本機上傳匯入應用程式，並在同一個主控台管理路由、環境變數、日誌、檔案、映像與執行環境移轉。",
  "managed first / owned runtime later": "先用代管執行環境 / 再移轉到自有執行環境",
  "Ship on Fugue, then move the same app to your own server.":
    "先在 Fugue 上發布，再把同一個應用程式移轉到自己的伺服器。",
  "Import from GitHub, a Docker image, or a local upload. Fugue starts it on shared managed runtime and keeps the route, env, logs, files, images, and migration surface in one console.":
    "從 GitHub、Docker 映像或本機上傳匯入。Fugue 會先在共用代管執行環境啟動應用程式，並把路由、環境變數、日誌、檔案、映像與移轉入口集中在同一個主控台。",
  "Get started": "開始使用",
  "Read docs": "閱讀文件",
  "Deployment graph": "部署關係",
  "The product panel keeps the first workflow visible.":
    "產品面板會讓第一個工作流程保持清楚可見。",
  Source: "來源",
  Runtime: "執行環境",
  ...
  "GitHub repository": "GitHub 儲存庫",
  "Connect a repository, choose a branch, authorize private access, and create the first service.":
    "連接儲存庫、選擇分支、授權私有存取並建立第一個服務。",
  source: "原始碼",
  "Docker image": "Docker 映像",
  "Point Fugue at an existing image and keep runtime, env, route, and logs in the same console.":
    "讓 Fugue 使用現有映像，並在同一個主控台管理執行環境、環境變數、路由與日誌。",
  image: "映像",
  "Local upload": "本機上傳",
  "Upload a build artifact before auth and resume the pending deploy after sign-in.":
    "可在驗證前上傳建置產物，並在登入後繼續待處理的部署。",
  upload: "上傳",
  "Project workbench": "專案工作台",
  "Routes, env, logs, files, images, observability, and settings live with the service.":
    "路由、環境變數、日誌、檔案、映像、可觀測性與設定都隨服務集中管理。",
  "Runtime servers": "執行環境伺服器",
  "Add your own machines, inspect pressure, and move workloads without changing the product model.":
    "新增自己的機器、查看資源壓力，並在不變更產品模型的情況下移轉工作負載。",
  "Capacity and billing": "容量與計費",
  "Prepaid balance, managed envelope, storage, and events are visible from one page.":
    "預付餘額、代管容量、儲存空間與事件都能在同一頁查看。",
  "Console ready": "主控台已就緒",
  "Open the operational surface first.": "先開啟實際操作介面。",
  "The app shell, docs shell, auth panels, deploy wizard, and admin pages share the same component foundation.":
    "應用程式外殼、文件外殼、驗證面板、部署精靈與管理頁面共用同一套元件基礎。",
  "Open console": "開啟主控台",
  "Fugue documentation": "Fugue 文件",
  "Operate Fugue from source import through runtime inspection, migration, and diagnosis.":
    "從原始碼匯入到執行環境檢查、移轉與診斷，完整操作 Fugue。",
  "Operate Fugue from source import to runtime diagnosis.":
    "從原始碼匯入到執行環境診斷，完整操作 Fugue。",
  "CLI quick start, import modes, topology rules, billing boundaries, migration, failover, inspection, and diagnosis.":
    "涵蓋 CLI 快速入門、匯入方式、拓撲規則、計費邊界、移轉、容錯移轉、檢查與診斷。",
  "Start deploy": "開始部署",
  "On this page": "本頁內容",
  "Docs navigation": "文件目錄",
  "CLI quick start": "CLI 快速入門",
  "Install Fugue, authenticate, and import a service from a repository, image, or local upload.":
    "安裝 Fugue、完成驗證，並從儲存庫、映像或本機上傳匯入服務。",
  "Import modes": "匯入方式",
  "GitHub repository, Docker image, and local upload all create the same project/service graph.":
    "GitHub 儲存庫、Docker 映像與本機上傳都會建立相同的專案與服務關係。",
  "fugue.yaml topology": "fugue.yaml 拓撲",
  "Topology files describe services, routes, backing services, runtime targets, and persistent mounts.":
    "拓撲檔案描述服務、路由、後端服務、執行環境目標與持久化掛載。",
  "Inspect and diagnose": "檢查與診斷",
  "Use inspect and diagnose to compare configured intent against runtime state.":
    "使用 inspect 與 diagnose 比較設定意圖和執行環境狀態。",
  "Copy command": "複製指令",
  "Copied to clipboard.": "已複製到剪貼簿。",
  "Could not copy to clipboard.": "無法複製到剪貼簿。",
  "Billing and continuity boundaries": "計費與連續性邊界",
  "Stateless migrate moves an app service between runtime targets. Managed failover protects backing services that support primary/standby behavior. Both states are visible from the project workbench.":
    "無狀態移轉會在執行環境目標之間移動應用服務。代管容錯移轉會保護支援主備模式的後端服務。兩類狀態都能在專案工作台查看。",
  "Sign in to Fugue": "登入 Fugue",
  "Provider auth, password auth, and email link auth all preserve the requested return destination.":
    "第三方驗證、密碼驗證與電子郵件連結驗證都會保留要求的返回位置。",
  "Create your Fugue account": "建立 Fugue 帳號",
  "Create the account first, then continue the saved project or template deployment intent.":
    "先建立帳號，再繼續已儲存的專案或範本部署操作。",
  "Authentication failed": "驗證失敗",
  "Authentication method": "驗證方式",
  "Authentication request failed.": "驗證要求失敗。",
  "Check your email to finish creating the account.": "請檢查電子郵件以完成帳號建立。",
  "Check your email": "請檢查電子郵件",
  "Confirm password": "確認密碼",
  ...
  "Email link": "電子郵件連結",
  "Email link mode": "電子郵件連結模式",
  "A verification link creates or resumes the session without exposing credentials.":
    "驗證連結可在不揭露憑證的情況下建立或恢復工作階段。",
  "Enter a valid email address.": "請輸入有效的電子郵件地址。",
  "Password must be at least 10 characters.": "密碼至少需要 10 個字元。",
  "Use an existing password for this account.": "請輸入此帳號的現有密碼。",
  "Use at least 10 characters. Email verification is still required.":
    "請至少使用 10 個字元；仍需完成電子郵件驗證。",
  "Send link": "傳送連結",
  "Sending link…": "正在傳送連結…",
  "Signing in…": "正在登入…",
  "Too many attempts. Wait a moment and try again.": "嘗試次數過多，請稍後再試。",
  "Too many attempts. Try again in {seconds} seconds.":
    "嘗試次數過多，請在 {seconds} 秒後再試。",
  "Try again later": "請稍後再試",
  "Try again in {seconds} seconds": "請在 {seconds} 秒後再試",
  "Verification link sent to {email}.": "驗證連結已傳送至 {email}。",
  "Account registration is temporarily unavailable.": "帳號註冊暫時無法使用。",
  "Authentication protection is temporarily unavailable. Try again.":
    "驗證保護暫時無法使用，請再試一次。",
  "Authentication request payload is too large.": "驗證要求內容過大。",
  "Display name is too long.": "顯示名稱過長。",
  "Email or password is incorrect.": "電子郵件或密碼不正確。",
  "Enter a password.": "請輸入密碼。",
  "Fugue could not open the workspace session. Try again.":
    "Fugue 無法開啟工作區工作階段，請再試一次。",
  "Invalid request payload.": "要求內容無效。",
  "Passwords must stay under 256 characters.": "密碼不得超過 256 個字元。",
  "This account has been deleted.": "此帳號已刪除。",
  "This account is blocked.": "此帳號已封鎖。",
  "Use at least 10 characters.": "請至少使用 10 個字元。",
  "Verification email could not be sent. Try again.":
    "驗證電子郵件無法傳送，請再試一次。",
  "Page not found": "找不到頁面",
  "The requested page does not exist or is no longer available.":
    "要求的頁面不存在或已無法使用。",
  "Finalize session": "完成工作階段",
  "Convert the OAuth or email-link handoff into a Fugue browser session.":
    "將 OAuth 或電子郵件連結交接轉換為 Fugue 瀏覽器工作階段。",
  "Import a repository, image, or local upload.": "匯入儲存庫、映像或本機上傳。",
  "Configure project name, app name, branch, port, runtime target, environment variables, network mode, and persistent storage intent.":
    "設定專案名稱、應用程式名稱、分支、連接埠、執行環境目標、環境變數、網路模式與持久儲存意圖。",
  "Template metadata, variables, default runtime, and fugue.yaml topology are reviewed before project creation.":
    "建立專案前會檢查範本中繼資料、變數、預設執行環境與 fugue.yaml 拓撲。",
  "Canonical template checked": "已檢查標準範本",
  "The template slug is resolved before rendering. Missing metadata falls back to the standard repository import path.":
    "呈現前會解析範本識別碼；缺少中繼資料時會回到標準儲存庫匯入流程。",
  Configure: "設定",
  "Console navigation": "主控台導覽",
  "Create project steps": "建立專案步驟",
  "Fugue home": "Fugue 首頁",
  "Public navigation": "公開導覽",
  "Skip to main content": "跳至主要內容",
  Breadcrumb: "麵包屑導覽",
  Confirm: "確認",
  "Something went wrong": "發生問題",
  "The page failed to render. Retry keeps the current route and asks React to recover.":
    "頁面呈現失敗。重試會保留目前路徑，並嘗試恢復頁面。",
  "Console surface failed": "主控台頁面載入失敗",
  "The protected workspace view could not render. Retry without leaving the console.":
    "受保護的工作區檢視無法呈現。可留在主控台中重試。",
  "Retry console": "重試主控台",
  "Loading console data…": "正在載入主控台資料…",
  "Unable to update the interface language.": "無法更新介面語言。",
  Previous: "上一頁",
  "Showing {visible} of {total}": "顯示 {visible} / {total}",
  "Table pagination": "表格分頁",
  "Preparing the workspace.": "正在準備工作區。",
  "Loading Fugue…": "正在載入 Fugue…",
  "Loading console…": "正在載入主控台…",
  "Preparing the secure sign-in flow.": "正在準備安全登入流程。",
  "Loading authentication…": "正在載入驗證流程…",
  "Preparing the project configuration.": "正在準備專案設定。",
  "Loading deploy wizard…": "正在載入部署精靈…",
  "Console page not found": "找不到主控台頁面",
  "The requested workspace page does not exist or is no longer available.":
    "要求的工作區頁面不存在或已無法使用。",
  "Return to projects": "返回專案列表",
  "Complete session": "完成工作階段",
  "Fugue validates the provider handoff token, creates a first-party session, and redirects to the requested destination.":
    "Fugue 會驗證提供方交接權杖、建立第一方工作階段，並重新導向至要求的目標頁面。",
  "Start a fresh sign-in flow to receive a new browser session token.":
    "請重新開始登入流程，以取得新的瀏覽器工作階段權杖。",
  "Handoff token missing": "缺少交接權杖",
  "Missing token": "缺少權杖",
  "Restart sign in": "重新登入",
  "Your session expired. Sign in again.": "工作階段已過期，請重新登入。",
  "Validating…": "正在驗證…",
  "Display name must be 80 characters or fewer.": "顯示名稱不得超過 80 個字元。",
  "Choose a source archive or source file first.": "請先選擇原始碼封存檔或原始碼檔案。",
  "Variable {index} key": "第 {index} 個變數的名稱",
  "Variable {index} value": "第 {index} 個變數的值",
  "Workspace API keys and node enrollment keys with scopes, one-time secrets, join commands, rotation, and revoke actions.":
    "管理工作區 API 金鑰與節點註冊金鑰，包括權限範圍、一次性密鑰、加入指令、輪替與撤銷操作。",
  "Prepaid balance, managed capacity envelope, image storage, price book, checkout status, and billing events.":
    "查看預付餘額、代管容量上限、映像儲存、價格表、結帳狀態與計費事件。",
  "Runtime servers, heartbeat, roles, pressure signals, capacity, workloads, runtime access, sharing, pool state, and offline cleanup.":
    "管理執行環境伺服器、心跳、角色、壓力訊號、容量、工作負載、存取、共用、資源池狀態與離線清理。",
  "Hosted DNS": "代管 DNS",
  "Tenant DNS zones, records, delegation preflight, and Fugue-managed app records.":
    "管理租戶 DNS 區域、記錄、委派預檢與 Fugue 代管的應用程式記錄。",
  "Admin apps": "應用程式管理",
  "Cluster-wide applications, owners, resource usage, routes, phase, runtime, source, tech stack, rebuild, and delete.":
    "管理叢集範圍的應用程式、擁有者、資源使用、路由、階段、執行環境、來源、技術堆疊、重建與刪除。",
  "Admin cluster": "叢集管理",
  "Control plane status, runtime nodes, platform join keys, runtime node policy, build allowance, workload placement, and reconcile state.":
    "管理控制平面狀態、執行環境節點、平台加入金鑰、節點政策、建置權限、工作負載配置與協調狀態。",
  "Admin users": "使用者管理",
  "User directory, account status, admin state, providers, verification, balance, billing limit, service usage, block, unblock, and delete.":
    "管理使用者目錄、帳號狀態、管理員狀態、提供方、驗證、餘額、計費上限、服務使用、封鎖、解除封鎖與刪除。",
  "Display name, account email, active session, connected providers, email links, password, and at-least-one-method protection.":
    "管理顯示名稱、帳號電子郵件、作用中工作階段、已連接提供方、電子郵件連結、密碼與至少一種登入方式保護。",
  "Routes, environment, logs, files, images, observability, settings, backing services, failover, and migration in one workspace.":
    "在一個工作區中管理路由、環境變數、日誌、檔案、映像、可觀測性、設定、後端服務、容錯移轉與移轉。",
  "{label} / {primary} / {secondary}": "{label} / {primary} / {secondary}",
  "{label} / {primary}": "{label} / {primary}",
  "Hosted DNS zones, records, and delegation health": "代管 DNS 區域、記錄與委派健康",
  "Zones / Records / Preflight": "區域 / 記錄 / 預檢",
} satisfies MessageCatalog;

const zhCNConsoleStateMessages = {
  "A database continuity operation is currently in progress.":
    "数据库连续性操作正在进行中。",
  "Access keys unavailable": "访问密钥暂不可用",
  "Add a record after the zone is delegated to Fugue nameservers.":
    "将区域委派给 Fugue 名称服务器后即可添加记录。",
  "Add a zone to start serving DNS from Fugue nameservers.":
    "添加区域后即可开始通过 Fugue 名称服务器提供 DNS 服务。",
  "Admin operation failed": "管理员操作失败",
  "Apex CNAME uses flattening.": "根域 CNAME 使用扁平化解析。",
  "Applications unavailable": "应用暂不可用",
  "Billing action failed": "计费操作失败",
  "Billing snapshot refreshed with partial live data":
    "计费快照已刷新，但仅包含部分实时数据",
  "Billing sync error": "计费同步错误",
  "Clear search or adjust the lifecycle filter.": "清除搜索或调整生命周期筛选条件。",
  "Clear search or change the phase filter.": "清除搜索或更改阶段筛选条件。",
  "Clear search or change the user filter.": "清除搜索或更改用户筛选条件。",
  "Clear the node search.": "清除节点搜索。",
  "Clear the search query or attach a new runtime node.":
    "清除搜索条件，或接入新的运行时节点。",
  "Cluster operation failed": "集群操作失败",
  "Cluster unavailable": "集群暂不可用",
  "Control plane status unavailable": "控制平面状态暂不可用",
  "Could not save password.": "无法保存密码。",
  "Could not update sign-in methods.": "无法更新登录方式。",
  "Create a node key, copy the join command, and run it on a VPS.":
    "创建节点密钥、复制加入命令，然后在 VPS 上运行。",
  "Create a project from a repository, image, or upload.":
    "从仓库、镜像或本地上传创建项目。",
  "Create or open a Fugue workspace before changing tenant billing.":
    "更改租户计费前，请先创建或打开 Fugue 工作区。",
  "Create or open a Fugue workspace before managing API keys and node enrollment keys.":
    "管理 API 密钥和节点注册密钥前，请先创建或打开 Fugue 工作区。",
  "Create or open a Fugue workspace before managing hosted DNS.":
    "管理托管 DNS 前，请先创建或打开 Fugue 工作区。",
  "Create or open a Fugue workspace before viewing runtime servers.":
    "查看运行时服务器前，请先创建或打开 Fugue 工作区。",
  "Current image": "当前镜像",
  "Current saved cap": "当前已保存上限",
  "Custom domains are unavailable.": "自定义域名暂不可用。",
  "Deploy failed": "部署失败",
  "Duplicate key": "键名重复",
  "Effective policy": "生效策略",
  "Enable email link or connect an OAuth provider before leaving this page.":
    "离开此页面前，请启用邮箱链接或连接 OAuth 提供方。",
  "Environment keys must be unique before save.": "保存前，环境变量键名必须唯一。",
  "Environment unavailable": "环境变量暂不可用",
  "Filesystem unavailable": "文件系统暂不可用",
  "Fugue could not load hosted DNS right now.": "Fugue 当前无法加载托管 DNS。",
  "Fugue did not return a selectable runtime target. Leaving this blank lets the control plane choose the default placement.":
    "Fugue 未返回可选的运行时目标。留空后，控制平面将选择默认位置。",
  "Fugue did not return filesystem entries for this app.":
    "Fugue 未返回此应用的文件系统条目。",
  "Fugue did not return log lines for this app and mode.":
    "Fugue 未返回此应用和当前模式的日志行。",
  ...
  "Fugue is not reporting stale runtime server records for this workspace.":
    "Fugue 未报告此工作区中过期的运行时服务器记录。",
  "Fugue observability returned no metric samples for this window.":
    "Fugue 可观测性在此时间窗口内未返回指标样本。",
  "Fugue observability returned no request summaries for this window.":
    "Fugue 可观测性在此时间窗口内未返回请求摘要。",
  "Fugue returned an empty cluster application inventory.":
    "Fugue 返回了空的集群应用清单。",
  "Fugue returned an empty cluster node inventory.": "Fugue 返回了空的集群节点清单。",
  "Fugue returned an empty environment for this app.":
    "Fugue 返回了此应用的空环境变量列表。",
  "Fugue returned an empty user directory.": "Fugue 返回了空的用户目录。",
  "Fugue returned no tenant billing events for this workspace.":
    "Fugue 未返回此工作区的租户计费事件。",
  "Fugue will publish A/AAAA answers at the apex instead of an invalid apex CNAME RR.":
    "Fugue 将在根域发布 A/AAAA 应答，而不是无效的根域 CNAME 资源记录。",
  "Fugue will still preserve system protected records and backend ownership checks.":
    "Fugue 仍会保留受系统保护的记录和后端所有权检查。",
  "Fugue will restart this app without rebuilding its image.":
    "Fugue 将重启此应用，而不重新构建镜像。",
  "Fugue accepted the restart and refreshed the project status.":
    "Fugue 已接受重启请求并刷新了项目状态。",
  "Full creation flow": "完整创建流程",
  "Hosted DNS loaded with a warning.": "托管 DNS 已加载，但存在警告。",
  "If the registrar has DNSSEC DS records enabled, remove them until Fugue DNSSEC is configured.":
    "如果注册商已启用 DNSSEC DS 记录，请在 Fugue DNSSEC 配置完成前将其移除。",
  "Images unavailable": "镜像暂不可用",
  "Internal service URL is not reported for this app.": "此应用尚未报告内部服务 URL。",
  "Inventory partially loaded": "清单仅部分加载",
  "Logs unavailable": "日志暂不可用",
  Loading: "正在加载",
  "Metrics unavailable": "指标暂不可用",
  "Network mode and persistent storage are available after source validation.":
    "源验证完成后即可配置网络模式和持久化存储。",
  "No API keys": "没有 API 密钥",
  "No applications found": "未找到应用",
  "No applications match this filter": "没有应用符合当前筛选条件",
  "No balance data": "没有余额数据",
  "No cluster nodes found": "未找到集群节点",
  "No cluster nodes match this filter": "没有集群节点符合当前筛选条件",
  "No custom domains": "没有自定义域名",
  "No DNS records": "没有 DNS 记录",
  "No environment variables": "没有环境变量",
  "No files returned": "未返回文件",
  "No hosted zones": "没有托管区域",
  "No image versions": "没有镜像版本",
  "No live database continuity operation is reported for this backing service.":
    "此后端服务当前未报告正在进行的数据库连续性操作。",
  "No role labels": "没有角色标签",
  "No logs returned": "未返回日志",
  "No metrics returned": "未返回指标",
  "No node keys": "没有节点密钥",
  "No offline servers": "没有离线服务器",
  "No pod selected": "未选择 Pod",
  "No projects match this filter": "没有项目符合当前筛选条件",
  "No public route": "没有公开路由",
  "No requests returned": "未返回请求",
  "No runtime": "没有运行时",
  "No runtime targets": "没有运行时目标",
  "No scopes": "没有权限范围",
  "No servers found": "未找到服务器",
  "No services yet": "尚无服务",
  "No sign-in method is recorded.": "尚未记录登录方式。",
  "No trace": "没有追踪信息",
  "No telemetry": "没有遥测数据",
  "No usage stats": "没有使用量统计",
  "No users found": "未找到用户",
  "No users match this filter": "没有用户符合当前筛选条件",
  None: "无",
  "Not yet": "尚未",
  "Overwrite is explicit for this save.": "本次保存将明确覆盖冲突记录。",
  "Parent delegation is not fully active.": "父级委派尚未完全生效。",
  "Policy unavailable": "策略暂不可用",
  "Project details unavailable": "项目详情暂不可用",
  "Project not found": "未找到项目",
  "Projects unavailable": "项目暂不可用",
  "Provision the workspace admin key before using the Fugue CLI or API from this account.":
    "使用此账号调用 Fugue CLI 或 API 前，请先配置工作区管理员密钥。",
  "Requests unavailable": "请求数据暂不可用",
  "Restart app": "重启应用",
  "Restart failed": "重启失败",
  "Restart requested": "已请求重启",
  "Runtime targets unavailable": "运行时目标暂不可用",
  "Server inventory partially loaded": "服务器清单仅部分加载",
  "Servers unavailable": "服务器暂不可用",
  "Showing stored API key metadata while live sync is unavailable.":
    "实时同步暂不可用，当前显示已存储的 API 密钥元数据。",
  "Snapshot partially loaded": "快照仅部分加载",
  "Template variables and topology preview are included in the deploy payload.":
    "部署负载中包含模板变量和拓扑预览。",
  "Template: {template}": "模板：{template}",
  "The access key operation failed.": "访问密钥操作失败。",
  "The admin snapshot did not include control plane telemetry.":
    "管理员快照中不包含控制平面遥测数据。",
  "The application list changed. Returned to the first page.":
    "应用列表已变化，已返回第一页。",
  "The complete import wizard is available from the dedicated new project route.":
    "可从专用的新建项目页面打开完整导入向导。",
  "The DNS operation failed.": "DNS 操作失败。",
  "The requested project does not exist in this workspace, or the current account cannot view it.":
    "请求的项目不在此工作区中，或当前账号无权查看。",
  "The user list changed. Returned to the first page.":
    "用户列表已变化，已返回第一页。",
  "This app does not currently expose a public route.": "此应用当前未公开对外路由。",
  "This app has no AppDomain bindings yet.": "此应用尚无 AppDomain 绑定。",
  ...
  "This project exists, but Fugue is not reporting any app or backing service for it yet.":
    "此项目已存在，但 Fugue 尚未报告其中的应用或后端服务。",
  Unavailable: "暂不可用",
  "Workspace is not ready": "工作区尚未就绪",
} satisfies MessageCatalog;

const zhTWConsoleStateMessages = {
  "A database continuity operation is currently in progress.":
    "資料庫連續性操作正在進行中。",
  "Access keys unavailable": "存取金鑰暫時無法使用",
  "Add a record after the zone is delegated to Fugue nameservers.":
    "將區域委派給 Fugue 名稱伺服器後即可新增記錄。",
  "Add a zone to start serving DNS from Fugue nameservers.":
    "新增區域後即可開始透過 Fugue 名稱伺服器提供 DNS 服務。",
  "Admin operation failed": "管理員操作失敗",
  "Apex CNAME uses flattening.": "根網域 CNAME 使用扁平化解析。",
  "Applications unavailable": "應用程式暫時無法使用",
  "Billing action failed": "計費操作失敗",
  "Billing snapshot refreshed with partial live data":
    "計費快照已重新整理，但僅包含部分即時資料",
  "Billing sync error": "計費同步錯誤",
  "Clear search or adjust the lifecycle filter.": "清除搜尋或調整生命週期篩選條件。",
  "Clear search or change the phase filter.": "清除搜尋或變更階段篩選條件。",
  "Clear search or change the user filter.": "清除搜尋或變更使用者篩選條件。",
  "Clear the node search.": "清除節點搜尋。",
  "Clear the search query or attach a new runtime node.":
    "清除搜尋條件，或連接新的執行環境節點。",
  "Cluster operation failed": "叢集操作失敗",
  "Cluster unavailable": "叢集暫時無法使用",
  "Control plane status unavailable": "控制平面狀態暫時無法使用",
  "Could not save password.": "無法儲存密碼。",
  "Could not update sign-in methods.": "無法更新登入方式。",
  "Create a node key, copy the join command, and run it on a VPS.":
    "建立節點金鑰、複製加入命令，然後在 VPS 上執行。",
  "Create a project from a repository, image, or upload.":
    "從儲存庫、映像或本機上傳建立專案。",
  "Create or open a Fugue workspace before changing tenant billing.":
    "變更租戶計費前，請先建立或開啟 Fugue 工作區。",
  "Create or open a Fugue workspace before managing API keys and node enrollment keys.":
    "管理 API 金鑰和節點註冊金鑰前，請先建立或開啟 Fugue 工作區。",
  "Create or open a Fugue workspace before managing hosted DNS.":
    "管理代管 DNS 前，請先建立或開啟 Fugue 工作區。",
  "Create or open a Fugue workspace before viewing runtime servers.":
    "檢視執行環境伺服器前，請先建立或開啟 Fugue 工作區。",
  "Current image": "目前映像",
  "Current saved cap": "目前已儲存上限",
  "Custom domains are unavailable.": "自訂網域暫時無法使用。",
  "Deploy failed": "部署失敗",
  "Duplicate key": "鍵名重複",
  "Effective policy": "生效政策",
  "Enable email link or connect an OAuth provider before leaving this page.":
    "離開此頁面前，請啟用電子郵件連結或連接 OAuth 提供方。",
  "Environment keys must be unique before save.": "儲存前，環境變數鍵名必須唯一。",
  "Environment unavailable": "環境變數暫時無法使用",
  "Filesystem unavailable": "檔案系統暫時無法使用",
  "Fugue could not load hosted DNS right now.": "Fugue 目前無法載入代管 DNS。",
  "Fugue did not return a selectable runtime target. Leaving this blank lets the control plane choose the default placement.":
    "Fugue 未回傳可選的執行環境目標。留空後，控制平面將選擇預設位置。",
  "Fugue did not return filesystem entries for this app.":
    "Fugue 未回傳此應用程式的檔案系統項目。",
  "Fugue did not return log lines for this app and mode.":
    "Fugue 未回傳此應用程式和目前模式的日誌行。",
  "Fugue did not return retained image versions for this app.":
    "Fugue 未回傳此應用程式保留的映像版本。",
  "Fugue is not reporting stale runtime server records for this workspace.":
    "Fugue 未回報此工作區中過期的執行環境伺服器記錄。",
  "Fugue observability returned no metric samples for this window.":
    "Fugue 可觀測性在此時間區間內未回傳指標樣本。",
  "Fugue observability returned no request summaries for this window.":
    "Fugue 可觀測性在此時間區間內未回傳請求摘要。",
  "Fugue returned an empty cluster application inventory.":
    "Fugue 回傳了空的叢集應用程式清單。",
  "Fugue returned an empty cluster node inventory.": "Fugue 回傳了空的叢集節點清單。",
  "Fugue returned an empty environment for this app.":
    "Fugue 回傳了此應用程式的空環境變數清單。",
  "Fugue returned an empty user directory.": "Fugue 回傳了空的使用者目錄。",
  "Fugue returned no tenant billing events for this workspace.":
    "Fugue 未回傳此工作區的租戶計費事件。",
  "Fugue will publish A/AAAA answers at the apex instead of an invalid apex CNAME RR.":
    "Fugue 將在根網域發佈 A/AAAA 回應，而不是無效的根網域 CNAME 資源記錄。",
  "Fugue will still preserve system protected records and backend ownership checks.":
    "Fugue 仍會保留受系統保護的記錄和後端擁有權檢查。",
  "Fugue will restart this app without rebuilding its image.":
    "Fugue 將重新啟動此應用程式，而不重新建置映像。",
  "Fugue accepted the restart and refreshed the project status.":
    "Fugue 已接受重新啟動請求並重新整理專案狀態。",
  "Full creation flow": "完整建立流程",
  "Hosted DNS loaded with a warning.": "代管 DNS 已載入，但存在警告。",
  "If the registrar has DNSSEC DS records enabled, remove them until Fugue DNSSEC is configured.":
    "如果註冊商已啟用 DNSSEC DS 記錄，請在 Fugue DNSSEC 設定完成前將其移除。",
  "Images unavailable": "映像暫時無法使用",
  "Internal service URL is not reported for this app.":
    "此應用程式尚未回報內部服務 URL。",
  "Inventory partially loaded": "清單僅部分載入",
  "Logs unavailable": "日誌暫時無法使用",
  Loading: "正在載入",
  "Metrics unavailable": "指標暫時無法使用",
  "Network mode and persistent storage are available after source validation.":
    "來源驗證完成後即可設定網路模式和持久化儲存。",
  "No API keys": "沒有 API 金鑰",
  "No applications found": "找不到應用程式",
  "No applications match this filter": "沒有應用程式符合目前篩選條件",
  "No balance data": "沒有餘額資料",
  "No cluster nodes found": "找不到叢集節點",
  "No cluster nodes match this filter": "沒有叢集節點符合目前篩選條件",
  "No custom domains": "沒有自訂網域",
  "No DNS records": "沒有 DNS 記錄",
  "No environment variables": "沒有環境變數",
  "No files returned": "未回傳檔案",
  "No hosted zones": "沒有代管區域",
  "No image versions": "沒有映像版本",
  "No live database continuity operation is reported for this backing service.":
    "此後端服務目前未回報正在進行的資料庫連續性操作。",
  "No role labels": "沒有角色標籤",
  "No logs returned": "未回傳日誌",
  "No metrics returned": "未回傳指標",
  "No node keys": "沒有節點金鑰",
  "No offline servers": "沒有離線伺服器",
  "No pod selected": "未選擇 Pod",
  "No projects match this filter": "沒有專案符合目前篩選條件",
  "No public route": "沒有公開路由",
  "No requests returned": "未回傳請求",
  "No runtime": "沒有執行環境",
  "No runtime targets": "沒有執行環境目標",
  "No scopes": "沒有權限範圍",
  "No servers found": "找不到伺服器",
  "No services yet": "尚無服務",
  "No sign-in method is recorded.": "尚未記錄登入方式。",
  "No trace": "沒有追蹤資訊",
  "No telemetry": "沒有遙測資料",
  "No usage stats": "沒有使用量統計",
  "No users found": "找不到使用者",
  "No users match this filter": "沒有使用者符合目前篩選條件",
  None: "無",
  "Not yet": "尚未",
  "Overwrite is explicit for this save.": "本次儲存將明確覆寫衝突記錄。",
  "Parent delegation is not fully active.": "父層委派尚未完全生效。",
  "Policy unavailable": "政策暫時無法使用",
  "Project details unavailable": "專案詳細資料暫時無法使用",
  "Project not found": "找不到專案",
  "Projects unavailable": "專案暫時無法使用",
  "Provision the workspace admin key before using the Fugue CLI or API from this account.":
    "使用此帳號呼叫 Fugue CLI 或 API 前，請先設定工作區管理員金鑰。",
  "Requests unavailable": "請求資料暫時無法使用",
  "Restart app": "重新啟動應用程式",
  "Restart failed": "重新啟動失敗",
  "Restart requested": "已要求重新啟動",
  "Runtime targets unavailable": "執行環境目標暫時無法使用",
  "Server inventory partially loaded": "伺服器清單僅部分載入",
  "Servers unavailable": "伺服器暫時無法使用",
  "Showing stored API key metadata while live sync is unavailable.":
    "即時同步暫時無法使用，目前顯示已儲存的 API 金鑰中繼資料。",
  "Snapshot partially loaded": "快照僅部分載入",
  "Template variables and topology preview are included in the deploy payload.":
    "部署負載中包含範本變數和拓撲預覽。",
  "Template: {template}": "範本：{template}",
  "The access key operation failed.": "存取金鑰操作失敗。",
  "The admin snapshot did not include control plane telemetry.":
    "管理員快照中不包含控制平面遙測資料。",
  "The application list changed. Returned to the first page.":
    "應用程式清單已變更，已返回第一頁。",
  "The complete import wizard is available from the dedicated new project route.":
    "可從專用的新建專案頁面開啟完整匯入精靈。",
  "The DNS operation failed.": "DNS 操作失敗。",
  "The requested project does not exist in this workspace, or the current account cannot view it.":
    "要求的專案不在此工作區中，或目前帳號無權檢視。",
  "The user list changed. Returned to the first page.":
    "使用者清單已變更，已返回第一頁。",
  "This app does not currently expose a public route.":
    "此應用程式目前未公開對外路由。",
  "This app has no AppDomain bindings yet.": "此應用程式尚無 AppDomain 綁定。",
  "This node cannot be managed through the admin policy endpoint.":
    "無法透過管理員政策端點管理此節點。",
  "This project exists, but Fugue is not reporting any app or backing service for it yet.":
    "此專案已存在，但 Fugue 尚未回報其中的應用程式或後端服務。",
  Unavailable: "暫時無法使用",
  "No projects yet": "尚無專案",
  "Project name is required.": "必須提供專案名稱。",
  Users: "使用者",
  "Users unavailable": "使用者暫時無法使用",
  "Workspace is not ready": "工作區尚未就緒",
} satisfies MessageCatalog;
...
const catalogs: Record<Locale, MessageCatalog> = {
  ...
  "zh-CN": {
    ...zhCNMessages,
    ...zhCNExtraMessages,
    ...zhCNMorlanePatchMessages,
    ...zhCNPublicMessages,
    ...zhCNConsoleStateMessages,
  },
  "zh-TW": {
    ...zhTWMessages,
    ...zhTWExtraMessages,
    ...zhTWMorlanePatchMessages,
    ...zhTWPublicMessages,
    ...zhTWConsoleStateMessages,
  },
};
...
function normalizeLanguageTag(value: string) {
  return value.trim().replace(/_/g, "-").split("-").filter(Boolean);
}
...
export function resolveLocale(value?: string | null): Locale {
  ...
  try {
    ...
    if (
      (script && TRADITIONAL_SCRIPTS.has(script)) ||
    ...
    if (
      (upperScriptOrRegion &&
        (TRADITIONAL_SCRIPTS.has(upperScriptOrRegion) ||
          TRADITIONAL_REGIONS.has(upperScriptOrRegion))) ||
...
export function negotiateLocale(acceptLanguage?: string | null): Locale {
  ...
  const candidates = acceptLanguage
    ...
    .filter((candidate) => candidate.tag.length > 0 && candidate.score > 0)
    .sort((left, right) => right.score - left.score);

  for (const candidate of candidates) {
    const language = normalizeLanguageTag(candidate.tag)[0]?.toLowerCase();

    if (language === "en") {
      return "en";
    }
    if (language === "zh") {
      return resolveLocale(candidate.tag);
    }
  }
...
export function hasMessage(locale: Locale, key: string) {
