...
export const CONSOLE_BILLING_PAGE_SNAPSHOT_URL = "/api/fugue/console/pages/billing";
export const CONSOLE_BILLING_PAGE_USAGE_SNAPSHOT_URL =
  "/api/fugue/console/pages/billing?include_usage=1";
export const CONSOLE_API_KEYS_PAGE_SNAPSHOT_URL = "/api/fugue/console/pages/api-keys";
export const CONSOLE_CLUSTER_NODES_PAGE_SNAPSHOT_URL =
  "/api/fugue/console/pages/cluster-nodes";
export const CONSOLE_DNS_PAGE_SNAPSHOT_URL = "/api/fugue/console/pages/dns";
export const CONSOLE_PROFILE_SETTINGS_PAGE_SNAPSHOT_URL =
  "/api/fugue/console/pages/settings/profile";
export const CONSOLE_ADMIN_APPS_PAGE_SNAPSHOT_URL = "/api/fugue/admin/pages/apps";
export const CONSOLE_ADMIN_APPS_PAGE_USAGE_SNAPSHOT_URL =
  "/api/fugue/admin/pages/apps?include_usage=1";
export const CONSOLE_ADMIN_USERS_PAGE_SNAPSHOT_URL = "/api/fugue/admin/pages/users";
...
export const CONSOLE_ADMIN_CLUSTER_PAGE_SNAPSHOT_URL = "/api/fugue/admin/pages/cluster";
  ...
  return {
    ...
    refresh: async (refreshOptions?: SnapshotFetchOptions) => {
      ...
      try {
        ...
        startTransition(() => {
          setError(readRequestError(error));
          setLoading(false);
        });
