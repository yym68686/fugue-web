...
export type DeploySourceMode = "repository" | "local-upload" | "docker-image";
...
function readFirstNonEmptyParam(params: SearchParamRecord, keys: readonly string[]) {
...
export function readDeploySearchState(params: SearchParamRecord): DeploySearchState {
  return {
...
export function buildDeployHref(pathname: string, search: Partial<DeploySearchState>) {
