...
const billingLiveSummaryCache = createExpiringAsyncCache<FugueBillingSummary>(
  BILLING_LIVE_USAGE_CACHE_TTL_MS,
);
const billingImageStorageCache = createExpiringAsyncCache<number>(
  BILLING_LIVE_USAGE_CACHE_TTL_MS,
);
